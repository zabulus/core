 ...
 *  - Added customer data containing 8-bit characters.
 *  - Added a field office in Norway
 *  - Added employee records that use 8-bit data (C.E.O was changed)
 *
*****************************************************************************/
...
INSERT INTO country (country, currency) VALUES ('Deutschland', 'D-Mark');
...
INSERT INTO country (country, currency) VALUES ('Norge',       'Guilder');
INSERT INTO country (country, currency) VALUES ('Norway',      'Guilder');
 ...
 *                  Field Office: Germany      -- added to intl exmpl
 *              Field Office: Canada
...
INSERT INTO department
(dept_no, department, head_dept, budget, location, phone_no) VALUES
('122', 'Field Office: Germany',     '120', 400000, 'Munich', '89 29 37 41');
...
INSERT INTO job
(job_code, job_grade, job_country, job_title, min_salary, max_salary) VALUES
('VP',    2, 'England', 'Vice President',             54000,  89000) /* Pounds*/;
...
INSERT INTO job
(job_code, job_grade, job_country, job_title, min_salary, max_salary) VALUES
('Dir',   2, 'France', 'Director',                  443000,  711000) /* FFranc */;

INSERT INTO job
(job_code, job_grade, job_country, job_title, min_salary, max_salary) VALUES
('Dir',   2, 'Germany', 'Director',                  128000,  205000) /* D-Mark */;
...
INSERT INTO job
(job_code, job_grade, job_country, job_title, min_salary, max_salary) VALUES
('Mngr',  3, 'Canada', 'Manager',                    80000,  133000) /*CndDollar*/;
...
INSERT INTO job
(job_code, job_grade, job_country, job_title, min_salary, max_salary) VALUES
('Mngr',  4, 'England', 'Manager',                    41000,  677000) /* Pounds */;

INSERT INTO job
(job_code, job_grade, job_country, job_title, min_salary, max_salary) VALUES
('Mngr',  4, 'Germany', 'Manager',                   103000,  171000);

INSERT INTO job
(job_code, job_grade, job_country, job_title, min_salary, max_salary) VALUES
('Mngr',  4, 'France', 'Manager',                   355000,  591000) /* FFranc */;
...
INSERT INTO job
(job_code, job_grade, job_country, job_title, min_salary, max_salary) VALUES
('Admin', 4, 'France', 'Administrative Assistant',   21000,  33000) /* FFranc */;

INSERT INTO job
(job_code, job_grade, job_country, job_title, min_salary, max_salary) VALUES
('Admin', 4, 'Germany', 'Administrative Assistant',   59000,  94000);
...
INSERT INTO job
(job_code, job_grade, job_country, job_title, min_salary, max_salary) VALUES
('SRep',  4, 'Germany', 'Sales Representative',       34000,  170000) /* D-Mark */;
...
INSERT INTO employee (emp_no, first_name, last_name, dept_no, job_code,
job_grade, job_country, hire_date, salary, phone_ext) VALUES
(105, 'François', 'Peyré', '000', 'CEO', 1, 'USA', '10/08/92', 220000, '255');
...
COMMIT;
/* Start of additional international data */

INSERT INTO employee (emp_no, first_name, last_name, dept_no, job_code,
job_grade, job_country, hire_date, salary, phone_ext) VALUES
(201, 'Joseph', 'Vaca', '120', 'Eng', 4, 'England', 
'01/15/91', 25900, null);

/* Canadian employees added -- add fine. */
INSERT INTO employee (emp_no, first_name, last_name, dept_no, job_code,
job_grade, job_country, hire_date, salary, phone_ext) VALUES
(208, 'Thérèse', 'Dubreuil-Lafont', '120', 'Mngr', 3, 'Canada', 
'01/15/91', 93000, null);

INSERT INTO employee (emp_no, first_name, last_name, dept_no, job_code,
job_grade, job_country, hire_date, salary, phone_ext) VALUES
(202, 'Marie-Pierre', 'Desfossés', '140', 'SRep', 4, 'Canada', 
'01/15/91', 93000, null);

INSERT INTO employee (emp_no, first_name, last_name, dept_no, job_code,
job_grade, job_country, hire_date, salary, phone_ext) VALUES
(203, 'Guillaume', 'Le Clézio', '140', 'SRep', 4, 'Canada', 
'06/21/93', 78000, null);
...
INSERT INTO employee (emp_no, first_name, last_name, dept_no, job_code,
job_grade, job_country, hire_date, salary, phone_ext) VALUES
(204, 'Vivianne', "de l'Etournay", '123', 'SRep',  4, 'France', 
'01/17/90', 384754, '344');

INSERT INTO employee (emp_no, first_name, last_name, dept_no, job_code,
job_grade, job_country, hire_date, salary, phone_ext) VALUES
(205, 'Martine', 'Bélard', '123', 'SRep',  4, 'France', '04/17/90', 440000,
'344');

INSERT INTO employee (emp_no, first_name, last_name, dept_no, job_code,
job_grade, job_country, hire_date, salary, phone_ext) VALUES
(206, 'Jérôme', 'Louÿs', '123', 'Mngr',  4, 'France', '06/22/91', 
405500, '338');

INSERT INTO employee (emp_no, first_name, last_name, dept_no, job_code,
job_grade, job_country, hire_date, salary, phone_ext) VALUES
(207, 'Jean-François', 'Bouverat', '123', 'Admin',  4, 'France', '01/10/92', 
25500, null);
COMMIT;

/* German employees added */
INSERT INTO employee (emp_no, first_name, last_name, dept_no, job_code,
job_grade, job_country, hire_date, salary, phone_ext) VALUES
(301, 'Anke', 'Flöck', '122', 'SRep',  4, 'Germany', '07/04/92', 
65000, '228');

INSERT INTO employee (emp_no, first_name, last_name, dept_no, job_code,
job_grade, job_country, hire_date, salary, phone_ext) VALUES
(302, 'Marlene', 'Schäfer', '122', 'SRep',  4, 'Germany', '03/24/93', 
69000, '239');

INSERT INTO employee (emp_no, first_name, last_name, dept_no, job_code,
job_grade, job_country, hire_date, salary, phone_ext) VALUES
(303, 'Jürgen', 'Schmidt', '122', 'SRep',  4, 'Germany', '06/19/91', 
110000, '224');
COMMIT;

INSERT INTO employee (emp_no, first_name, last_name, dept_no, job_code,
job_grade, job_country, hire_date, salary, phone_ext) VALUES
(304, 'Jörg', 'Stecher', '122', 'Dir',  2, 'Germany', '10/27/92',
180000, '236');

INSERT INTO employee (emp_no, first_name, last_name, dept_no, job_code,
job_grade, job_country, hire_date, salary, phone_ext) VALUES
(305, 'Ralf', 'Schwenkmezger', '122', 'Admin',  4, 'Germany', '05/07/93', 
62700, null);

/* Swiss employees added */
INSERT INTO employee (emp_no, first_name, last_name, dept_no, job_code,
job_grade, job_country, hire_date, salary, phone_ext) VALUES
(312, 'Gertrud', 'Schleußner', '121', 'SRep', 4, 'Switzerland', '10/03/93',
78000, null);
COMMIT;

INSERT INTO employee (emp_no, first_name, last_name, dept_no, job_code,
job_grade, job_country, hire_date, salary, phone_ext) VALUES
(315, 'Silvia', 'Rössler', '121', 'SRep', 4, 'Switzerland', '05/07/92',
102000, null);

INSERT INTO employee (emp_no, first_name, last_name, dept_no, job_code,
job_grade, job_country, hire_date, salary, phone_ext) VALUES
(325, 'Roland', 'Fürderer', '121', 'SRep', 4, 'Switzerland', '10/27/92',
96000, null);
...
COMMIT;
/*
 *  Add a few customer records--the original US data and the international data. 
 */
...
address_line2, city, state_province, country, postal_code, on_hold) VALUES
     (1052, 
     'Rondouillard & frères, S.A.R.L.',
     'Honoré', 
     'de Ségonzac', 
     '(1) 89.36.75.11',
     '25, rue des Franc-Maçons',   
     null, 
     'Paris',
     null, 
     'France', 
...
address_line2, city, state_province, country, postal_code, on_hold) VALUES
     ...
     'Démêloir',    
     '86 35 71 23',   
     '173 bis, rue de la Pierre-á-Feu',   
     null, 
     'La Côtinière',
     "île d'Oléron",
     'France', 
...
address_line2, city, state_province, country, postal_code, on_hold) VALUES
     (1054, 
     'Madame veuve Michoux',
     'Cunégonde',
     'Michoux',     
     '27.58.69.12',   
     'Résidence "Les Belles Années"',     
     'Appartement 179, Bâtiment C',
     'Saint-Georges-en-Vâle',
     null,
     'France', 
     '24575', 
     null);
...
/* start here with german entries */
INSERT INTO customer
(cust_no, customer, contact_first, contact_last, phone_no, address_line1,
address_line2, city, state_province, country, postal_code, on_hold) VALUES
     (1055, 
