...
static SLONG compute_access(TDBB, SCL, REL, CONST TEXT*, CONST TEXT*);
static TEXT *save_string(TEXT*, TEXT**);
static SLONG walk_acl(TDBB, CONST TEXT*, REL, CONST TEXT*, CONST TEXT*, STR*, ULONG*);
...
void SCL_check_index( TDBB tdbb, TEXT * index_name, USHORT mask)
{
/******************************************************
 *
