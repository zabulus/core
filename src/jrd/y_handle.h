...
typedef struct why_hndl* isc_att_handle;
typedef struct why_hndl* isc_blob_handle;
typedef struct why_hndl* isc_db_handle;
typedef struct why_hndl* isc_form_handle;
typedef struct why_hndl* isc_req_handle;
typedef struct why_hndl* isc_stmt_handle;
typedef struct why_hndl* isc_svc_handle;
typedef struct why_hndl* isc_tr_handle;
typedef struct why_hndl* isc_win_handle;
