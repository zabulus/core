...
ISC_STATUS	API_ROUTINE gds__prepare_transaction2(ISC_STATUS*, FB_API_HANDLE*, SSHORT, const SCHAR*);
...
ISC_STATUS	API_ROUTINE gds__send(ISC_STATUS*, FB_API_HANDLE*, SSHORT, SSHORT, const void*,	SSHORT);
ISC_STATUS	API_ROUTINE gds__start_and_send(ISC_STATUS*, FB_API_HANDLE*, FB_API_HANDLE*, SSHORT, SSHORT, const void*, SSHORT);
