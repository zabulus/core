...
const int drq_s_prc_usr_prvs	= 79;	// store procedure privileges
...
const int drq_s_funcs2		= 168;		// store functions (CreateAlterFunctionNode)
const int drq_s_func_args2	= 169;		// store function arguments (CreateAlterFunctionNode)
const int drq_m_funcs2		= 170;		// modify functions (CreateAlterFunctionNode)
const int drq_e_func_args2	= 171;		// erase function arguments (CreateAlterFunctionNode)
const int drq_s_prcs2		= 172;
const int drq_s_prms4		= 173;
const int drq_s_prm_src2	= 174;
const int drq_m_prcs2		= 175;
const int drq_e_prms2		= 176;
const int drq_s_triggers2	= 177;
const int drq_m_trigger2	= 178;
const int drq_d_gfields3	= 179;
const int drq_d_gfields4	= 180;
const int drq_e_prcs2		= 181;
const int drq_e_prc_prvs2	= 182;
const int drq_e_prc_prv2	= 183;
const int drq_e_trg_msgs3	= 184;
const int drq_e_trigger3	= 185;
const int drq_e_trg_prv2	= 186;
const int drq_l_view_rel3	= 187;
const int drq_m_rel_flds2	= 188;
const int drq_e_trg_prv3	= 189;
const int drq_s_pkg			= 190;		// store package
const int drq_e_pkg			= 191;		// erase package
const int drq_m_pkg_body	= 192;		// create package body
const int drq_m_pkg_body2	= 193;		// drop package body
const int drq_m_pkg_prc		= 194;		// drop package body
const int drq_m_pkg_fun		= 195;		// drop package body
const int drq_m_pkg			= 196;		// alter package
const int drq_l_pkg_funcs	= 197;		// lookup packaged functions
const int drq_l_pkg_func_args	= 198;	// lookup packaged function arguments
const int drq_l_pkg_procs	= 199;		// lookup packaged procedures
const int drq_l_pkg_proc_args	= 200;	// lookup packaged procedure arguments
