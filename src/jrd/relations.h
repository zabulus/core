...
RELATION(nam_trgs, rel_triggers, ODS_8_0, rel_persistent)
	...
	FIELD(f_trg_engine_name, nam_engine_name, fld_engine_name, 0, 0, 0, 0)
	FIELD(f_trg_entry, nam_entry, fld_ext_name, 0, 0, 0, 0)
END_RELATION
RELATION(nam_dpds, rel_dpds, ODS_8_0, rel_persistent)
	...
	FIELD(f_dpd_pkg_name, nam_pkg_name, fld_pkg_name, 0, 0, 0, 0)
END_RELATION
RELATION(nam_funs, rel_funs, ODS_8_0, rel_persistent)
	...
	FIELD(f_fun_engine_name, nam_engine_name, fld_engine_name, 0, 0, 0, 0)
	FIELD(f_fun_pkg_name, nam_pkg_name, fld_pkg_name, 0, 0, 0, 0)
	FIELD(f_fun_private_flag, nam_private_flag, fld_flag, 0, 0, 0, 0)
	FIELD(f_fun_source, nam_fun_source, fld_source, 0, 0, 0, 0)
END_RELATION
RELATION(nam_args, rel_args, ODS_8_0, rel_persistent)
	...
	FIELD(f_arg_pkg_name, nam_pkg_name, fld_pkg_name, 0, 0, 0, 0)
END_RELATION
...
RELATION(nam_procedures, rel_procedures, ODS_8_0, rel_persistent)
	...
	FIELD(f_prc_engine_name, nam_engine_name, fld_engine_name, 0, 0, 0, 0)
	FIELD(f_prc_entry, nam_entry, fld_ext_name, 0, 0, 0, 0)
	FIELD(f_prc_pkg_name, nam_pkg_name, fld_pkg_name, 0, 0, 0, 0)
	FIELD(f_prc_private_flag, nam_private_flag, fld_flag, 0, 0, 0, 0)
END_RELATION
RELATION(nam_proc_parameters, rel_prc_prms, ODS_8_0, rel_persistent)
	...
	FIELD(f_prm_pkg_name, nam_pkg_name, fld_pkg_name, 0, 0, 0, 0)
END_RELATION
...
RELATION(nam_mon_calls, rel_mon_calls, ODS_11_1, rel_virtual)
	...
	FIELD(f_mon_call_pkg_name, nam_mon_pkg_name, fld_pkg_name, 0, 0, 0, 0)
END_RELATION
...
RELATION(nam_packages, rel_packages, ODS_12_0, rel_persistent)
	FIELD(f_pkg_name, nam_pkg_name, fld_pkg_name, 0, 0, 0, 0)
	FIELD(f_pkg_header_source, nam_pkg_header_source, fld_source, 0, 0, 0, 0)
	FIELD(f_pkg_body_source, nam_pkg_body_source, fld_source, 0, 0, 0, 0)
	FIELD(f_pkg_class, nam_class, fld_class, 0, 0, 0, 0)
	FIELD(f_pkg_owner, nam_owner, fld_user, 0, 0, 0, 0)
	FIELD(f_pkg_sys_flag, nam_sys_flag, fld_flag, 0, 0, 0, 0)
	FIELD(f_pkg_desc, nam_description, fld_description, 0, 0, 0, 0)
END_RELATION
