...
RELATION(nam_pages, rel_pages, ODS_8_0)
	...
	END_RELATION RELATION(nam_database, rel_database, ODS_8_0)
	...
	END_RELATION RELATION(nam_fields, rel_fields, ODS_8_0)
	...
	END_RELATION RELATION(nam_i_segments, rel_segments, ODS_8_0)
	...
	END_RELATION RELATION(nam_indices, rel_indices, ODS_8_0)
	...
	END_RELATION RELATION(nam_r_fields, rel_rfr, ODS_8_0)
	...
	END_RELATION RELATION(nam_relations, rel_relations, ODS_8_0)
	...
	END_RELATION RELATION(nam_v_relations, rel_vrel, ODS_8_0)
	...
	END_RELATION RELATION(nam_formats, rel_formats, ODS_8_0)
	...
	END_RELATION RELATION(nam_files, rel_files, ODS_8_0)
	...
	END_RELATION RELATION(nam_types, rel_types, ODS_8_0)
	...
	END_RELATION RELATION(nam_trgs, rel_triggers, ODS_8_0)
	...
	END_RELATION RELATION(nam_dpds, rel_dpds, ODS_8_0)
	...
	END_RELATION RELATION(nam_funs, rel_funs, ODS_8_0)
	...
	END_RELATION RELATION(nam_args, rel_args, ODS_8_0)
	...
	END_RELATION RELATION(nam_filters, rel_filters, ODS_8_0)
	...
	END_RELATION RELATION(nam_trg_msgs, rel_msgs, ODS_8_0)
	...
	END_RELATION RELATION(nam_user_privileges, rel_priv, ODS_8_0)
	...
	END_RELATION RELATION(nam_trans, rel_trans, ODS_8_0)
	...
	END_RELATION RELATION(nam_gens, rel_gens, ODS_8_0)
	...
	END_RELATION RELATION(nam_fld_dims, rel_dims, ODS_8_0)
	...
	END_RELATION RELATION(nam_rel_constr, rel_rcon, ODS_8_0)
	...
	END_RELATION RELATION(nam_ref_constr, rel_refc, ODS_8_0)
	...
	END_RELATION RELATION(nam_chk_constr, rel_ccon, ODS_8_0)
	...
	END_RELATION RELATION(nam_procedures, rel_procedures, ODS_8_0)
	...
	END_RELATION RELATION(nam_proc_parameters, rel_prc_prms, ODS_8_0)
	...
	END_RELATION RELATION(nam_charsets, rel_charsets, ODS_8_0)
	...
	END_RELATION RELATION(nam_collations, rel_collations, ODS_8_0)
	...
	END_RELATION RELATION(nam_exceptions, rel_exceptions, ODS_8_0)
	...
	END_RELATION RELATION(nam_roles, rel_roles, ODS_9_0)
