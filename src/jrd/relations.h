...
RELATION(nam_mon_database, rel_mon_database, ODS_11_1, rel_virtual)
	...
	FIELD(f_mon_db_cur_mem, nam_mon_cur_mem, fld_counter, 0, 0, 0, 0)
	FIELD(f_mon_db_max_mem, nam_mon_max_mem, fld_counter, 0, 0, 0, 0)
	FIELD(f_mon_db_page_reads, nam_mon_page_reads, fld_counter, 0, 0, 0, 0)
	FIELD(f_mon_db_page_writes, nam_mon_page_writes, fld_counter, 0, 0, 0, 0)
	FIELD(f_mon_db_page_fetches, nam_mon_page_fetches, fld_counter, 0, 0, 0, 0)
	FIELD(f_mon_db_page_marks, nam_mon_page_marks, fld_counter, 0, 0, 0, 0)
END_RELATION
...
RELATION(nam_mon_statements, rel_mon_statements, ODS_11_1, rel_virtual)
	...
	FIELD(f_mon_stmt_rec_selects, nam_mon_rec_selects, fld_counter, 0, 0, 0, 0)
	FIELD(f_mon_stmt_rec_inserts, nam_mon_rec_inserts, fld_counter, 0, 0, 0, 0)
	FIELD(f_mon_stmt_rec_updates, nam_mon_rec_updates, fld_counter, 0, 0, 0, 0)
	FIELD(f_mon_stmt_rec_deletes, nam_mon_rec_deletes, fld_counter, 0, 0, 0, 0)
END_RELATION
