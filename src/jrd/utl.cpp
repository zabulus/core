...
int API_ROUTINE BLOB_close(BLOBSTREAM bstream)
{
/**************************************
 *
 *	B L O B _ c l o s e
...
int API_ROUTINE BLOB_get(BLOBSTREAM bstream)
{
/**************************************
 *
 *	B L O B _ g e t
...
BLOBSTREAM API_ROUTINE Bopen(ISC_QUAD* blob_id,
						   FB_API_HANDLE database,
						   FB_API_HANDLE transaction,
						   const SCHAR* mode)
{
 ...
 **************************************/
	...
	BLOBSTREAM bstream = BLOB_open(blob, NULL, 0);
...
BLOBSTREAM API_ROUTINE BLOB_open(FB_API_HANDLE blob, SCHAR* buffer, int length)
{
/**************************************
 *
 *	B L O B _ o p e n
 ...
 **************************************/
	...
	BLOBSTREAM bstream = (BLOBSTREAM) gds__alloc((SLONG) sizeof(BSTREAM));
...
int API_ROUTINE BLOB_put(SCHAR x, BLOBSTREAM bstream)
{
/**************************************
 *
 *	B L O B _ p u t
