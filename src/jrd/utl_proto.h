...
typedef struct  bstream* StreamPtr;
StreamPtr	API_ROUTINE Bopen(ISC_QUAD*, FB_API_HANDLE, FB_API_HANDLE, const SCHAR*);
StreamPtr	API_ROUTINE BLOB_open(FB_API_HANDLE, SCHAR*, int);
