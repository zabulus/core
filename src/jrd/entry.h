 ...
 *  source/jrd/why.c.  Failure to do so will result in
 *  much frustration
 ******************************************************/
...
ENTRYPOINT("gds_attach_database",
		   ...
		   IPI_attach_database,
		   (STATUS *, SSHORT, SCHAR *, struct att **, SSHORT, SCHAR *,
			SCHAR *))

	ENTRYPOINT("gds_blob_info", jrd8_blob_info, "jrd5_blob_info", REM_blob_info,
		   "_REM_blob_info", CSI_blob_info, RDB_blob_info, PSI_blob_info,
			   PSI5_blob_info, "_jrd8_blob_info", IPI_blob_info, (STATUS *,
																  struct blb
																  **, SSHORT,
																  SCHAR *,
																  SSHORT,
	...
	ENTRYPOINT("gds_cancel_blob", jrd8_cancel_blob, "jrd5_cancel_blob",
		   REM_cancel_blob, "_REM_cancel_blob", CSI_cancel_blob,
			   RDB_cancel_blob, PSI_cancel_blob, PSI5_cancel_blob,
			   "_jrd8_cancel_blob", IPI_cancel_blob, (STATUS *,
													  struct blb **))

	ENTRYPOINT("gds_close_blob", jrd8_close_blob, "jrd5_close_blob",
		   REM_close_blob, "_REM_close_blob", CSI_close_blob, RDB_close_blob,
			   PSI_close_blob, PSI5_close_blob, "_jrd8_close_blob",
			   IPI_close_blob, (STATUS *, struct blb **))

	ENTRYPOINT("gds_commit_transaction", jrd8_commit_transaction,
		   "jrd5_commit_transaction", REM_commit_transaction,
			   "_REM_commit_transaction", CSI_commit_transaction,
			   RDB_commit_transaction, PSI_commit_transaction,
			   PSI5_commit_transaction, "_jrd8_commit_transaction",
			   IPI_commit_transaction, (STATUS *, struct tra **))

	ENTRYPOINT("gds_compile_request", jrd8_compile_request,
		   "jrd5_compile_request", REM_compile_request,
		   "_REM_compile_request", CSI_compile_request, RDB_compile_request,
PSI_compile_request, PSI5_compile_request, "_jrd8_compile_request", IPI_compile_request, (STATUS *,
															struct att **,
															struct req **,
															SSHORT, SCHAR *))
   ...
   /****     CSI_create_blob    ***/ y_valve_no_entrypoint,
			   RDB_create_blob, PSI_create_blob, PSI5_create_blob,
   /****  "_jrd8_create_blob"    ***/ "no_entrypoint",
			   IPI_create_blob,
			   (STATUS *, struct rdb **, struct rtr **, struct rbl **,
				struct bid *))

	ENTRYPOINT("gds_create_database", jrd8_create_database,
   /****   "jrd5_create_database"   ***/ NULL,
			   REM_create_database,
			   "_REM_create_database",
			   CSI_create_database, RDB_create_database, PSI_create_database,
   /****    PSI5_create_database    ***/ y_valve_no_entrypoint,
			   "_jrd8_create_database",
			   IPI_create_database,
			   (STATUS *, USHORT, UCHAR *, struct att **, USHORT, UCHAR *,
				USHORT, UCHAR *))

	ENTRYPOINT("gds_database_info", jrd8_database_info, "jrd5_database_info",
		   REM_database_info, "_REM_database_info", CSI_database_info,
			   RDB_database_info, PSI_database_info, PSI5_database_info,
			   "_jrd8_database_info", IPI_database_info, (STATUS *,
														  struct att **,
														  SSHORT, SCHAR *,
														  SSHORT, SCHAR *))

	ENTRYPOINT("gds_detach_database", jrd8_detach_database,
		   "jrd5_detach_database", REM_detach_database,
		   "_REM_detach_database", CSI_detach_database, RDB_detach_database,
PSI_detach_database, PSI5_detach_database, "_jrd8_detach_database", IPI_detach_database, (STATUS *,
															struct att **))

	ENTRYPOINT("gds_get_segment", jrd8_get_segment, "jrd5_get_segment",
		   REM_get_segment, "_REM_get_segment", CSI_get_segment,
			   RDB_get_segment, PSI_get_segment, PSI5_get_segment,
			   "_jrd8_get_segment", IPI_get_segment, (STATUS *, struct blb **,
													  USHORT *, USHORT,
													  UCHAR *))
   ...
   /****     CSI_open_blob    ***/ y_valve_no_entrypoint,
			   RDB_open_blob, PSI_open_blob, PSI5_open_blob,
   /****  "_jrd8_open_blob"   ***/ "no_entrypoint",
			   IPI_open_blob,
			   (STATUS *, struct rdb **, struct rtr **, struct rbl **,
				struct bid *))

	ENTRYPOINT("gds_prepare_transaction", jrd8_prepare_transaction,
		   "jrd5_prepare_transaction", REM_prepare_transaction,
			   "_REM_prepare_transaction", CSI_prepare_transaction,
			   RDB_prepare_transaction, PSI_prepare_transaction,
			   PSI5_prepare_transaction, "_jrd8_prepare_transaction",
			   IPI_prepare_transaction, (STATUS *, struct tra **, USHORT,
										 UCHAR *))

	ENTRYPOINT("gds_put_segment", jrd8_put_segment, "jrd5_put_segment",
		   REM_put_segment, "_REM_put_segment", CSI_put_segment,
			   RDB_put_segment, PSI_put_segment, PSI5_put_segment,
			   "_jrd8_put_segment", IPI_put_segment, (STATUS *, struct blb **,
													  USHORT, UCHAR *))

	ENTRYPOINT("gds_reconnect_transaction", jrd8_reconnect_transaction,
		   "jrd5_reconnect_transaction", REM_reconnect_transaction,
			   "_REM_reconnect_transaction", CSI_reconnect_transaction,
			   RDB_reconnect_transaction, PSI_reconnect_transaction,
			   PSI5_reconnect_transaction, "_jrd8_reconnect_transaction",
			   IPI_reconnect_transaction, (STATUS *, struct att **,
										   struct tra **, SSHORT, UCHAR *))

	ENTRYPOINT("gds_receive", jrd8_receive, "jrd5_receive", REM_receive,
		   "_REM_receive", CSI_receive, RDB_receive, PSI_receive, PSI5_receive,	/* the bridge pipe server will have two less params, but should be OK */
			   "_jrd8_receive", IPI_receive, (STATUS *, struct req **, USHORT,
											  USHORT, SCHAR *, SSHORT))

	ENTRYPOINT("gds_release_request", jrd8_release_request,
		   "jrd5_release_request", REM_release_request,
		   "_REM_release_request", CSI_release_request, RDB_release_request,
PSI_release_request, PSI5_release_request, "_jrd8_release_request", IPI_release_request, (STATUS *,
															struct req **))

	ENTRYPOINT("gds_request_info", jrd8_request_info, "jrd5_request_info",
		   REM_request_info, "_REM_request_info", CSI_request_info,
			   RDB_request_info, PSI_request_info, PSI5_request_info,
			   "_jrd8_request_info", IPI_request_info, (STATUS *,
														struct req **, SSHORT,
														SSHORT, SCHAR *,
														SSHORT, SCHAR *))
	...
	ENTRYPOINT("gds_start_multiple", jrd8_start_multiple, "jrd5_start_multiple",
   /****     REM_start_multiple    ***/ y_valve_no_entrypoint,
			   ...
			   IPI_start_multiple,
			   (STATUS *, struct tra **, USHORT, struct teb *))
...
"_jrd8_start_transaction", IPI_start_transaction, (STATUS *, struct tra **, SSHORT,...))
...
IPI_transaction_info, (STATUS *, struct tra **, SSHORT, SCHAR *, SSHORT, SCHAR *))
...
PSI_unwind_request,
PSI5_unwind_request,
"_jrd8_unwind_request", IPI_unwind_request, (STATUS *, struct req **, SSHORT))

	ENTRYPOINT("gds_commit_retaining",
		   jrd8_commit_retaining,
		   "jrd5_commit_retaining",
REM_commit_retaining, "_REM_commit_retaining", CSI_commit_retaining,
   /****     RDB_commit_retaining    ***/ y_valve_no_entrypoint,
			   PSI_commit_retaining,
			   PSI5_commit_retaining,
			   "_jrd8_commit_retaining",
			   IPI_commit_retaining, (STATUS *, struct tra **))

	ENTRYPOINT("gds_que_events",
		   jrd8_que_events,
		   "jrd5_que_events",
		   REM_que_events, "_REM_que_events", CSI_que_events,
   /****     RDB_que_events    ***/ y_valve_no_entrypoint,
	...
	ENTRYPOINT("gds_cancel_events", jrd8_cancel_events, "jrd5_cancel_events",
		   REM_cancel_events, "_REM_cancel_events", CSI_cancel_events,
   /****     RDB_cancel_events    ***/ y_valve_no_entrypoint,
			   PSI_cancel_events,
			   PSI5_cancel_events,
			   "_jrd8_cancel_events",
			   IPI_cancel_events, (STATUS *, struct att **, SLONG *))

	ENTRYPOINT("gds_ddl", jrd8_ddl,
   /****   "jrd5_ddl"   ***/ NULL,
			   REM_ddl, "_REM_ddl", CSI_ddl,
   /****     RDB_ddl    ***/ y_valve_no_entrypoint,
			   PSI_ddl,
			   PSI5_ddl,
			   "_jrd8_ddl",
			   IPI_ddl,
			   (STATUS *, struct att **, struct tra **, USHORT, SCHAR *))

	ENTRYPOINT("gds_open_blob2",
		   jrd8_open_blob2,
		   "jrd5_open_blob2",
		   REM_open_blob2, "_REM_open_blob2", CSI_open_blob2,
   /****     RDB_open_blob2    ***/ y_valve_no_entrypoint,
			   PSI_open_blob2,
			   PSI5_open_blob2,
			   "_jrd8_open_blob2",
			   IPI_open_blob2,
			   (STATUS *, struct att **, struct tra **, struct blb **,
				struct bid *, USHORT, UCHAR *))

	ENTRYPOINT("gds_create_blob2", jrd8_create_blob2, "jrd5_create_blob2",
		   REM_create_blob2, "_REM_create_blob2", CSI_create_blob2,
   /****     RDB_create_blob2    ***/ y_valve_no_entrypoint,
	...
	ENTRYPOINT("gds_get_slice", jrd8_get_slice, "jrd5_get_slice", REM_get_slice,
		   "_REM_get_slice", CSI_get_slice,
   /****     RDB_get_slice    ***/ y_valve_no_entrypoint,
			   PSI_get_slice,
			   PSI5_get_slice,
			   "_jrd8_get_slice",
			   IPI_get_slice,
			   (STATUS *, struct att **, struct tra **, SLONG *, USHORT,
				UCHAR *, USHORT, UCHAR *, SLONG, UCHAR *, SLONG *))

	ENTRYPOINT("gds_put_slice", jrd8_put_slice, "jrd5_put_slice", REM_put_slice,
		   "_REM_put_slice", CSI_put_slice,
   /****     RDB_put_slice    ***/ y_valve_no_entrypoint,
	...
	ENTRYPOINT("gds_seek_blob", jrd8_seek_blob, "jrd5_seek_blob", REM_seek_blob,
		   "_REM_seek_blob", CSI_seek_blob,
   /****     RDB_seek_blob    ***/ y_valve_no_entrypoint,
	...
	ENTRYPOINT("isc_transact_request", jrd8_transact_request,
   /****   "jrd5_transact_request"   ***/ NULL,
			   REM_transact_request,
			   "_REM_transact_request", CSI_transact_request,
   ...
   /****    PSI5_transact_request    ***/ y_valve_no_entrypoint,
	...
	ENTRYPOINT("isc_drop_database", jrd8_drop_database,
   ...
   /****    PSI5_drop_database    ***/ y_valve_no_entrypoint,
			   "_jrd8_drop_database",
			   IPI_drop_database, (STATUS *, struct att **))

/* and the DSQL entry points */
	ENTRYPOINT("isc_dsql_allocate_statement",
   /****         jrd8_allocate_statement    ***/
			   y_valve_no_entrypoint,
			   "LDSQL_allocate_statement", REM_allocate_statement,
   /****        "_REM_allocate_statement"   ***/ "no_entrypoint",
			   CSI_allocate_statement,
   /****          RDB_allocate_statement    ***/
			   y_valve_no_entrypoint,
			   PSI_allocate_statement, PSI5_allocate_statement,
   ...
   /****         jrd8_execute_immediate    ***/
			   y_valve_no_entrypoint,
			   "LDSQL_execute_immediate", REM_execute_immediate,
   /****        "_REM_execute_immediate"   ***/ "no_entrypoint",
			   CSI_execute_immediate,
   /****          RDB_execute_immediate    ***/
			   y_valve_no_entrypoint,
			   PSI_execute_immediate, PSI5_execute_immediate,
   ...
   /****       "_jrd8_fetch"   ***/ "no_entrypoint",
			   IPI_fetch,
			   (STATUS *, struct rsr **, USHORT, UCHAR *, USHORT, USHORT,
				UCHAR *))

	ENTRYPOINT("isc_dsql_free_statement",
   /****         jrd8_free_statement    ***/
			   y_valve_no_entrypoint,
			   "LDSQL_free_statement", REM_free_statement,
   /****        "_REM_free_statement"   ***/ "no_entrypoint",
			   CSI_free_statement,
   /****          RDB_free_statement    ***/
			   y_valve_no_entrypoint,
			   PSI_free_statement, PSI5_free_statement,
   /****       "_jrd8_free_statement"   ***/ "no_entrypoint",
			   IPI_free_statement, (STATUS *, struct rsr **, USHORT))
   ...
   /****         jrd8_set_cursor    ***/ y_valve_no_entrypoint,
			   "LDSQL_set_cursor", REM_set_cursor_name,
   /****        "_REM_set_cursor"   ***/ "no_entrypoint",
			   CSI_set_cursor_name,
   /****          RDB_set_cursor    ***/ y_valve_no_entrypoint,
			   PSI_set_cursor_name, PSI5_set_cursor_name,
...
/* and service entry points */
	ENTRYPOINT("isc_service_attach", jrd8_service_attach,
   /****   "jrd5_service_attach"   ***/ NULL,
			   REM_service_attach, "REM_service_attach",
   ...
   /****    PSI5_rollback_retaining    ***/ y_valve_no_entrypoint,
			   ...
			   IPI_rollback_retaining, (STATUS *, struct tra **))
...
ENTRYPOINT("gds_attach_database",
		   ...
		   RDB_attach_database,
		   PSI_attach_database,
		   PSI5_attach_database, "_jrd8_attach_database", IPI_attach_database)
	...
	ENTRYPOINT("gds_blob_info",
		   ...
		   "_REM_blob_info",
CSI_blob_info,
RDB_blob_info, PSI_blob_info, PSI5_blob_info, "_jrd8_blob_info", IPI_blob_info)
...
CSI_cancel_blob,
RDB_cancel_blob,
PSI_cancel_blob, PSI5_cancel_blob, "_jrd8_cancel_blob", IPI_cancel_blob)
	...
	CSI_close_blob,
	RDB_close_blob,
	PSI_close_blob, PSI5_close_blob, "_jrd8_close_blob", IPI_close_blob)
...
PSI_commit_transaction, PSI5_commit_transaction, "_jrd8_commit_transaction", IPI_commit_transaction)
...
RDB_compile_request,
PSI_compile_request,
PSI5_compile_request, "_jrd8_compile_request", IPI_compile_request)
   ...
   /****    PSI5_create_database    ***/ no_entrypoint,
			   "_jrd8_create_database", IPI_create_database)
...
CSI_database_info,
RDB_database_info,
PSI_database_info, PSI5_database_info, "_jrd8_database_info", IPI_database_info)
...
RDB_detach_database,
PSI_detach_database,
PSI5_detach_database, "_jrd8_detach_database", IPI_detach_database)
...
CSI_get_segment,
RDB_get_segment,
PSI_get_segment, PSI5_get_segment, "_jrd8_get_segment", IPI_get_segment)
...
PSI_prepare_transaction, PSI5_prepare_transaction, "_jrd8_prepare_transaction", IPI_prepare_transaction)
...
CSI_put_segment,
RDB_put_segment,
PSI_put_segment, PSI5_put_segment, "_jrd8_put_segment", IPI_put_segment)
...
PSI_reconnect_transaction, PSI5_reconnect_transaction, "_jrd8_reconnect_transaction", IPI_reconnect_transaction)

	ENTRYPOINT("gds_receive",
		   jrd8_receive, "jrd5_receive", REM_receive, "_REM_receive", CSI_receive, RDB_receive, PSI_receive, PSI5_receive,	/* the bridge pipe server will have two less params, but should be OK */
			   "_jrd8_receive", IPI_receive)
...
RDB_release_request,
PSI_release_request,
PSI5_release_request, "_jrd8_release_request", IPI_release_request)
...
CSI_request_info,
RDB_request_info,
PSI_request_info, PSI5_request_info, "_jrd8_request_info", IPI_request_info)
...
PSI_rollback_transaction, PSI5_rollback_transaction, "_jrd8_rollback_transaction", IPI_rollback_transaction)
...
CSI_start_and_send,
RDB_start_and_send,
PSI_start_and_send, PSI5_start_and_send, "_jrd8_start_and_send", IPI_start_and_send)
...
CSI_start_request,
RDB_start_request,
PSI_start_request, PSI5_start_request, "_jrd8_start_request", IPI_start_request)
   ...
   /****     REM_start_multiple    ***/ no_entrypoint,
			   ...
			   PSI_start_multiple,
			   PSI5_start_multiple,
			   "_jrd8_start_multiple", IPI_start_multiple)
...
CSI_start_transaction,
RDB_start_transaction,
PSI_start_transaction, PSI5_start_transaction, "_jrd8_start_transaction", IPI_start_transaction)
...
CSI_transaction_info,
RDB_transaction_info,
PSI_transaction_info, PSI5_transaction_info, "_jrd8_transaction_info", IPI_transaction_info)
...
CSI_unwind_request,
RDB_unwind_request,
PSI_unwind_request, PSI5_unwind_request, "_jrd8_unwind_request", IPI_unwind_request)
...
REM_commit_retaining, "_REM_commit_retaining", CSI_commit_retaining,
   /****     RDB_commit_retaining    ***/ no_entrypoint,
			   PSI_commit_retaining,
			   PSI5_commit_retaining,
			   "_jrd8_commit_retaining", IPI_commit_retaining)
   ...
   /****     RDB_que_events    ***/ no_entrypoint,
			   PSI_que_events,
			   PSI5_que_events, "_jrd8_que_events", IPI_que_events)
   ...
   /****     RDB_cancel_events    ***/ no_entrypoint,
			   PSI_cancel_events,
			   PSI5_cancel_events, "_jrd8_cancel_events", IPI_cancel_events)

	ENTRYPOINT("gds_ddl", jrd8_ddl,
   /****   "jrd5_ddl"   ***/ NULL,
			   REM_ddl, "_REM_ddl", CSI_ddl,
   /****     RDB_ddl    ***/ no_entrypoint,
			   PSI_ddl, PSI5_ddl, "_jrd8_ddl", IPI_ddl)
   ...
   /****     RDB_open_blob2    ***/ no_entrypoint,
			   PSI_open_blob2,
			   PSI5_open_blob2, "_jrd8_open_blob2", IPI_open_blob2)
   ...
   /****     RDB_create_blob2    ***/ no_entrypoint,
			   PSI_create_blob2,
			   PSI5_create_blob2, "_jrd8_create_blob2", IPI_create_blob2)

	ENTRYPOINT("gds_get_slice",
		   jrd8_get_slice,
		   "jrd5_get_slice", REM_get_slice, "_REM_get_slice", CSI_get_slice,
   /****     RDB_get_slice    ***/ no_entrypoint,
			   PSI_get_slice,
			   PSI5_get_slice, "_jrd8_get_slice", IPI_get_slice)

	ENTRYPOINT("gds_put_slice",
		   jrd8_put_slice,
		   "jrd5_put_slice", REM_put_slice, "_REM_put_slice", CSI_put_slice,
   /****     RDB_put_slice    ***/ no_entrypoint,
			   PSI_put_slice,
			   PSI5_put_slice, "_jrd8_put_slice", IPI_put_slice)

	ENTRYPOINT("gds_seek_blob",
		   jrd8_seek_blob,
		   "jrd5_seek_blob", REM_seek_blob, "_REM_seek_blob", CSI_seek_blob,
   /****     RDB_seek_blob    ***/ no_entrypoint,
			   PSI_seek_blob,
			   PSI5_seek_blob, "_jrd8_seek_blob", IPI_seek_blob)
   ...
   /****    PSI5_transact_request    ***/ no_entrypoint,
			   "_jrd8_transact_request", IPI_transact_request)
   ...
   /****    PSI5_drop_database    ***/ no_entrypoint,
			   "_jrd8_drop_database", IPI_drop_database)
...
/* and service entry points */
   ...
   /****    PSI5_service_attach    ***/ no_entrypoint,
			   "_jrd8_service_attach", IPI_service_attach)
   ...
   /****    PSI5_service_detach    ***/ no_entrypoint,
			   "_jrd8_service_detach", IPI_service_detach)
   ...
   /****    PSI5_service_query    ***/ no_entrypoint,
			   "_jrd8_service_query", IPI_service_query)
   ...
   /****    PSI5_service_start    ***/ no_entrypoint,
			   "_jrd8_service_start", IPI_service_start)
   ...
   /****    PSI5_rollback_retaining    ***/ no_entrypoint,
			   "_jrd8_rollback_retaining", IPI_rollback_retaining)
#ifdef CANCEL_OPERATION
	ENTRYPOINT("gds_cancel_operation", jrd8_cancel_operation,
   /***    "jrd5_cancel_operation"  ***/ NULL,
