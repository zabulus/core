...
static SLONG get_merge_record(thread_db* tdbb, RecordSource* rsb, irsb_mrg::irsb_mrg_repeat* impure)
{
/**************************************
 *
...
bool RSE_internal_get_record(thread_db* tdbb, RecordSource* rsb, RecordSource* parent_rsb)
{
/**************************************
 *
