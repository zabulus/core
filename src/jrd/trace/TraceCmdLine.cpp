...
static void usage(UtilSvc* uSvc, const char* message, ...)
{
	...
	fprintf(stderr,
		...
		"\n"
		"Examples: \n"
		"  fbtracemgr -SE remote_host:serice_mgr -USER SYSDBA -PASS masterkey -LIST\n"
		"  fbtracemgr -SE serice_mgr -START -NAME my_trace -CONFIG my_cfg.txt\n"
		"  fbtracemgr -SE serice_mgr -SUSPEND -ID 2\n"
		"  fbtracemgr -SE serice_mgr -RESUME -ID 2\n"
		"  fbtracemgr -SE serice_mgr -STOP -ID 4\n"
		"\n"
		"Notes:\n"
