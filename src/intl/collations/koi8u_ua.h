...
static const SortOrderTblEntry NoCaseOrderTbl [ NOCASESORT_LEN ] = {
	...
	{ FIRST_PRIMARY + 134, NULL_SECONDARY, FIRST_TERTIARY + 0, 0, 0 }, /* 164 § */
	{ FIRST_PRIMARY +  78, FIRST_SECONDARY + 2, NULL_TERTIARY, 0, 0 }, /* 165 • */
	{ FIRST_PRIMARY + 138, NULL_SECONDARY, FIRST_TERTIARY + 0, 0, 0 }, /* 166 ¶ */
	{ FIRST_PRIMARY + 139, NULL_SECONDARY, FIRST_TERTIARY + 0, 0, 0 }, /* 167 ß */
	{ FIRST_PRIMARY +  79, FIRST_SECONDARY + 1, NULL_TERTIARY, 0, 0 }, /* 168 ® */
	...
	{ FIRST_PRIMARY + 131, FIRST_SECONDARY + 1, FIRST_TERTIARY + 0, 0, 0 }, /* 173 ≠ */
	{ FIRST_PRIMARY + 151, NULL_SECONDARY, FIRST_TERTIARY + 0, 0, 0 }, /* 174 Æ */
	...
	{ FIRST_PRIMARY + 134, NULL_SECONDARY, FIRST_TERTIARY + 1, 0, 0 }, /* 180 ¥ */
	{ FIRST_PRIMARY +  83, FIRST_SECONDARY + 2, NULL_TERTIARY, 0, 0 }, /* 181 µ */
	{ FIRST_PRIMARY + 138, NULL_SECONDARY, FIRST_TERTIARY + 1, 0, 0 }, /* 182 ∂ */
	{ FIRST_PRIMARY + 139, NULL_SECONDARY, FIRST_TERTIARY + 1, 0, 0 }, /* 183 ∑ */
	{ FIRST_PRIMARY +  84, FIRST_SECONDARY + 1, NULL_TERTIARY, 0, 0 }, /* 184 ∏ */
	...
	{ FIRST_PRIMARY + 131, FIRST_SECONDARY + 1, FIRST_TERTIARY + 1, 0, 0 }, /* 189 Ω */
	{ FIRST_PRIMARY + 151, NULL_SECONDARY, FIRST_TERTIARY + 1, 0, 0 }, /* 190 æ */
	{ FIRST_PRIMARY +  89, NULL_SECONDARY, NULL_TERTIARY, 0, 0 }, /* 191 ø */
	{ FIRST_PRIMARY + 161, NULL_SECONDARY, FIRST_TERTIARY + 0, 0, 0 }, /* 192 ¿ */
	{ FIRST_PRIMARY + 128, NULL_SECONDARY, FIRST_TERTIARY + 0, 0, 0 }, /* 193 ¡ */
	{ FIRST_PRIMARY + 129, NULL_SECONDARY, FIRST_TERTIARY + 0, 0, 0 }, /* 194 ¬ */
	{ FIRST_PRIMARY + 154, NULL_SECONDARY, FIRST_TERTIARY + 0, 0, 0 }, /* 195 √ */
	{ FIRST_PRIMARY + 132, NULL_SECONDARY, FIRST_TERTIARY + 0, 0, 0 }, /* 196 ƒ */
	{ FIRST_PRIMARY + 133, FIRST_SECONDARY + 0, FIRST_TERTIARY + 0, 0, 0 }, /* 197 ≈ */
	{ FIRST_PRIMARY + 152, NULL_SECONDARY, FIRST_TERTIARY + 0, 0, 0 }, /* 198 ∆ */
	{ FIRST_PRIMARY + 131, FIRST_SECONDARY + 0, FIRST_TERTIARY + 0, 0, 0 }, /* 199 « */
	{ FIRST_PRIMARY + 153, NULL_SECONDARY, FIRST_TERTIARY + 0, 0, 0 }, /* 200 » */
	{ FIRST_PRIMARY + 137, NULL_SECONDARY, FIRST_TERTIARY + 0, 0, 0 }, /* 201 … */
	{ FIRST_PRIMARY + 140, NULL_SECONDARY, FIRST_TERTIARY + 0, 0, 0 }, /* 202   */
	{ FIRST_PRIMARY + 141, NULL_SECONDARY, FIRST_TERTIARY + 0, 0, 0 }, /* 203 À */
	{ FIRST_PRIMARY + 142, NULL_SECONDARY, FIRST_TERTIARY + 0, 0, 0 }, /* 204 Ã */
	{ FIRST_PRIMARY + 143, NULL_SECONDARY, FIRST_TERTIARY + 0, 0, 0 }, /* 205 Õ */
	{ FIRST_PRIMARY + 144, NULL_SECONDARY, FIRST_TERTIARY + 0, 0, 0 }, /* 206 Œ */
	{ FIRST_PRIMARY + 145, NULL_SECONDARY, FIRST_TERTIARY + 0, 0, 0 }, /* 207 œ */
	{ FIRST_PRIMARY + 146, NULL_SECONDARY, FIRST_TERTIARY + 0, 0, 0 }, /* 208 – */
	{ FIRST_PRIMARY + 162, NULL_SECONDARY, FIRST_TERTIARY + 0, 0, 0 }, /* 209 — */
	{ FIRST_PRIMARY + 147, NULL_SECONDARY, FIRST_TERTIARY + 0, 0, 0 }, /* 210 “ */
	{ FIRST_PRIMARY + 148, NULL_SECONDARY, FIRST_TERTIARY + 0, 0, 0 }, /* 211 ” */
	{ FIRST_PRIMARY + 149, NULL_SECONDARY, FIRST_TERTIARY + 0, 0, 0 }, /* 212 ‘ */
	{ FIRST_PRIMARY + 150, NULL_SECONDARY, FIRST_TERTIARY + 0, 0, 0 }, /* 213 ’ */
	{ FIRST_PRIMARY + 135, NULL_SECONDARY, FIRST_TERTIARY + 0, 0, 0 }, /* 214 ÷ */
	{ FIRST_PRIMARY + 130, NULL_SECONDARY, FIRST_TERTIARY + 0, 0, 0 }, /* 215 ◊ */
	{ FIRST_PRIMARY + 163, NULL_SECONDARY, NULL_TERTIARY, 0, 0 }, /* 216 ÿ */
	{ FIRST_PRIMARY + 159, NULL_SECONDARY, FIRST_TERTIARY + 0, 0, 0 }, /* 217 Ÿ */
	{ FIRST_PRIMARY + 136, NULL_SECONDARY, FIRST_TERTIARY + 0, 0, 0 }, /* 218 ⁄ */
	{ FIRST_PRIMARY + 156, NULL_SECONDARY, FIRST_TERTIARY + 0, 0, 0 }, /* 219 € */
	{ FIRST_PRIMARY + 160, NULL_SECONDARY, FIRST_TERTIARY + 0, 0, 0 }, /* 220 ‹ */
	{ FIRST_PRIMARY + 157, NULL_SECONDARY, FIRST_TERTIARY + 0, 0, 0 }, /* 221 › */
	{ FIRST_PRIMARY + 155, NULL_SECONDARY, FIRST_TERTIARY + 0, 0, 0 }, /* 222 ﬁ */
	{ FIRST_PRIMARY + 158, NULL_SECONDARY, FIRST_TERTIARY + 0, 0, 0 }, /* 223 ﬂ */
	{ FIRST_PRIMARY + 161, NULL_SECONDARY, FIRST_TERTIARY + 1, 0, 0 }, /* 224 ‡ */
	{ FIRST_PRIMARY + 128, NULL_SECONDARY, FIRST_TERTIARY + 1, 0, 0 }, /* 225 · */
	{ FIRST_PRIMARY + 129, NULL_SECONDARY, FIRST_TERTIARY + 1, 0, 0 }, /* 226 ‚ */
	{ FIRST_PRIMARY + 154, NULL_SECONDARY, FIRST_TERTIARY + 1, 0, 0 }, /* 227 „ */
	{ FIRST_PRIMARY + 132, NULL_SECONDARY, FIRST_TERTIARY + 1, 0, 0 }, /* 228 ‰ */
	{ FIRST_PRIMARY + 133, FIRST_SECONDARY + 0, FIRST_TERTIARY + 1, 0, 0 }, /* 229 Â */
	{ FIRST_PRIMARY + 152, NULL_SECONDARY, FIRST_TERTIARY + 1, 0, 0 }, /* 230 Ê */
	{ FIRST_PRIMARY + 131, FIRST_SECONDARY + 0, FIRST_TERTIARY + 1, 0, 0 }, /* 231 Á */
	{ FIRST_PRIMARY + 153, NULL_SECONDARY, FIRST_TERTIARY + 1, 0, 0 }, /* 232 Ë */
	{ FIRST_PRIMARY + 137, NULL_SECONDARY, FIRST_TERTIARY + 1, 0, 0 }, /* 233 È */
	{ FIRST_PRIMARY + 140, NULL_SECONDARY, FIRST_TERTIARY + 1, 0, 0 }, /* 234 Í */
	{ FIRST_PRIMARY + 141, NULL_SECONDARY, FIRST_TERTIARY + 1, 0, 0 }, /* 235 Î */
	{ FIRST_PRIMARY + 142, NULL_SECONDARY, FIRST_TERTIARY + 1, 0, 0 }, /* 236 Ï */
	{ FIRST_PRIMARY + 143, NULL_SECONDARY, FIRST_TERTIARY + 1, 0, 0 }, /* 237 Ì */
	{ FIRST_PRIMARY + 144, NULL_SECONDARY, FIRST_TERTIARY + 1, 0, 0 }, /* 238 Ó */
	{ FIRST_PRIMARY + 145, NULL_SECONDARY, FIRST_TERTIARY + 1, 0, 0 }, /* 239 Ô */
	{ FIRST_PRIMARY + 146, NULL_SECONDARY, FIRST_TERTIARY + 1, 0, 0 }, /* 240  */
	{ FIRST_PRIMARY + 162, NULL_SECONDARY, FIRST_TERTIARY + 1, 0, 0 }, /* 241 Ò */
	{ FIRST_PRIMARY + 147, NULL_SECONDARY, FIRST_TERTIARY + 1, 0, 0 }, /* 242 Ú */
	{ FIRST_PRIMARY + 148, NULL_SECONDARY, FIRST_TERTIARY + 1, 0, 0 }, /* 243 Û */
	{ FIRST_PRIMARY + 149, NULL_SECONDARY, FIRST_TERTIARY + 1, 0, 0 }, /* 244 Ù */
	{ FIRST_PRIMARY + 150, NULL_SECONDARY, FIRST_TERTIARY + 1, 0, 0 }, /* 245 ı */
	{ FIRST_PRIMARY + 135, NULL_SECONDARY, FIRST_TERTIARY + 1, 0, 0 }, /* 246 ˆ */
	{ FIRST_PRIMARY + 130, NULL_SECONDARY, FIRST_TERTIARY + 1, 0, 0 }, /* 247 ˜ */
	{ FIRST_PRIMARY + 163, NULL_SECONDARY, NULL_TERTIARY, 0, 0 }, /* 248 ¯ */
	{ FIRST_PRIMARY + 159, NULL_SECONDARY, FIRST_TERTIARY + 1, 0, 0 }, /* 249 ˘ */
	{ FIRST_PRIMARY + 136, NULL_SECONDARY, FIRST_TERTIARY + 1, 0, 0 }, /* 250 ˙ */
	{ FIRST_PRIMARY + 156, NULL_SECONDARY, FIRST_TERTIARY + 1, 0, 0 }, /* 251 ˚ */
	{ FIRST_PRIMARY + 160, NULL_SECONDARY, FIRST_TERTIARY + 1, 0, 0 }, /* 252 ¸ */
	{ FIRST_PRIMARY + 157, NULL_SECONDARY, FIRST_TERTIARY + 1, 0, 0 }, /* 253 ˝ */
	{ FIRST_PRIMARY + 155, NULL_SECONDARY, FIRST_TERTIARY + 1, 0, 0 }, /* 254 ˛ */
	{ FIRST_PRIMARY + 158, NULL_SECONDARY, FIRST_TERTIARY + 1, 0, 0 }  /* 255 ˇ */
};
