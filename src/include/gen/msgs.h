...
%s"},		/* 193, wal_bugcheck */
	...
	{335740929, "data base file name (%s) already given"},		/* 555, gfix_db_name */
	{335740930, "invalid switch %s"},		/* 556, gfix_invalid_sw */
	{335740932, "incompatible switch combination"},		/* 557, gfix_incmp_sw */
	{335740933, "replay log pathname required"},		/* 558, gfix_replay_req */
	{335740934, "number of page buffers for cache required"},		/* 559, gfix_pgbuf_req */
	{335740935, "numeric value required"},		/* 560, gfix_val_req */
	{335740936, "positive numeric value required"},		/* 561, gfix_pval_req */
	{335740937, "number of transactions per sweep required"},		/* 562, gfix_trn_req */
	{335740940, "\"full\" or \"reserve\" required"},		/* 563, gfix_full_req */
	{335740941, "user name required"},		/* 564, gfix_usrname_req */
	{335740942, "password required"},		/* 565, gfix_pass_req */
	{335740943, "subsystem name"},		/* 566, gfix_subs_name */
	{335740944, "\"wal\" required"},		/* 567, gfix_wal_req */
	{335740945, "number of seconds required"},		/* 568, gfix_sec_req */
	{335740946, "numeric value between 0 and 32767 inclusive required"},		/* 569, gfix_nval_req */
	{335740947, "must specify type of shutdown"},		/* 570, gfix_type_shut */
	{335740948, "please retry, specifying an option"},		/* 571, gfix_retry */
	{335740951, "please retry, giving a database name"},		/* 572, gfix_retry_db */
	{335740991, "internal block exceeds maximum size"},		/* 573, gfix_exceed_max */
	{335740992, "corrupt pool"},		/* 574, gfix_corrupt_pool */
	{335740993, "virtual memory exhausted"},		/* 575, gfix_mem_exhausted */
	{335740994, "bad pool id"},		/* 576, gfix_bad_pool */
	{335740995, "Transaction state %d not in valid range."},		/* 577, gfix_trn_not_valid */
	{335741012, "unexpected end of input"},		/* 578, gfix_unexp_eoi */
	{335741018, "failed to reconnect to a transaction in database %s"},		/* 579, gfix_recon_fail */
	{335741036, "Transaction description item unknown"},		/* 580, gfix_trn_unknown */
	{335741038, "\"read_only\" or \"read_write\" required"},		/* 581, gfix_mode_req */
	{335741039, "	-sql_dialect	set database dialect n"},		/* 582, gfix_opt_SQL_dialect */
	{335741042, "positive or zero numeric value required"},		/* 583, gfix_pzval_req */
	{336003074, "Cannot SELECT RDB$DB_KEY from a stored procedure."},		/* 584, dsql_dbkey_from_non_table */
	{336003075, "Precision 10 to 18 changed from DOUBLE PRECISION in SQL dialect 1 to 64-bit scaled integer in SQL dialect 3"},		/* 585, dsql_transitional_numeric */
	{336003076, "Use of %s expression that returns different results in dialect 1 and dialect 3"},		/* 586, dsql_dialect_warning_expr */
	{336003077, "Database SQL dialect %d does not support reference to %s datatype"},		/* 587, sql_db_dialect_dtype_unsupport */
	{336003079, "DB dialect %d and client dialect %d conflict with respect to numeric precision %d."},		/* 588, isc_sql_dialect_conflict_num */
	{336003080, "WARNING: Numeric literal %s is interpreted as a floating-point"},		/* 589, dsql_warning_number_ambiguous */
	{336003081, "value in SQL dialect 1, but as an exact numeric value in SQL dialect 3."},		/* 590, dsql_warning_number_ambiguous1 */
	{336003082, "WARNING: NUMERIC and DECIMAL fields with precision 10 or greater are stored"},		/* 591, dsql_warn_precision_ambiguous */
	{336003083, "as approximate floating-point values in SQL dialect 1, but as 64-bit"},		/* 592, dsql_warn_precision_ambiguous1 */
	{336003084, "integers in SQL dialect 3."},		/* 593, dsql_warn_precision_ambiguous2 */
	{336003085, "Ambiguous field name between %s and %s"},		/* 594, dsql_ambiguous_field_name */
	{336003086, "External function should have return position between 1 and %d"},		/* 595, dsql_udf_return_pos_err */
	{336003087, "Label %s %s in the current scope"},		/* 596, dsql_invalid_label */
	{336003088, "Datatypes %sare not comparable in expression %s"},		/* 597, dsql_datatypes_not_comparable */
	{336003089, "Empty cursor name is not allowed"},		/* 598, dsql_cursor_invalid */
	{336003090, "Statement already has a cursor %s assigned"},		/* 599, dsql_cursor_redefined */
	{336003091, "Cursor %s is not found in the current context"},		/* 600, dsql_cursor_not_found */
	{336003092, "Cursor %s already exists in the current context"},		/* 601, dsql_cursor_exists */
	{336003093, "Relation %s is ambiguous in cursor %s"},		/* 602, dsql_cursor_rel_ambiguous */
	{336003094, "Relation %s is not found in cursor %s"},		/* 603, dsql_cursor_rel_not_found */
	{336003095, "Cursor is not open"},		/* 604, dsql_cursor_not_open */
	{336003096, "Data type %s is not supported for EXTERNAL TABLES. Relation '%s', field '%s'"},		/* 605, dsql_type_not_supp_ext_tab */
	{336003097, "Feature not supported on ODS version older than %d.%d"},		/* 606, dsql_feature_not_supported_ods */
	{336003098, "Primary key required on table %s"},		/* 607, primary_key_required */
	{336003099, "REPLACE field list does not match primary key of table %s"},		/* 608, replace_doesnt_match_pk */
	{336003100, "REPLACE field list does not match MATCHING clause"},		/* 609, replace_doesnt_match_matching */
	{336003101, "REPLACE without MATCHING could not be used with views based on more than one table"},		/* 610, replace_with_complex_view */
	{336068796, "SQL role %s does not exist"},		/* 611, dyn_role_does_not_exist */
	{336068797, "user %s has no grant admin option on SQL role %s"},		/* 612, dyn_no_grant_admin_opt */
	{336068798, "user %s is not a member of SQL role %s"},		/* 613, dyn_user_not_role_member */
	{336068799, "%s is not the owner of SQL role %s"},		/* 614, dyn_delete_role_failed */
	{336068800, "%s is a SQL role and not a user"},		/* 615, dyn_grant_role_to_user */
	{336068801, "user name %s could not be used for SQL role"},		/* 616, dyn_inv_sql_role_name */
	{336068802, "SQL role %s already exists"},		/* 617, dyn_dup_sql_role */
	{336068803, "keyword %s can not be used as a SQL role name"},		/* 618, dyn_kywd_spec_for_role */
	{336068804, "SQL roles are not supported in on older versions of the database.  A backup and restore of the database is required."},		/* 619, dyn_roles_not_supported */
	{336068812, "Cannot rename domain %s to %s.  A domain with that name already exists."},		/* 620, dyn_domain_name_exists */
	{336068813, "Cannot rename column %s to %s.  A column with that name already exists in table %s."},		/* 621, dyn_field_name_exists */
	{336068814, "Column %s from table %s is referenced in %s"},		/* 622, dyn_dependency_exists */
	{336068815, "Cannot change datatype for column %s.  Changing datatype is not supported for BLOB or ARRAY columns."},		/* 623, dyn_dtype_invalid */
	{336068816, "New size specified for column %s must be at least %d characters."},		/* 624, dyn_char_fld_too_small */
	{336068817, "Cannot change datatype for %s.  Conversion from base type %s to %s is not supported."},		/* 625, dyn_invalid_dtype_conversion */
	{336068818, "Cannot change datatype for column %s from a character type to a non-character type."},		/* 626, dyn_dtype_conv_invalid */
	{336068820, "Zero length identifiers are not allowed"},		/* 627, dyn_zero_len_id */
	{336068840, "%s cannot reference %s"},		/* 628, dyn_wrong_gtt_scope */
	{336330753, "found unknown switch"},		/* 629, gbak_unknown_switch */
	{336330754, "page size parameter missing"},		/* 630, gbak_page_size_missing */
	{336330755, "Page size specified (%ld) greater than limit (16384 bytes)"},		/* 631, gbak_page_size_toobig */
	{336330756, "redirect location for output is not specified"},		/* 632, gbak_redir_ouput_missing */
	{336330757, "conflicting switches for backup/restore"},		/* 633, gbak_switches_conflict */
	{336330758, "device type %s not known"},		/* 634, gbak_unknown_device */
	{336330759, "protection is not there yet"},		/* 635, gbak_no_protection */
	{336330760, "page size is allowed only on restore or create"},		/* 636, gbak_page_size_not_allowed */
	{336330761, "multiple sources or destinations specified"},		/* 637, gbak_multi_source_dest */
	{336330762, "requires both input and output filenames"},		/* 638, gbak_filename_missing */
	{336330763, "input and output have the same name.  Disallowed."},		/* 639, gbak_dup_inout_names */
	{336330764, "expected page size, encountered \"%s\""},		/* 640, gbak_inv_page_size */
	{336330765, "REPLACE specified, but the first file %s is a database"},		/* 641, gbak_db_specified */
	{336330766, "database %s already exists.  To replace it, use the -REP switch"},		/* 642, gbak_db_exists */
	{336330767, "device type not specified"},		/* 643, gbak_unk_device */
	{336330772, "gds_$blob_info failed"},		/* 644, gbak_blob_info_failed */
	{336330773, "do not understand BLOB INFO item %ld"},		/* 645, gbak_unk_blob_item */
	{336330774, "gds_$get_segment failed"},		/* 646, gbak_get_seg_failed */
	{336330775, "gds_$close_blob failed"},		/* 647, gbak_close_blob_failed */
	{336330776, "gds_$open_blob failed"},		/* 648, gbak_open_blob_failed */
	{336330777, "Failed in put_blr_gen_id"},		/* 649, gbak_put_blr_gen_id_failed */
	{336330778, "data type %ld not understood"},		/* 650, gbak_unk_type */
	{336330779, "gds_$compile_request failed"},		/* 651, gbak_comp_req_failed */
	{336330780, "gds_$start_request failed"},		/* 652, gbak_start_req_failed */
	{336330781, " gds_$receive failed"},		/* 653, gbak_rec_failed */
	{336330782, "gds_$release_request failed"},		/* 654, gbak_rel_req_failed */
	{336330783, " gds_$database_info failed"},		/* 655, gbak_db_info_failed */
	{336330784, "Expected database description record"},		/* 656, gbak_no_db_desc */
	{336330785, "failed to create database %s"},		/* 657, gbak_db_create_failed */
	{336330786, "RESTORE: decompression length error"},		/* 658, gbak_decomp_len_error */
	{336330787, "cannot find table %s"},		/* 659, gbak_tbl_missing */
	{336330788, "Cannot find column for BLOB"},		/* 660, gbak_blob_col_missing */
	{336330789, "gds_$create_blob failed"},		/* 661, gbak_create_blob_failed */
	{336330790, "gds_$put_segment failed"},		/* 662, gbak_put_seg_failed */
	{336330791, "expected record length"},		/* 663, gbak_rec_len_exp */
	{336330792, "wrong length record, expected %ld encountered %ld"},		/* 664, gbak_inv_rec_len */
	{336330793, "expected data attribute"},		/* 665, gbak_exp_data_type */
	{336330794, "Failed in store_blr_gen_id"},		/* 666, gbak_gen_id_failed */
	{336330795, "do not recognize record type %ld"},		/* 667, gbak_unk_rec_type */
	{336330796, "Expected backup version 1..8.  Found %ld"},		/* 668, gbak_inv_bkup_ver */
	{336330797, "expected backup description record"},		/* 669, gbak_missing_bkup_desc */
	{336330798, "string truncated"},		/* 670, gbak_string_trunc */
	{336330799, " warning -- record could not be restored"},		/* 671, gbak_cant_rest_record */
	{336330800, "gds_$send failed"},		/* 672, gbak_send_failed */
	{336330801, "no table name for data"},		/* 673, gbak_no_tbl_name */
	{336330802, "unexpected end of file on backup file"},		/* 674, gbak_unexp_eof */
	{336330803, "database format %ld is too old to restore to"},		/* 675, gbak_db_format_too_old */
	{336330804, "array dimension for column %s is invalid"},		/* 676, gbak_inv_array_dim */
	{336330807, "Expected XDR record length"},		/* 677, gbak_xdr_len_expected */
	{336330817, "cannot open backup file %s"},		/* 678, gbak_open_bkup_error */
	{336330818, "cannot open status and error output file %s"},		/* 679, gbak_open_error */
	{336330934, "blocking factor parameter missing"},		/* 680, gbak_missing_block_fac */
	{336330935, "expected blocking factor, encountered \"%s\""},		/* 681, gbak_inv_block_fac */
	{336330936, "a blocking factor may not be used in conjunction with device CT"},		/* 682, gbak_block_fac_specified */
	{336330940, "user name parameter missing"},		/* 683, gbak_missing_username */
	{336330941, "password parameter missing"},		/* 684, gbak_missing_password */
	{336330952, " missing parameter for the number of bytes to be skipped"},		/* 685, gbak_missing_skipped_bytes */
	{336330953, "expected number of bytes to be skipped, encountered \"%s\""},		/* 686, gbak_inv_skipped_bytes */
	{336330965, "character set"},		/* 687, gbak_err_restore_charset */
	{336330967, "collation"},		/* 688, gbak_err_restore_collation */
	{336330972, "Unexpected I/O error while reading from backup file"},		/* 689, gbak_read_error */
	{336330973, "Unexpected I/O error while writing to backup file"},		/* 690, gbak_write_error */
	{336330985, "could not drop database %s (database might be in use)"},		/* 691, gbak_db_in_use */
	{336330990, "System memory exhausted"},		/* 692, gbak_sysmemex */
	{336331002, "SQL role"},		/* 693, gbak_restore_role_failed */
	{336331005, "SQL role parameter missing"},		/* 694, gbak_role_op_missing */
	{336331010, "page buffers parameter missing"},		/* 695, gbak_page_buffers_missing */
	{336331011, "expected page buffers, encountered \"%s\""},		/* 696, gbak_page_buffers_wrong_param */
	{336331012, "page buffers is allowed only on restore or create"},		/* 697, gbak_page_buffers_restore */
	{336331014, "size specification either missing or incorrect for file %s"},		/* 698, gbak_inv_size */
	{336331015, "file %s out of sequence"},		/* 699, gbak_file_outof_sequence */
	{336331016, "can't join -- one of the files missing"},		/* 700, gbak_join_file_missing */
	{336331017, " standard input is not supported when using join operation"},		/* 701, gbak_stdin_not_supptd */
	{336331018, "standard output is not supported when using split operation"},		/* 702, gbak_stdout_not_supptd */
	{336331019, "backup file %s might be corrupt"},		/* 703, gbak_bkup_corrupt */
	{336331020, "database file specification missing"},		/* 704, gbak_unk_db_file_spec */
	{336331021, "can't write a header record to file %s"},		/* 705, gbak_hdr_write_failed */
	{336331022, "free disk space exhausted"},		/* 706, gbak_disk_space_ex */
	{336331023, "file size given (%d) is less than minimum allowed (%d)"},		/* 707, gbak_size_lt_min */
	{336331025, "service name parameter missing"},		/* 708, gbak_svc_name_missing */
	{336331026, "Cannot restore over current database, must be SYSDBA or owner of the existing database."},		/* 709, gbak_not_ownr */
	{336331031, "\"read_only\" or \"read_write\" required"},		/* 710, gbak_mode_req */
	{336331033, "just data ignore all constraints etc."},		/* 711, gbak_just_data */
	{336331034, "restoring data only ignoring foreign key, unique, not null & other constraints"},		/* 712, gbak_data_only */
	{336397205, "ODS versions before ODS%d are not supported"},		/* 713, dsql_too_old_ods */
	{336397206, "Table %s does not exist"},		/* 714, dsql_table_not_found */
	{336397207, "View %s does not exist"},		/* 715, dsql_view_not_found */
	{336397208, "At line %d, column %d"},		/* 716, dsql_line_col_error */
	{336397209, "At unknown line and column"},		/* 717, dsql_unknown_pos */
	{336397210, "Column %s cannot be repeated in %s statement"},		/* 718, dsql_no_dup_name */
	{336397211, "Too many values (more than %d) in member list to match against"},		/* 719, dsql_too_many_values */
	{336397212, "Array and BLOB data types not allowed in computed field"},		/* 720, dsql_no_array_computed */
	{336397213, "Implicit domain name %s not allowed in user created domain"},		/* 721, dsql_implicit_domain_name */
	{336397214, "scalar operator used on field %s which is not an array"},		/* 722, dsql_only_can_subscript_array */
