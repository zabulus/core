...
@3"},		/* 193, wal_bugcheck */
	...
	{336068855, "Warning: @1 on @2 is not granted to @3."},		/* 641, dyn_miss_priv_warning */
	{336330753, "found unknown switch"},		/* 642, gbak_unknown_switch */
	{336330754, "page size parameter missing"},		/* 643, gbak_page_size_missing */
	{336330755, "Page size specified (@1) greater than limit (16384 bytes)"},		/* 644, gbak_page_size_toobig */
	{336330756, "redirect location for output is not specified"},		/* 645, gbak_redir_ouput_missing */
	{336330757, "conflicting switches for backup/restore"},		/* 646, gbak_switches_conflict */
	{336330758, "device type @1 not known"},		/* 647, gbak_unknown_device */
	{336330759, "protection is not there yet"},		/* 648, gbak_no_protection */
	{336330760, "page size is allowed only on restore or create"},		/* 649, gbak_page_size_not_allowed */
	{336330761, "multiple sources or destinations specified"},		/* 650, gbak_multi_source_dest */
	{336330762, "requires both input and output filenames"},		/* 651, gbak_filename_missing */
	{336330763, "input and output have the same name.  Disallowed."},		/* 652, gbak_dup_inout_names */
	{336330764, "expected page size, encountered \"@1\""},		/* 653, gbak_inv_page_size */
	{336330765, "REPLACE specified, but the first file @1 is a database"},		/* 654, gbak_db_specified */
	{336330766, "database @1 already exists.  To replace it, use the -REP switch"},		/* 655, gbak_db_exists */
	{336330767, "device type not specified"},		/* 656, gbak_unk_device */
	{336330772, "gds_$blob_info failed"},		/* 657, gbak_blob_info_failed */
	{336330773, "do not understand BLOB INFO item @1"},		/* 658, gbak_unk_blob_item */
	{336330774, "gds_$get_segment failed"},		/* 659, gbak_get_seg_failed */
	{336330775, "gds_$close_blob failed"},		/* 660, gbak_close_blob_failed */
	{336330776, "gds_$open_blob failed"},		/* 661, gbak_open_blob_failed */
	{336330777, "Failed in put_blr_gen_id"},		/* 662, gbak_put_blr_gen_id_failed */
	{336330778, "data type @1 not understood"},		/* 663, gbak_unk_type */
	{336330779, "gds_$compile_request failed"},		/* 664, gbak_comp_req_failed */
	{336330780, "gds_$start_request failed"},		/* 665, gbak_start_req_failed */
	{336330781, " gds_$receive failed"},		/* 666, gbak_rec_failed */
	{336330782, "gds_$release_request failed"},		/* 667, gbak_rel_req_failed */
	{336330783, " gds_$database_info failed"},		/* 668, gbak_db_info_failed */
	{336330784, "Expected database description record"},		/* 669, gbak_no_db_desc */
	{336330785, "failed to create database @1"},		/* 670, gbak_db_create_failed */
	{336330786, "RESTORE: decompression length error"},		/* 671, gbak_decomp_len_error */
	{336330787, "cannot find table @1"},		/* 672, gbak_tbl_missing */
	{336330788, "Cannot find column for BLOB"},		/* 673, gbak_blob_col_missing */
	{336330789, "gds_$create_blob failed"},		/* 674, gbak_create_blob_failed */
	{336330790, "gds_$put_segment failed"},		/* 675, gbak_put_seg_failed */
	{336330791, "expected record length"},		/* 676, gbak_rec_len_exp */
	{336330792, "wrong length record, expected @1 encountered @2"},		/* 677, gbak_inv_rec_len */
	{336330793, "expected data attribute"},		/* 678, gbak_exp_data_type */
	{336330794, "Failed in store_blr_gen_id"},		/* 679, gbak_gen_id_failed */
	{336330795, "do not recognize record type @1"},		/* 680, gbak_unk_rec_type */
	{336330796, "Expected backup version 1..8.  Found @1"},		/* 681, gbak_inv_bkup_ver */
	{336330797, "expected backup description record"},		/* 682, gbak_missing_bkup_desc */
	{336330798, "string truncated"},		/* 683, gbak_string_trunc */
	{336330799, " warning -- record could not be restored"},		/* 684, gbak_cant_rest_record */
	{336330800, "gds_$send failed"},		/* 685, gbak_send_failed */
	{336330801, "no table name for data"},		/* 686, gbak_no_tbl_name */
	{336330802, "unexpected end of file on backup file"},		/* 687, gbak_unexp_eof */
	{336330803, "database format @1 is too old to restore to"},		/* 688, gbak_db_format_too_old */
	{336330804, "array dimension for column @1 is invalid"},		/* 689, gbak_inv_array_dim */
	{336330807, "Expected XDR record length"},		/* 690, gbak_xdr_len_expected */
	{336330817, "cannot open backup file @1"},		/* 691, gbak_open_bkup_error */
	{336330818, "cannot open status and error output file @1"},		/* 692, gbak_open_error */
	{336330934, "blocking factor parameter missing"},		/* 693, gbak_missing_block_fac */
	{336330935, "expected blocking factor, encountered \"@1\""},		/* 694, gbak_inv_block_fac */
	{336330936, "a blocking factor may not be used in conjunction with device CT"},		/* 695, gbak_block_fac_specified */
	{336330940, "user name parameter missing"},		/* 696, gbak_missing_username */
	{336330941, "password parameter missing"},		/* 697, gbak_missing_password */
	{336330952, " missing parameter for the number of bytes to be skipped"},		/* 698, gbak_missing_skipped_bytes */
	{336330953, "expected number of bytes to be skipped, encountered \"@1\""},		/* 699, gbak_inv_skipped_bytes */
	{336330965, "character set"},		/* 700, gbak_err_restore_charset */
	{336330967, "collation"},		/* 701, gbak_err_restore_collation */
	{336330972, "Unexpected I/O error while reading from backup file"},		/* 702, gbak_read_error */
	{336330973, "Unexpected I/O error while writing to backup file"},		/* 703, gbak_write_error */
	{336330985, "could not drop database @1 (database might be in use)"},		/* 704, gbak_db_in_use */
	{336330990, "System memory exhausted"},		/* 705, gbak_sysmemex */
	{336331002, "SQL role"},		/* 706, gbak_restore_role_failed */
	{336331005, "SQL role parameter missing"},		/* 707, gbak_role_op_missing */
	{336331010, "page buffers parameter missing"},		/* 708, gbak_page_buffers_missing */
	{336331011, "expected page buffers, encountered \"@1\""},		/* 709, gbak_page_buffers_wrong_param */
	{336331012, "page buffers is allowed only on restore or create"},		/* 710, gbak_page_buffers_restore */
	{336331014, "size specification either missing or incorrect for file @1"},		/* 711, gbak_inv_size */
	{336331015, "file @1 out of sequence"},		/* 712, gbak_file_outof_sequence */
	{336331016, "can't join -- one of the files missing"},		/* 713, gbak_join_file_missing */
	{336331017, " standard input is not supported when using join operation"},		/* 714, gbak_stdin_not_supptd */
	{336331018, "standard output is not supported when using split operation"},		/* 715, gbak_stdout_not_supptd */
	{336331019, "backup file @1 might be corrupt"},		/* 716, gbak_bkup_corrupt */
	{336331020, "database file specification missing"},		/* 717, gbak_unk_db_file_spec */
	{336331021, "can't write a header record to file @1"},		/* 718, gbak_hdr_write_failed */
	{336331022, "free disk space exhausted"},		/* 719, gbak_disk_space_ex */
	{336331023, "file size given (@1) is less than minimum allowed (@2)"},		/* 720, gbak_size_lt_min */
	{336331025, "service name parameter missing"},		/* 721, gbak_svc_name_missing */
	{336331026, "Cannot restore over current database, must be SYSDBA or owner of the existing database."},		/* 722, gbak_not_ownr */
	{336331031, "\"read_only\" or \"read_write\" required"},		/* 723, gbak_mode_req */
	{336331033, "just data ignore all constraints etc."},		/* 724, gbak_just_data */
	{336331034, "restoring data only ignoring foreign key, unique, not null & other constraints"},		/* 725, gbak_data_only */
	{336397205, "ODS versions before ODS@1 are not supported"},		/* 726, dsql_too_old_ods */
	{336397206, "Table @1 does not exist"},		/* 727, dsql_table_not_found */
	{336397207, "View @1 does not exist"},		/* 728, dsql_view_not_found */
	{336397208, "At line @1, column @2"},		/* 729, dsql_line_col_error */
	{336397209, "At unknown line and column"},		/* 730, dsql_unknown_pos */
	{336397210, "Column @1 cannot be repeated in @2 statement"},		/* 731, dsql_no_dup_name */
	{336397211, "Too many values (more than @1) in member list to match against"},		/* 732, dsql_too_many_values */
	{336397212, "Array and BLOB data types not allowed in computed field"},		/* 733, dsql_no_array_computed */
	{336397213, "Implicit domain name @1 not allowed in user created domain"},		/* 734, dsql_implicit_domain_name */
	{336397214, "scalar operator used on field @1 which is not an array"},		/* 735, dsql_only_can_subscript_array */
	{336397215, "cannot sort on more than 255 items"},		/* 736, dsql_max_sort_items */
	{336397216, "cannot group on more than 255 items"},		/* 737, dsql_max_group_items */
	{336397217, "Cannot include the same field (@1.@2) twice in the ORDER BY clause with conflicting sorting options"},		/* 738, dsql_conflicting_sort_field */
	{336397218, "column list from derived table @1 has more columns than the number of items in its SELECT statement"},		/* 739, dsql_derived_table_more_columns */
	{336397219, "column list from derived table @1 has less columns than the number of items in its SELECT statement"},		/* 740, dsql_derived_table_less_columns */
	{336397220, "no column name specified for column number @1 in derived table @2"},		/* 741, dsql_derived_field_unnamed */
	{336397221, "column @1 was specified multiple times for derived table @2"},		/* 742, dsql_derived_field_dup_name */
	{336397222, "Internal dsql error: alias type expected by pass1_expand_select_node"},		/* 743, dsql_derived_alias_select */
	{336397223, "Internal dsql error: alias type expected by pass1_field"},		/* 744, dsql_derived_alias_field */
	{336397224, "Internal dsql error: column position out of range in pass1_union_auto_cast"},		/* 745, dsql_auto_field_bad_pos */
	{336397225, "Recursive CTE member (@1) can refer itself only in FROM clause"},		/* 746, dsql_cte_wrong_reference */
	{336397226, "CTE '@1' has cyclic dependencies"},		/* 747, dsql_cte_cycle */
	{336397227, "Recursive member of CTE can't be member of an outer join"},		/* 748, dsql_cte_outer_join */
	{336397228, "Recursive member of CTE can't reference itself more than once"},		/* 749, dsql_cte_mult_references */
	{336397229, "Recursive CTE (@1) must be an UNION"},		/* 750, dsql_cte_not_a_union */
	{336397230, "CTE '@1' defined non-recursive member after recursive"},		/* 751, dsql_cte_nonrecurs_after_recurs */
	{336397231, "Recursive member of CTE '@1' has @2 clause"},		/* 752, dsql_cte_wrong_clause */
