...
"Column used in a PRIMARY KEY constraint must be NOT NULL.",		/*211, primary_key_notnull             */
...
"Datatypes %sare not comparable in expression %s",		/*553, dsql_datatypes_not_comparable   */
"SQL role %s does not exist",		/*554, dyn_role_does_not_exist         */
"user %s has no grant admin option on SQL role %s",		/*555, dyn_no_grant_admin_opt          */
"user %s is not a member of SQL role %s",		/*556, dyn_user_not_role_member        */
"%s is not the owner of SQL role %s",		/*557, dyn_delete_role_failed          */
"%s is a SQL role and not a user",		/*558, dyn_grant_role_to_user          */
"user name %s could not be used for SQL role",		/*559, dyn_inv_sql_role_name           */
"SQL role %s already exists",		/*560, dyn_dup_sql_role                */
"keyword %s can not be used as a SQL role name",		/*561, dyn_kywd_spec_for_role          */
"SQL roles are not supported in on older versions of the database.  A backup and restore of the database is required.",		/*562, dyn_roles_not_supported         */
"Cannot rename domain %s to %s.  A domain with that name already exists.",		/*563, dyn_domain_name_exists          */
"Cannot rename column %s to %s.  A column with that name already exists in table %s.",		/*564, dyn_field_name_exists           */
"Column %s from table %s is referenced in %s",		/*565, dyn_dependency_exists           */
"Cannot change datatype for column %s.  Changing datatype is not supported for BLOB or ARRAY columns.",		/*566, dyn_dtype_invalid               */
"New size specified for column %s must be at least %d characters.",		/*567, dyn_char_fld_too_small          */
"Cannot change datatype for %s.  Conversion from base type %s to %s is not supported.",		/*568, dyn_invalid_dtype_conversion    */
"Cannot change datatype for column %s from a character type to a non-character type.",		/*569, dyn_dtype_conv_invalid          */
"Zero length identifiers are not allowed",		/*570, dyn_zero_len_id                 */
"found unknown switch",		/*571, gbak_unknown_switch             */
"page size parameter missing",		/*572, gbak_page_size_missing          */
"Page size specified (%ld) greater than limit (8192 bytes)",		/*573, gbak_page_size_toobig           */
"redirect location for output is not specified",		/*574, gbak_redir_ouput_missing        */
"conflicting switches for backup/restore",		/*575, gbak_switches_conflict          */
"device type %s not known",		/*576, gbak_unknown_device             */
"protection is not there yet",		/*577, gbak_no_protection              */
"page size is allowed only on restore or create",		/*578, gbak_page_size_not_allowed      */
"multiple sources or destinations specified",		/*579, gbak_multi_source_dest          */
"requires both input and output filenames",		/*580, gbak_filename_missing           */
"input and output have the same name.  Disallowed.",		/*581, gbak_dup_inout_names            */
"expected page size, encountered \"%s\"",		/*582, gbak_inv_page_size              */
"REPLACE specified, but the first file %s is a database",		/*583, gbak_db_specified               */
"database %s already exists.  To replace it, use the -R switch",		/*584, gbak_db_exists                  */
"device type not specified",		/*585, gbak_unk_device                 */
"gds_$blob_info failed",		/*586, gbak_blob_info_failed           */
"do not understand BLOB INFO item %ld",		/*587, gbak_unk_blob_item              */
"gds_$get_segment failed",		/*588, gbak_get_seg_failed             */
"gds_$close_blob failed",		/*589, gbak_close_blob_failed          */
"gds_$open_blob failed",		/*590, gbak_open_blob_failed           */
"Failed in put_blr_gen_id",		/*591, gbak_put_blr_gen_id_failed      */
"data type %ld not understood",		/*592, gbak_unk_type                   */
"gds_$compile_request failed",		/*593, gbak_comp_req_failed            */
"gds_$start_request failed",		/*594, gbak_start_req_failed           */
" gds_$receive failed",		/*595, gbak_rec_failed                 */
"gds_$release_request failed",		/*596, gbak_rel_req_failed             */
" gds_$database_info failed",		/*597, gbak_db_info_failed             */
"Expected database description record",		/*598, gbak_no_db_desc                 */
"failed to create database %s",		/*599, gbak_db_create_failed           */
"RESTORE: decompression length error",		/*600, gbak_decomp_len_error           */
"cannot find table %s",		/*601, gbak_tbl_missing                */
"Cannot find column for BLOB",		/*602, gbak_blob_col_missing           */
"gds_$create_blob failed",		/*603, gbak_create_blob_failed         */
"gds_$put_segment failed",		/*604, gbak_put_seg_failed             */
"expected record length",		/*605, gbak_rec_len_exp                */
"wrong length record, expected %ld encountered %ld",		/*606, gbak_inv_rec_len                */
"expected data attribute",		/*607, gbak_exp_data_type              */
"Failed in store_blr_gen_id",		/*608, gbak_gen_id_failed              */
"do not recognize record type %ld",		/*609, gbak_unk_rec_type               */
"Expected backup version 1, 2, or 3.  Found %ld",		/*610, gbak_inv_bkup_ver               */
"expected backup description record",		/*611, gbak_missing_bkup_desc          */
"string truncated",		/*612, gbak_string_trunc               */
" warning -- record could not be restored",		/*613, gbak_cant_rest_record           */
"gds_$send failed",		/*614, gbak_send_failed                */
"no table name for data",		/*615, gbak_no_tbl_name                */
"unexpected end of file on backup file",		/*616, gbak_unexp_eof                  */
"database format %ld is too old to restore to",		/*617, gbak_db_format_too_old          */
"array dimension for column %s is invalid",		/*618, gbak_inv_array_dim              */
"Expected XDR record length",		/*619, gbak_xdr_len_expected           */
"cannot open backup file %s",		/*620, gbak_open_bkup_error            */
"cannot open status and error output file %s",		/*621, gbak_open_error                 */
"blocking factor parameter missing",		/*622, gbak_missing_block_fac          */
"expected blocking factor, encountered \"%s\"",		/*623, gbak_inv_block_fac              */
"a blocking factor may not be used in conjunction with device CT",		/*624, gbak_block_fac_specified        */
"user name parameter missing",		/*625, gbak_missing_username           */
"password parameter missing",		/*626, gbak_missing_password           */
" missing parameter for the number of bytes to be skipped",		/*627, gbak_missing_skipped_bytes      */
"expected number of bytes to be skipped, encountered \"%s\"",		/*628, gbak_inv_skipped_bytes          */
"Bad attribute for RDB$CHARACTER_SETS",		/*629, gbak_err_restore_charset        */
"Bad attribute for RDB$COLLATIONS",		/*630, gbak_err_restore_collation      */
"Unexpected I/O error while reading from backup file",		/*631, gbak_read_error                 */
"Unexpected I/O error while writing to backup file",		/*632, gbak_write_error                */
"could not drop database %s (database might be in use)",		/*633, gbak_db_in_use                  */
"System memory exhausted",		/*634, gbak_sysmemex                   */
"Bad attributes for restoring SQL role",		/*635, gbak_restore_role_failed        */
"SQL role parameter missing",		/*636, gbak_role_op_missing            */
"page buffers parameter missing",		/*637, gbak_page_buffers_missing       */
"expected page buffers, encountered \"%s\"",		/*638, gbak_page_buffers_wrong_param   */
"page buffers is allowed only on restore or create",		/*639, gbak_page_buffers_restore       */
"size specification either missing or incorrect for file %s",		/*640, gbak_inv_size                   */
"file %s out of sequence",		/*641, gbak_file_outof_sequence        */
"can't join -- one of the files missing",		/*642, gbak_join_file_missing          */
" standard input is not supported when using join operation",		/*643, gbak_stdin_not_supptd           */
"standard output is not supported when using split operation",		/*644, gbak_stdout_not_supptd          */
"backup file %s might be corrupt",		/*645, gbak_bkup_corrupt               */
"database file specification missing",		/*646, gbak_unk_db_file_spec           */
"can't write a header record to file %s",		/*647, gbak_hdr_write_failed           */
"free disk space exhausted",		/*648, gbak_disk_space_ex              */
"file size given (%d) is less than minimum allowed (%d)",		/*649, gbak_size_lt_min                */
"service name parameter missing",		/*650, gbak_svc_name_missing           */
"Cannot restore over current database, must be SYSDBA or owner of the existing database.",		/*651, gbak_not_ownr                   */
"\"read_only\" or \"read_write\" required",		/*652, gbak_mode_req                   */
"just data ignore all constraints etc.",		/*653, gbak_just_data                  */
"restoring data only ignoring foreign key, unique, not null & other constraints",		/*654, gbak_data_only                  */
"unable to open database",		/*655, gsec_cant_open_db               */
"error in switch specifications",		/*656, gsec_switches_error             */
"no operation specified",		/*657, gsec_no_op_spec                 */
"no user name specified",		/*658, gsec_no_usr_name                */
"add record error",		/*659, gsec_err_add                    */
"modify record error",		/*660, gsec_err_modify                 */
"find/modify record error",		/*661, gsec_err_find_mod               */
"record not found for user: %s",		/*662, gsec_err_rec_not_found          */
"delete record error",		/*663, gsec_err_delete                 */
"find/delete record error",		/*664, gsec_err_find_del               */
"find/display record error",		/*665, gsec_err_find_disp              */
"invalid parameter, no switch defined",		/*666, gsec_inv_param                  */
"operation already specified",		/*667, gsec_op_specified               */
"password already specified",		/*668, gsec_pw_specified               */
"uid already specified",		/*669, gsec_uid_specified              */
"gid already specified",		/*670, gsec_gid_specified              */
"project already specified",		/*671, gsec_proj_specified             */
"organization already specified",		/*672, gsec_org_specified              */
"first name already specified",		/*673, gsec_fname_specified            */
"middle name already specified",		/*674, gsec_mname_specified            */
"last name already specified",		/*675, gsec_lname_specified            */
"invalid switch specified",		/*676, gsec_inv_switch                 */
"ambiguous switch specified",		/*677, gsec_amb_switch                 */
"no operation specified for parameters",		/*678, gsec_no_op_specified            */
"no parameters allowed for this operation",		/*679, gsec_params_not_allowed         */
"incompatible switches specified",		/*680, gsec_incompat_switch            */
"Invalid user name (maximum 31 bytes allowed)",		/*681, gsec_inv_username               */
"Warning - maximum 8 significant bytes of password used",		/*682, gsec_inv_pw_length              */
"database already specified",		/*683, gsec_db_specified               */
"database administrator name already specified",		/*684, gsec_db_admin_specified         */
"database administrator password already specified",		/*685, gsec_db_admin_pw_specified      */
"SQL role name already specified",		/*686, gsec_sql_role_specified         */
"The license file does not exist or could not be opened for read",		/*687, license_no_file                 */
"operation already specified",		/*688, license_op_specified            */
"no operation specified",		/*689, license_op_missing              */
"invalid switch",		/*690, license_inv_switch              */
"invalid switch combination",		/*691, license_inv_switch_combo        */
"illegal operation/switch combination",		/*692, license_inv_op_combo            */
"ambiguous switch",		/*693, license_amb_switch              */
"invalid parameter, no switch specified",		/*694, license_inv_parameter           */
"switch does not take any parameter",		/*695, license_param_specified         */
"switch requires a parameter",		/*696, license_param_req               */
"syntax error in command line",		/*697, license_syntx_error             */
"The certificate was not added.  A duplicate ID exists in the license file.",		/*698, license_dup_id                  */
"The certificate was not added.  Invalid certificate ID / Key combination.",		/*699, license_inv_id_key              */
"The certificate was not removed.  The key does not exist or corresponds to a temporary evaluation license.",		/*700, license_err_remove              */
"An error occurred updating the license file.  Operation cancelled.",		/*701, license_err_update              */
"The certificate could not be validated based on the information given.  Please recheck the ID and key information.",		/*702, license_err_convert             */
"Operation failed.  An unknown error occurred.",		/*703, license_err_unk                 */
"Add license operation failed, KEY: %s ID: %s",		/*704, license_svc_err_add             */
"Remove license operation failed, KEY: %s",		/*705, license_svc_err_remove          */
"The evaluation license has already been used on this server.  You need to purchase a non-evaluation license.",		/*706, license_eval_exists             */
"found unknown switch",		/*707, gstat_unknown_switch            */
"please retry, giving a database name",		/*708, gstat_retry                     */
"Wrong ODS version, expected %d, encountered %d",		/*709, gstat_wrong_ods                 */
"Unexpected end of database file.",		/*710, gstat_unexpected_eof            */
"Can't open database file %s",		/*711, gstat_open_err                  */
"Can't read a database page",		/*712, gstat_read_err                  */
"System memory exhausted",		/*713, gstat_sysmemex                  */
