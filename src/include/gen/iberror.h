...
const SLONG isc_facility	= 20;
const SLONG isc_base = 335544320L;
const SLONG isc_factor = 1;
...
const SLONG isc_arith_except                     = 335544321L;
const SLONG isc_bad_dbkey                        = 335544322L;
const SLONG isc_bad_db_format                    = 335544323L;
const SLONG isc_bad_db_handle                    = 335544324L;
const SLONG isc_bad_dpb_content                  = 335544325L;
const SLONG isc_bad_dpb_form                     = 335544326L;
const SLONG isc_bad_req_handle                   = 335544327L;
const SLONG isc_bad_segstr_handle                = 335544328L;
const SLONG isc_bad_segstr_id                    = 335544329L;
const SLONG isc_bad_tpb_content                  = 335544330L;
const SLONG isc_bad_tpb_form                     = 335544331L;
const SLONG isc_bad_trans_handle                 = 335544332L;
const SLONG isc_bug_check                        = 335544333L;
const SLONG isc_convert_error                    = 335544334L;
const SLONG isc_db_corrupt                       = 335544335L;
const SLONG isc_deadlock                         = 335544336L;
const SLONG isc_excess_trans                     = 335544337L;
const SLONG isc_from_no_match                    = 335544338L;
const SLONG isc_infinap                          = 335544339L;
const SLONG isc_infona                           = 335544340L;
const SLONG isc_infunk                           = 335544341L;
const SLONG isc_integ_fail                       = 335544342L;
const SLONG isc_invalid_blr                      = 335544343L;
const SLONG isc_io_error                         = 335544344L;
const SLONG isc_lock_conflict                    = 335544345L;
const SLONG isc_metadata_corrupt                 = 335544346L;
const SLONG isc_not_valid                        = 335544347L;
const SLONG isc_no_cur_rec                       = 335544348L;
const SLONG isc_no_dup                           = 335544349L;
const SLONG isc_no_finish                        = 335544350L;
const SLONG isc_no_meta_update                   = 335544351L;
const SLONG isc_no_priv                          = 335544352L;
const SLONG isc_no_recon                         = 335544353L;
const SLONG isc_no_record                        = 335544354L;
const SLONG isc_no_segstr_close                  = 335544355L;
const SLONG isc_obsolete_metadata                = 335544356L;
const SLONG isc_open_trans                       = 335544357L;
const SLONG isc_port_len                         = 335544358L;
const SLONG isc_read_only_field                  = 335544359L;
const SLONG isc_read_only_rel                    = 335544360L;
const SLONG isc_read_only_trans                  = 335544361L;
const SLONG isc_read_only_view                   = 335544362L;
const SLONG isc_req_no_trans                     = 335544363L;
const SLONG isc_req_sync                         = 335544364L;
const SLONG isc_req_wrong_db                     = 335544365L;
const SLONG isc_segment                          = 335544366L;
const SLONG isc_segstr_eof                       = 335544367L;
const SLONG isc_segstr_no_op                     = 335544368L;
const SLONG isc_segstr_no_read                   = 335544369L;
const SLONG isc_segstr_no_trans                  = 335544370L;
const SLONG isc_segstr_no_write                  = 335544371L;
const SLONG isc_segstr_wrong_db                  = 335544372L;
const SLONG isc_sys_request                      = 335544373L;
const SLONG isc_stream_eof                       = 335544374L;
const SLONG isc_unavailable                      = 335544375L;
const SLONG isc_unres_rel                        = 335544376L;
const SLONG isc_uns_ext                          = 335544377L;
const SLONG isc_wish_list                        = 335544378L;
const SLONG isc_wrong_ods                        = 335544379L;
const SLONG isc_wronumarg                        = 335544380L;
const SLONG isc_imp_exc                          = 335544381L;
const SLONG isc_random                           = 335544382L;
const SLONG isc_fatal_conflict                   = 335544383L;
const SLONG isc_badblk                           = 335544384L;
const SLONG isc_invpoolcl                        = 335544385L;
const SLONG isc_nopoolids                        = 335544386L;
const SLONG isc_relbadblk                        = 335544387L;
const SLONG isc_blktoobig                        = 335544388L;
const SLONG isc_bufexh                           = 335544389L;
const SLONG isc_syntaxerr                        = 335544390L;
const SLONG isc_bufinuse                         = 335544391L;
const SLONG isc_bdbincon                         = 335544392L;
const SLONG isc_reqinuse                         = 335544393L;
const SLONG isc_badodsver                        = 335544394L;
const SLONG isc_relnotdef                        = 335544395L;
const SLONG isc_fldnotdef                        = 335544396L;
const SLONG isc_dirtypage                        = 335544397L;
const SLONG isc_waifortra                        = 335544398L;
const SLONG isc_doubleloc                        = 335544399L;
const SLONG isc_nodnotfnd                        = 335544400L;
const SLONG isc_dupnodfnd                        = 335544401L;
const SLONG isc_locnotmar                        = 335544402L;
const SLONG isc_badpagtyp                        = 335544403L;
const SLONG isc_corrupt                          = 335544404L;
const SLONG isc_badpage                          = 335544405L;
const SLONG isc_badindex                         = 335544406L;
const SLONG isc_dbbnotzer                        = 335544407L;
const SLONG isc_tranotzer                        = 335544408L;
const SLONG isc_trareqmis                        = 335544409L;
const SLONG isc_badhndcnt                        = 335544410L;
const SLONG isc_wrotpbver                        = 335544411L;
const SLONG isc_wroblrver                        = 335544412L;
const SLONG isc_wrodpbver                        = 335544413L;
const SLONG isc_blobnotsup                       = 335544414L;
const SLONG isc_badrelation                      = 335544415L;
const SLONG isc_nodetach                         = 335544416L;
const SLONG isc_notremote                        = 335544417L;
const SLONG isc_trainlim                         = 335544418L;
const SLONG isc_notinlim                         = 335544419L;
const SLONG isc_traoutsta                        = 335544420L;
const SLONG isc_connect_reject                   = 335544421L;
const SLONG isc_dbfile                           = 335544422L;
const SLONG isc_orphan                           = 335544423L;
const SLONG isc_no_lock_mgr                      = 335544424L;
const SLONG isc_ctxinuse                         = 335544425L;
const SLONG isc_ctxnotdef                        = 335544426L;
const SLONG isc_datnotsup                        = 335544427L;
const SLONG isc_badmsgnum                        = 335544428L;
const SLONG isc_badparnum                        = 335544429L;
const SLONG isc_virmemexh                        = 335544430L;
const SLONG isc_blocking_signal                  = 335544431L;
const SLONG isc_lockmanerr                       = 335544432L;
const SLONG isc_journerr                         = 335544433L;
const SLONG isc_keytoobig                        = 335544434L;
const SLONG isc_nullsegkey                       = 335544435L;
const SLONG isc_sqlerr                           = 335544436L;
const SLONG isc_wrodynver                        = 335544437L;
const SLONG isc_funnotdef                        = 335544438L;
const SLONG isc_funmismat                        = 335544439L;
const SLONG isc_bad_msg_vec                      = 335544440L;
const SLONG isc_bad_detach                       = 335544441L;
const SLONG isc_noargacc_read                    = 335544442L;
const SLONG isc_noargacc_write                   = 335544443L;
const SLONG isc_read_only                        = 335544444L;
const SLONG isc_ext_err                          = 335544445L;
const SLONG isc_non_updatable                    = 335544446L;
const SLONG isc_no_rollback                      = 335544447L;
const SLONG isc_bad_sec_info                     = 335544448L;
const SLONG isc_invalid_sec_info                 = 335544449L;
const SLONG isc_misc_interpreted                 = 335544450L;
const SLONG isc_update_conflict                  = 335544451L;
const SLONG isc_unlicensed                       = 335544452L;
const SLONG isc_obj_in_use                       = 335544453L;
const SLONG isc_nofilter                         = 335544454L;
const SLONG isc_shadow_accessed                  = 335544455L;
const SLONG isc_invalid_sdl                      = 335544456L;
const SLONG isc_out_of_bounds                    = 335544457L;
const SLONG isc_invalid_dimension                = 335544458L;
const SLONG isc_rec_in_limbo                     = 335544459L;
const SLONG isc_shadow_missing                   = 335544460L;
const SLONG isc_cant_validate                    = 335544461L;
const SLONG isc_cant_start_journal               = 335544462L;
const SLONG isc_gennotdef                        = 335544463L;
const SLONG isc_cant_start_logging               = 335544464L;
const SLONG isc_bad_segstr_type                  = 335544465L;
const SLONG isc_foreign_key                      = 335544466L;
const SLONG isc_high_minor                       = 335544467L;
const SLONG isc_tra_state                        = 335544468L;
const SLONG isc_trans_invalid                    = 335544469L;
const SLONG isc_buf_invalid                      = 335544470L;
const SLONG isc_indexnotdefined                  = 335544471L;
const SLONG isc_login                            = 335544472L;
const SLONG isc_invalid_bookmark                 = 335544473L;
const SLONG isc_bad_lock_level                   = 335544474L;
const SLONG isc_relation_lock                    = 335544475L;
const SLONG isc_record_lock                      = 335544476L;
const SLONG isc_max_idx                          = 335544477L;
const SLONG isc_jrn_enable                       = 335544478L;
const SLONG isc_old_failure                      = 335544479L;
const SLONG isc_old_in_progress                  = 335544480L;
const SLONG isc_old_no_space                     = 335544481L;
const SLONG isc_no_wal_no_jrn                    = 335544482L;
const SLONG isc_num_old_files                    = 335544483L;
const SLONG isc_wal_file_open                    = 335544484L;
const SLONG isc_bad_stmt_handle                  = 335544485L;
const SLONG isc_wal_failure                      = 335544486L;
const SLONG isc_walw_err                         = 335544487L;
const SLONG isc_logh_small                       = 335544488L;
const SLONG isc_logh_inv_version                 = 335544489L;
const SLONG isc_logh_open_flag                   = 335544490L;
const SLONG isc_logh_open_flag2                  = 335544491L;
const SLONG isc_logh_diff_dbname                 = 335544492L;
const SLONG isc_logf_unexpected_eof              = 335544493L;
const SLONG isc_logr_incomplete                  = 335544494L;
const SLONG isc_logr_header_small                = 335544495L;
const SLONG isc_logb_small                       = 335544496L;
const SLONG isc_wal_illegal_attach               = 335544497L;
const SLONG isc_wal_invalid_wpb                  = 335544498L;
const SLONG isc_wal_err_rollover                 = 335544499L;
const SLONG isc_no_wal                           = 335544500L;
const SLONG isc_drop_wal                         = 335544501L;
const SLONG isc_stream_not_defined               = 335544502L;
const SLONG isc_wal_subsys_error                 = 335544503L;
const SLONG isc_wal_subsys_corrupt               = 335544504L;
const SLONG isc_no_archive                       = 335544505L;
const SLONG isc_shutinprog                       = 335544506L;
const SLONG isc_range_in_use                     = 335544507L;
const SLONG isc_range_not_found                  = 335544508L;
const SLONG isc_charset_not_found                = 335544509L;
const SLONG isc_lock_timeout                     = 335544510L;
const SLONG isc_prcnotdef                        = 335544511L;
const SLONG isc_prcmismat                        = 335544512L;
const SLONG isc_wal_bugcheck                     = 335544513L;
const SLONG isc_wal_cant_expand                  = 335544514L;
const SLONG isc_codnotdef                        = 335544515L;
const SLONG isc_xcpnotdef                        = 335544516L;
const SLONG isc_except                           = 335544517L;
const SLONG isc_cache_restart                    = 335544518L;
const SLONG isc_bad_lock_handle                  = 335544519L;
const SLONG isc_jrn_present                      = 335544520L;
const SLONG isc_wal_err_rollover2                = 335544521L;
const SLONG isc_wal_err_logwrite                 = 335544522L;
...
const SLONG isc_primary_key_ref                  = 335544530L;
const SLONG isc_primary_key_notnull              = 335544531L;
const SLONG isc_ref_cnstrnt_notfound             = 335544532L;
const SLONG isc_foreign_key_notfound             = 335544533L;
const SLONG isc_ref_cnstrnt_update               = 335544534L;
const SLONG isc_check_cnstrnt_update             = 335544535L;
const SLONG isc_check_cnstrnt_del                = 335544536L;
const SLONG isc_integ_index_seg_del              = 335544537L;
const SLONG isc_integ_index_seg_mod              = 335544538L;
const SLONG isc_integ_index_del                  = 335544539L;
const SLONG isc_integ_index_mod                  = 335544540L;
const SLONG isc_check_trig_del                   = 335544541L;
const SLONG isc_check_trig_update                = 335544542L;
const SLONG isc_cnstrnt_fld_del                  = 335544543L;
const SLONG isc_cnstrnt_fld_rename               = 335544544L;
const SLONG isc_rel_cnstrnt_update               = 335544545L;
const SLONG isc_constaint_on_view                = 335544546L;
const SLONG isc_invld_cnstrnt_type               = 335544547L;
const SLONG isc_primary_key_exists               = 335544548L;
const SLONG isc_systrig_update                   = 335544549L;
const SLONG isc_not_rel_owner                    = 335544550L;
const SLONG isc_grant_obj_notfound               = 335544551L;
const SLONG isc_grant_fld_notfound               = 335544552L;
const SLONG isc_grant_nopriv                     = 335544553L;
const SLONG isc_nonsql_security_rel              = 335544554L;
const SLONG isc_nonsql_security_fld              = 335544555L;
const SLONG isc_wal_cache_err                    = 335544556L;
const SLONG isc_shutfail                         = 335544557L;
const SLONG isc_check_constraint                 = 335544558L;
const SLONG isc_bad_svc_handle                   = 335544559L;
const SLONG isc_shutwarn                         = 335544560L;
const SLONG isc_wrospbver                        = 335544561L;
const SLONG isc_bad_spb_form                     = 335544562L;
const SLONG isc_svcnotdef                        = 335544563L;
const SLONG isc_no_jrn                           = 335544564L;
const SLONG isc_transliteration_failed           = 335544565L;
const SLONG isc_start_cm_for_wal                 = 335544566L;
const SLONG isc_wal_ovflow_log_required          = 335544567L;
const SLONG isc_text_subtype                     = 335544568L;
const SLONG isc_dsql_error                       = 335544569L;
const SLONG isc_dsql_command_err                 = 335544570L;
const SLONG isc_dsql_constant_err                = 335544571L;
const SLONG isc_dsql_cursor_err                  = 335544572L;
const SLONG isc_dsql_datatype_err                = 335544573L;
const SLONG isc_dsql_decl_err                    = 335544574L;
const SLONG isc_dsql_cursor_update_err           = 335544575L;
const SLONG isc_dsql_cursor_open_err             = 335544576L;
const SLONG isc_dsql_cursor_close_err            = 335544577L;
const SLONG isc_dsql_field_err                   = 335544578L;
const SLONG isc_dsql_internal_err                = 335544579L;
const SLONG isc_dsql_relation_err                = 335544580L;
const SLONG isc_dsql_procedure_err               = 335544581L;
const SLONG isc_dsql_request_err                 = 335544582L;
const SLONG isc_dsql_sqlda_err                   = 335544583L;
const SLONG isc_dsql_var_count_err               = 335544584L;
const SLONG isc_dsql_stmt_handle                 = 335544585L;
const SLONG isc_dsql_function_err                = 335544586L;
const SLONG isc_dsql_blob_err                    = 335544587L;
const SLONG isc_collation_not_found              = 335544588L;
const SLONG isc_collation_not_for_charset        = 335544589L;
const SLONG isc_dsql_dup_option                  = 335544590L;
const SLONG isc_dsql_tran_err                    = 335544591L;
const SLONG isc_dsql_invalid_array               = 335544592L;
const SLONG isc_dsql_max_arr_dim_exceeded        = 335544593L;
const SLONG isc_dsql_arr_range_error             = 335544594L;
const SLONG isc_dsql_trigger_err                 = 335544595L;
const SLONG isc_dsql_subselect_err               = 335544596L;
const SLONG isc_dsql_crdb_prepare_err            = 335544597L;
const SLONG isc_specify_field_err                = 335544598L;
const SLONG isc_num_field_err                    = 335544599L;
const SLONG isc_col_name_err                     = 335544600L;
const SLONG isc_where_err                        = 335544601L;
const SLONG isc_table_view_err                   = 335544602L;
const SLONG isc_distinct_err                     = 335544603L;
const SLONG isc_key_field_count_err              = 335544604L;
const SLONG isc_subquery_err                     = 335544605L;
const SLONG isc_expression_eval_err              = 335544606L;
const SLONG isc_node_err                         = 335544607L;
const SLONG isc_command_end_err                  = 335544608L;
const SLONG isc_index_name                       = 335544609L;
const SLONG isc_exception_name                   = 335544610L;
const SLONG isc_field_name                       = 335544611L;
const SLONG isc_token_err                        = 335544612L;
const SLONG isc_union_err                        = 335544613L;
const SLONG isc_dsql_construct_err               = 335544614L;
const SLONG isc_field_aggregate_err              = 335544615L;
const SLONG isc_field_ref_err                    = 335544616L;
const SLONG isc_order_by_err                     = 335544617L;
const SLONG isc_return_mode_err                  = 335544618L;
const SLONG isc_extern_func_err                  = 335544619L;
const SLONG isc_alias_conflict_err               = 335544620L;
const SLONG isc_procedure_conflict_error         = 335544621L;
const SLONG isc_relation_conflict_err            = 335544622L;
const SLONG isc_dsql_domain_err                  = 335544623L;
const SLONG isc_idx_seg_err                      = 335544624L;
const SLONG isc_node_name_err                    = 335544625L;
const SLONG isc_table_name                       = 335544626L;
const SLONG isc_proc_name                        = 335544627L;
const SLONG isc_idx_create_err                   = 335544628L;
const SLONG isc_wal_shadow_err                   = 335544629L;
const SLONG isc_dependency                       = 335544630L;
const SLONG isc_idx_key_err                      = 335544631L;
const SLONG isc_dsql_file_length_err             = 335544632L;
const SLONG isc_dsql_shadow_number_err           = 335544633L;
const SLONG isc_dsql_token_unk_err               = 335544634L;
const SLONG isc_dsql_no_relation_alias           = 335544635L;
const SLONG isc_indexname                        = 335544636L;
const SLONG isc_no_stream_plan                   = 335544637L;
const SLONG isc_stream_twice                     = 335544638L;
const SLONG isc_stream_not_found                 = 335544639L;
const SLONG isc_collation_requires_text          = 335544640L;
const SLONG isc_dsql_domain_not_found            = 335544641L;
const SLONG isc_index_unused                     = 335544642L;
const SLONG isc_dsql_self_join                   = 335544643L;
const SLONG isc_stream_bof                       = 335544644L;
const SLONG isc_stream_crack                     = 335544645L;
const SLONG isc_db_or_file_exists                = 335544646L;
const SLONG isc_invalid_operator                 = 335544647L;
const SLONG isc_conn_lost                        = 335544648L;
const SLONG isc_bad_checksum                     = 335544649L;
const SLONG isc_page_type_err                    = 335544650L;
const SLONG isc_ext_readonly_err                 = 335544651L;
const SLONG isc_sing_select_err                  = 335544652L;
const SLONG isc_psw_attach                       = 335544653L;
const SLONG isc_psw_start_trans                  = 335544654L;
const SLONG isc_invalid_direction                = 335544655L;
const SLONG isc_dsql_var_conflict                = 335544656L;
const SLONG isc_dsql_no_blob_array               = 335544657L;
const SLONG isc_dsql_base_table                  = 335544658L;
const SLONG isc_duplicate_base_table             = 335544659L;
const SLONG isc_view_alias                       = 335544660L;
const SLONG isc_index_root_page_full             = 335544661L;
const SLONG isc_dsql_blob_type_unknown           = 335544662L;
const SLONG isc_req_max_clones_exceeded          = 335544663L;
const SLONG isc_dsql_duplicate_spec              = 335544664L;
const SLONG isc_unique_key_violation             = 335544665L;
const SLONG isc_srvr_version_too_old             = 335544666L;
const SLONG isc_drdb_completed_with_errs         = 335544667L;
const SLONG isc_dsql_procedure_use_err           = 335544668L;
const SLONG isc_dsql_count_mismatch              = 335544669L;
const SLONG isc_blob_idx_err                     = 335544670L;
const SLONG isc_array_idx_err                    = 335544671L;
const SLONG isc_key_field_err                    = 335544672L;
const SLONG isc_no_delete                        = 335544673L;
const SLONG isc_del_last_field                   = 335544674L;
const SLONG isc_sort_err                         = 335544675L;
const SLONG isc_sort_mem_err                     = 335544676L;
const SLONG isc_version_err                      = 335544677L;
const SLONG isc_inval_key_posn                   = 335544678L;
const SLONG isc_no_segments_err                  = 335544679L;
const SLONG isc_crrp_data_err                    = 335544680L;
const SLONG isc_rec_size_err                     = 335544681L;
const SLONG isc_dsql_field_ref                   = 335544682L;
const SLONG isc_req_depth_exceeded               = 335544683L;
const SLONG isc_no_field_access                  = 335544684L;
const SLONG isc_no_dbkey                         = 335544685L;
const SLONG isc_jrn_format_err                   = 335544686L;
const SLONG isc_jrn_file_full                    = 335544687L;
const SLONG isc_dsql_open_cursor_request         = 335544688L;
const SLONG isc_ib_error                         = 335544689L;
const SLONG isc_cache_redef                      = 335544690L;
const SLONG isc_cache_too_small                  = 335544691L;
const SLONG isc_log_redef                        = 335544692L;
const SLONG isc_log_too_small                    = 335544693L;
const SLONG isc_partition_too_small              = 335544694L;
const SLONG isc_partition_not_supp               = 335544695L;
const SLONG isc_log_length_spec                  = 335544696L;
const SLONG isc_precision_err                    = 335544697L;
const SLONG isc_scale_nogt                       = 335544698L;
const SLONG isc_expec_short                      = 335544699L;
const SLONG isc_expec_long                       = 335544700L;
const SLONG isc_expec_ushort                     = 335544701L;
const SLONG isc_like_escape_invalid              = 335544702L;
const SLONG isc_svcnoexe                         = 335544703L;
const SLONG isc_net_lookup_err                   = 335544704L;
const SLONG isc_service_unknown                  = 335544705L;
const SLONG isc_host_unknown                     = 335544706L;
const SLONG isc_grant_nopriv_on_base             = 335544707L;
const SLONG isc_dyn_fld_ambiguous                = 335544708L;
const SLONG isc_dsql_agg_ref_err                 = 335544709L;
const SLONG isc_complex_view                     = 335544710L;
const SLONG isc_unprepared_stmt                  = 335544711L;
const SLONG isc_expec_positive                   = 335544712L;
const SLONG isc_dsql_sqlda_value_err             = 335544713L;
const SLONG isc_invalid_array_id                 = 335544714L;
const SLONG isc_extfile_uns_op                   = 335544715L;
const SLONG isc_svc_in_use                       = 335544716L;
const SLONG isc_err_stack_limit                  = 335544717L;
const SLONG isc_invalid_key                      = 335544718L;
const SLONG isc_net_init_error                   = 335544719L;
const SLONG isc_loadlib_failure                  = 335544720L;
const SLONG isc_network_error                    = 335544721L;
const SLONG isc_net_connect_err                  = 335544722L;
const SLONG isc_net_connect_listen_err           = 335544723L;
const SLONG isc_net_event_connect_err            = 335544724L;
const SLONG isc_net_event_listen_err             = 335544725L;
const SLONG isc_net_read_err                     = 335544726L;
const SLONG isc_net_write_err                    = 335544727L;
const SLONG isc_integ_index_deactivate           = 335544728L;
const SLONG isc_integ_deactivate_primary         = 335544729L;
const SLONG isc_cse_not_supported                = 335544730L;
const SLONG isc_tra_must_sweep                   = 335544731L;
const SLONG isc_unsupported_network_drive        = 335544732L;
const SLONG isc_io_create_err                    = 335544733L;
const SLONG isc_io_open_err                      = 335544734L;
const SLONG isc_io_close_err                     = 335544735L;
const SLONG isc_io_read_err                      = 335544736L;
const SLONG isc_io_write_err                     = 335544737L;
const SLONG isc_io_delete_err                    = 335544738L;
const SLONG isc_io_access_err                    = 335544739L;
const SLONG isc_udf_exception                    = 335544740L;
const SLONG isc_lost_db_connection               = 335544741L;
const SLONG isc_no_write_user_priv               = 335544742L;
const SLONG isc_token_too_long                   = 335544743L;
const SLONG isc_max_att_exceeded                 = 335544744L;
const SLONG isc_login_same_as_role_name          = 335544745L;
const SLONG isc_reftable_requires_pk             = 335544746L;
const SLONG isc_usrname_too_long                 = 335544747L;
const SLONG isc_password_too_long                = 335544748L;
const SLONG isc_usrname_required                 = 335544749L;
const SLONG isc_password_required                = 335544750L;
const SLONG isc_bad_protocol                     = 335544751L;
const SLONG isc_dup_usrname_found                = 335544752L;
const SLONG isc_usrname_not_found                = 335544753L;
const SLONG isc_error_adding_sec_record          = 335544754L;
const SLONG isc_error_modifying_sec_record       = 335544755L;
const SLONG isc_error_deleting_sec_record        = 335544756L;
const SLONG isc_error_updating_sec_db            = 335544757L;
const SLONG isc_sort_rec_size_err                = 335544758L;
const SLONG isc_bad_default_value                = 335544759L;
const SLONG isc_invalid_clause                   = 335544760L;
const SLONG isc_too_many_handles                 = 335544761L;
const SLONG isc_optimizer_blk_exc                = 335544762L;
const SLONG isc_invalid_string_constant          = 335544763L;
const SLONG isc_transitional_date                = 335544764L;
const SLONG isc_read_only_database               = 335544765L;
const SLONG isc_must_be_dialect_2_and_up         = 335544766L;
const SLONG isc_blob_filter_exception            = 335544767L;
const SLONG isc_exception_access_violation       = 335544768L;
const SLONG isc_exception_datatype_missalignment = 335544769L;
const SLONG isc_exception_array_bounds_exceeded  = 335544770L;
const SLONG isc_exception_float_denormal_operand = 335544771L;
const SLONG isc_exception_float_divide_by_zero   = 335544772L;
const SLONG isc_exception_float_inexact_result   = 335544773L;
const SLONG isc_exception_float_invalid_operand  = 335544774L;
const SLONG isc_exception_float_overflow         = 335544775L;
const SLONG isc_exception_float_stack_check      = 335544776L;
const SLONG isc_exception_float_underflow        = 335544777L;
const SLONG isc_exception_integer_divide_by_zero = 335544778L;
const SLONG isc_exception_integer_overflow       = 335544779L;
const SLONG isc_exception_unknown                = 335544780L;
const SLONG isc_exception_stack_overflow         = 335544781L;
const SLONG isc_exception_sigsegv                = 335544782L;
const SLONG isc_exception_sigill                 = 335544783L;
const SLONG isc_exception_sigbus                 = 335544784L;
const SLONG isc_exception_sigfpe                 = 335544785L;
const SLONG isc_ext_file_delete                  = 335544786L;
const SLONG isc_ext_file_modify                  = 335544787L;
const SLONG isc_adm_task_denied                  = 335544788L;
const SLONG isc_extract_input_mismatch           = 335544789L;
const SLONG isc_insufficient_svc_privileges      = 335544790L;
const SLONG isc_file_in_use                      = 335544791L;
const SLONG isc_service_att_err                  = 335544792L;
const SLONG isc_ddl_not_allowed_by_db_sql_dial   = 335544793L;
const SLONG isc_cancelled                        = 335544794L;
const SLONG isc_unexp_spb_form                   = 335544795L;
const SLONG isc_sql_dialect_datatype_unsupport   = 335544796L;
const SLONG isc_svcnouser                        = 335544797L;
const SLONG isc_depend_on_uncommitted_rel        = 335544798L;
const SLONG isc_svc_name_missing                 = 335544799L;
const SLONG isc_too_many_contexts                = 335544800L;
const SLONG isc_datype_notsup                    = 335544801L;
const SLONG isc_dialect_reset_warning            = 335544802L;
const SLONG isc_dialect_not_changed              = 335544803L;
const SLONG isc_database_create_failed           = 335544804L;
const SLONG isc_inv_dialect_specified            = 335544805L;
const SLONG isc_valid_db_dialects                = 335544806L;
const SLONG isc_sqlwarn                          = 335544807L;
const SLONG isc_dtype_renamed                    = 335544808L;
const SLONG isc_extern_func_dir_error            = 335544809L;
const SLONG isc_date_range_exceeded              = 335544810L;
const SLONG isc_inv_client_dialect_specified     = 335544811L;
const SLONG isc_valid_client_dialects            = 335544812L;
const SLONG isc_optimizer_between_err            = 335544813L;
const SLONG isc_service_not_supported            = 335544814L;
const SLONG isc_generator_name                   = 335544815L;
const SLONG isc_udf_name                         = 335544816L;
const SLONG isc_bad_limit_param                  = 335544817L;
const SLONG isc_bad_skip_param                   = 335544818L;
const SLONG isc_io_32bit_exceeded_err            = 335544819L;
const SLONG isc_invalid_savepoint                = 335544820L;
const SLONG isc_dsql_column_pos_err              = 335544821L;
const SLONG isc_dsql_agg_where_err               = 335544822L;
const SLONG isc_dsql_agg_group_err               = 335544823L;
const SLONG isc_dsql_agg_column_err              = 335544824L;
const SLONG isc_dsql_agg_having_err              = 335544825L;
const SLONG isc_dsql_agg_nested_err              = 335544826L;
const SLONG isc_exec_sql_invalid_arg             = 335544827L;
const SLONG isc_exec_sql_invalid_req             = 335544828L;
const SLONG isc_exec_sql_invalid_var             = 335544829L;
const SLONG isc_exec_sql_max_call_exceeded       = 335544830L;
...
const SLONG isc_cursor_not_open                  = 335544834L;
const SLONG isc_bad_shutdown_mode                = 335544835L;
const SLONG isc_concat_overflow                  = 335544836L;
const SLONG isc_bad_substring_offset             = 335544837L;
...
const SLONG isc_blob_convert_error               = 335544860L;
const SLONG isc_array_convert_error              = 335544861L;
const SLONG isc_record_lock_not_supp             = 335544862L;
const SLONG isc_partner_idx_not_found            = 335544863L;
...
const SLONG isc_gfix_replay_req                  = 335740933L;
const SLONG isc_gfix_pgbuf_req                   = 335740934L;
const SLONG isc_gfix_val_req                     = 335740935L;
const SLONG isc_gfix_pval_req                    = 335740936L;
const SLONG isc_gfix_trn_req                     = 335740937L;
const SLONG isc_gfix_full_req                    = 335740940L;
const SLONG isc_gfix_usrname_req                 = 335740941L;
const SLONG isc_gfix_pass_req                    = 335740942L;
const SLONG isc_gfix_subs_name                   = 335740943L;
const SLONG isc_gfix_wal_req                     = 335740944L;
const SLONG isc_gfix_sec_req                     = 335740945L;
const SLONG isc_gfix_nval_req                    = 335740946L;
const SLONG isc_gfix_type_shut                   = 335740947L;
const SLONG isc_gfix_retry                       = 335740948L;
const SLONG isc_gfix_retry_db                    = 335740951L;
const SLONG isc_gfix_exceed_max                  = 335740991L;
const SLONG isc_gfix_corrupt_pool                = 335740992L;
const SLONG isc_gfix_mem_exhausted               = 335740993L;
const SLONG isc_gfix_bad_pool                    = 335740994L;
const SLONG isc_gfix_trn_not_valid               = 335740995L;
const SLONG isc_gfix_unexp_eoi                   = 335741012L;
const SLONG isc_gfix_recon_fail                  = 335741018L;
...
const SLONG isc_sql_db_dialect_dtype_unsupport   = 336003077L;
const SLONG isc_isc_sql_dialect_conflict_num     = 336003079L;
const SLONG isc_dsql_warning_number_ambiguous    = 336003080L;
const SLONG isc_dsql_warning_number_ambiguous1   = 336003081L;
const SLONG isc_dsql_warn_precision_ambiguous    = 336003082L;
const SLONG isc_dsql_warn_precision_ambiguous1   = 336003083L;
const SLONG isc_dsql_warn_precision_ambiguous2   = 336003084L;
const SLONG isc_dsql_ambiguous_field_name        = 336003085L;
...
const SLONG isc_dyn_delete_role_failed           = 336068799L;
const SLONG isc_dyn_grant_role_to_user           = 336068800L;
const SLONG isc_dyn_inv_sql_role_name            = 336068801L;
const SLONG isc_dyn_dup_sql_role                 = 336068802L;
const SLONG isc_dyn_kywd_spec_for_role           = 336068803L;
const SLONG isc_dyn_roles_not_supported          = 336068804L;
const SLONG isc_dyn_domain_name_exists           = 336068812L;
const SLONG isc_dyn_field_name_exists            = 336068813L;
const SLONG isc_dyn_dependency_exists            = 336068814L;
const SLONG isc_dyn_dtype_invalid                = 336068815L;
const SLONG isc_dyn_char_fld_too_small           = 336068816L;
const SLONG isc_dyn_invalid_dtype_conversion     = 336068817L;
const SLONG isc_dyn_dtype_conv_invalid           = 336068818L;
const SLONG isc_dyn_zero_len_id                  = 336068820L;
const SLONG isc_gbak_unknown_switch              = 336330753L;
const SLONG isc_gbak_page_size_missing           = 336330754L;
const SLONG isc_gbak_page_size_toobig            = 336330755L;
const SLONG isc_gbak_redir_ouput_missing         = 336330756L;
const SLONG isc_gbak_switches_conflict           = 336330757L;
const SLONG isc_gbak_unknown_device              = 336330758L;
const SLONG isc_gbak_no_protection               = 336330759L;
const SLONG isc_gbak_page_size_not_allowed       = 336330760L;
const SLONG isc_gbak_multi_source_dest           = 336330761L;
const SLONG isc_gbak_filename_missing            = 336330762L;
const SLONG isc_gbak_dup_inout_names             = 336330763L;
const SLONG isc_gbak_inv_page_size               = 336330764L;
const SLONG isc_gbak_db_specified                = 336330765L;
const SLONG isc_gbak_db_exists                   = 336330766L;
const SLONG isc_gbak_unk_device                  = 336330767L;
const SLONG isc_gbak_blob_info_failed            = 336330772L;
const SLONG isc_gbak_unk_blob_item               = 336330773L;
const SLONG isc_gbak_get_seg_failed              = 336330774L;
const SLONG isc_gbak_close_blob_failed           = 336330775L;
const SLONG isc_gbak_open_blob_failed            = 336330776L;
const SLONG isc_gbak_put_blr_gen_id_failed       = 336330777L;
const SLONG isc_gbak_unk_type                    = 336330778L;
const SLONG isc_gbak_comp_req_failed             = 336330779L;
const SLONG isc_gbak_start_req_failed            = 336330780L;
const SLONG isc_gbak_rec_failed                  = 336330781L;
const SLONG isc_gbak_rel_req_failed              = 336330782L;
const SLONG isc_gbak_db_info_failed              = 336330783L;
const SLONG isc_gbak_no_db_desc                  = 336330784L;
const SLONG isc_gbak_db_create_failed            = 336330785L;
const SLONG isc_gbak_decomp_len_error            = 336330786L;
const SLONG isc_gbak_tbl_missing                 = 336330787L;
const SLONG isc_gbak_blob_col_missing            = 336330788L;
const SLONG isc_gbak_create_blob_failed          = 336330789L;
const SLONG isc_gbak_put_seg_failed              = 336330790L;
const SLONG isc_gbak_rec_len_exp                 = 336330791L;
const SLONG isc_gbak_inv_rec_len                 = 336330792L;
const SLONG isc_gbak_exp_data_type               = 336330793L;
const SLONG isc_gbak_gen_id_failed               = 336330794L;
const SLONG isc_gbak_unk_rec_type                = 336330795L;
const SLONG isc_gbak_inv_bkup_ver                = 336330796L;
const SLONG isc_gbak_missing_bkup_desc           = 336330797L;
const SLONG isc_gbak_string_trunc                = 336330798L;
const SLONG isc_gbak_cant_rest_record            = 336330799L;
const SLONG isc_gbak_send_failed                 = 336330800L;
const SLONG isc_gbak_no_tbl_name                 = 336330801L;
const SLONG isc_gbak_unexp_eof                   = 336330802L;
const SLONG isc_gbak_db_format_too_old           = 336330803L;
const SLONG isc_gbak_inv_array_dim               = 336330804L;
const SLONG isc_gbak_xdr_len_expected            = 336330807L;
const SLONG isc_gbak_open_bkup_error             = 336330817L;
const SLONG isc_gbak_open_error                  = 336330818L;
const SLONG isc_gbak_missing_block_fac           = 336330934L;
const SLONG isc_gbak_inv_block_fac               = 336330935L;
const SLONG isc_gbak_block_fac_specified         = 336330936L;
const SLONG isc_gbak_missing_username            = 336330940L;
const SLONG isc_gbak_missing_password            = 336330941L;
const SLONG isc_gbak_missing_skipped_bytes       = 336330952L;
const SLONG isc_gbak_inv_skipped_bytes           = 336330953L;
const SLONG isc_gbak_err_restore_charset         = 336330965L;
const SLONG isc_gbak_err_restore_collation       = 336330967L;
const SLONG isc_gbak_read_error                  = 336330972L;
const SLONG isc_gbak_write_error                 = 336330973L;
const SLONG isc_gbak_db_in_use                   = 336330985L;
const SLONG isc_gbak_sysmemex                    = 336330990L;
const SLONG isc_gbak_restore_role_failed         = 336331002L;
const SLONG isc_gbak_role_op_missing             = 336331005L;
const SLONG isc_gbak_page_buffers_missing        = 336331010L;
const SLONG isc_gbak_page_buffers_wrong_param    = 336331011L;
const SLONG isc_gbak_page_buffers_restore        = 336331012L;
const SLONG isc_gbak_inv_size                    = 336331014L;
const SLONG isc_gbak_file_outof_sequence         = 336331015L;
const SLONG isc_gbak_join_file_missing           = 336331016L;
const SLONG isc_gbak_stdin_not_supptd            = 336331017L;
const SLONG isc_gbak_stdout_not_supptd           = 336331018L;
const SLONG isc_gbak_bkup_corrupt                = 336331019L;
const SLONG isc_gbak_unk_db_file_spec            = 336331020L;
const SLONG isc_gbak_hdr_write_failed            = 336331021L;
const SLONG isc_gbak_disk_space_ex               = 336331022L;
const SLONG isc_gbak_size_lt_min                 = 336331023L;
const SLONG isc_gbak_svc_name_missing            = 336331025L;
const SLONG isc_gbak_not_ownr                    = 336331026L;
...
const SLONG isc_gsec_no_usr_name                 = 336723986L;
const SLONG isc_gsec_err_add                     = 336723987L;
const SLONG isc_gsec_err_modify                  = 336723988L;
const SLONG isc_gsec_err_find_mod                = 336723989L;
const SLONG isc_gsec_err_rec_not_found           = 336723990L;
const SLONG isc_gsec_err_delete                  = 336723991L;
const SLONG isc_gsec_err_find_del                = 336723992L;
const SLONG isc_gsec_err_find_disp               = 336723996L;
const SLONG isc_gsec_inv_param                   = 336723997L;
const SLONG isc_gsec_op_specified                = 336723998L;
const SLONG isc_gsec_pw_specified                = 336723999L;
const SLONG isc_gsec_uid_specified               = 336724000L;
const SLONG isc_gsec_gid_specified               = 336724001L;
const SLONG isc_gsec_proj_specified              = 336724002L;
const SLONG isc_gsec_org_specified               = 336724003L;
const SLONG isc_gsec_fname_specified             = 336724004L;
const SLONG isc_gsec_mname_specified             = 336724005L;
const SLONG isc_gsec_lname_specified             = 336724006L;
const SLONG isc_gsec_inv_switch                  = 336724008L;
const SLONG isc_gsec_amb_switch                  = 336724009L;
const SLONG isc_gsec_no_op_specified             = 336724010L;
const SLONG isc_gsec_params_not_allowed          = 336724011L;
const SLONG isc_gsec_incompat_switch             = 336724012L;
const SLONG isc_gsec_inv_username                = 336724044L;
const SLONG isc_gsec_inv_pw_length               = 336724045L;
const SLONG isc_gsec_db_specified                = 336724046L;
const SLONG isc_gsec_db_admin_specified          = 336724047L;
const SLONG isc_gsec_db_admin_pw_specified       = 336724048L;
const SLONG isc_gsec_sql_role_specified          = 336724049L;
const SLONG isc_license_no_file                  = 336789504L;
const SLONG isc_license_op_specified             = 336789523L;
const SLONG isc_license_op_missing               = 336789524L;
const SLONG isc_license_inv_switch               = 336789525L;
const SLONG isc_license_inv_switch_combo         = 336789526L;
const SLONG isc_license_inv_op_combo             = 336789527L;
const SLONG isc_license_amb_switch               = 336789528L;
const SLONG isc_license_inv_parameter            = 336789529L;
const SLONG isc_license_param_specified          = 336789530L;
const SLONG isc_license_param_req                = 336789531L;
const SLONG isc_license_syntx_error              = 336789532L;
const SLONG isc_license_dup_id                   = 336789534L;
const SLONG isc_license_inv_id_key               = 336789535L;
const SLONG isc_license_err_remove               = 336789536L;
const SLONG isc_license_err_update               = 336789537L;
const SLONG isc_license_err_convert              = 336789538L;
const SLONG isc_license_err_unk                  = 336789539L;
const SLONG isc_license_svc_err_add              = 336789540L;
const SLONG isc_license_svc_err_remove           = 336789541L;
const SLONG isc_license_eval_exists              = 336789563L;
const SLONG isc_gstat_unknown_switch             = 336920577L;
const SLONG isc_gstat_retry                      = 336920578L;
const SLONG isc_gstat_wrong_ods                  = 336920579L;
const SLONG isc_gstat_unexpected_eof             = 336920580L;
