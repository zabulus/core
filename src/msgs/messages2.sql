...
(NULL, NULL, 'dyn_def.epp', NULL, 8, 221, NULL, 'Maximum number of collations per character set exceeded', NULL, NULL);
(NULL, NULL, 'dyn_def.epp', NULL, 8, 222, NULL, 'Invalid collation attributes', NULL, NULL);
