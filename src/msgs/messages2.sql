...
(NULL, 'modify_type', 'exe.e', NULL, 2, 90, NULL, 'Type @1 for field @1 does not exist', NULL, NULL);
...
(NULL, 'DDL_ext', 'extract.e', NULL, 2, 248, NULL, 'ddl: cannot open @1', NULL, NULL);
...
(NULL, 'define_relation', 'dyn.c', NULL, 8, 132, NULL, 'Table @1 already exists', NULL, NULL);
...
(NULL, NULL, 'burp.c', NULL, 12, 99, NULL, '	@1O(NE_AT_A_TIME)      restore one table at a time', NULL, NULL);
...
(NULL, NULL, 'burp.c', NULL, 12, 104, NULL, '	@1Z                    print version number', NULL, NULL);
...
(NULL, NULL, 'burp.c', NULL, 12, 132, NULL, 'switches can be abbreviated to the unparenthesized characters', NULL, NULL);
...
(NULL, NULL, 'burp.c', NULL, 12, 181, NULL, '	@1FA(CTOR)             blocking factor', NULL, NULL);
...
(NULL, NULL, 'burp.c', NULL, 12, 187, NULL, '	@1N(O_VALIDITY)        do not restore database validity conditions', NULL, NULL);
...
(NULL, NULL, 'burp.c', NULL, 12, 204, NULL, '	@1S(KIP_BAD_DATA)      skip number of bytes after reading bad data', NULL, NULL);
...
(NULL, NULL, 'burp.c', NULL, 12, 276, NULL, '	@1USE_(ALL_SPACE)      do not reserve space for record versions', NULL, NULL);
(NULL, NULL, 'burpswi.h', NULL, 12, 277, NULL, '        @1SE(RVICE)            use services manager', NULL, NULL);
...
(NULL, NULL, 'burp.cpp', NULL, 12, 294, NULL, '	@1NOD(BTRIGGERS)       do not run database triggers', NULL, NULL);
...
(NULL, 'printInfo', 'gserv.cpp', NULL, 22, 7, NULL, 'Service Manager Version', NULL, NULL);
(NULL, 'printInfo', 'gserv.cpp', NULL, 22, 8, NULL, 'Server version', NULL, NULL);
(NULL, 'printInfo', 'gserv.cpp', NULL, 22, 9, NULL, 'Server implementation', NULL, NULL);
(NULL, 'printInfo', 'gserv.cpp', NULL, 22, 10, NULL, 'Path to firebird.msg', NULL, NULL);
(NULL, 'printInfo', 'gserv.cpp', NULL, 22, 11, NULL, 'Server root', NULL, NULL);
(NULL, 'printInfo', 'gserv.cpp', NULL, 22, 12, NULL, 'Path to lock files', NULL, NULL);
(NULL, 'printInfo', 'gserv.cpp', NULL, 22, 13, NULL, 'Security database', NULL, NULL);
(NULL, 'printInfo', 'gserv.cpp', NULL, 22, 14, NULL, 'Databases', NULL, NULL);
(NULL, 'printInfo', 'gserv.cpp', NULL, 22, 15, NULL, '   Database in use', NULL, NULL);
(NULL, 'printInfo', 'gserv.cpp', NULL, 22, 16, NULL, '   Number of attachments', NULL, NULL);
(NULL, 'printInfo', 'gserv.cpp', NULL, 22, 17, NULL, '   Number of databases', NULL, NULL);
(NULL, 'printInfo', 'gserv.cpp', NULL, 22, 18, NULL, 'Information truncated', NULL, NULL);
(NULL, 'usage', 'gserv.cpp', NULL, 22, 19, NULL, 'Usage: fbsvcmgr manager-name switches...', NULL, NULL);
(NULL, 'usage', 'gserv.cpp', NULL, 22, 20, NULL, 'Manager-name should be service_mgr, may be prefixed with host name', NULL, NULL);
(NULL, 'usage', 'gserv.cpp', NULL, 22, 21, NULL, 'according to common rules (host:service_mgr, \\host\service_mgr).', NULL, NULL);
(NULL, 'usage', 'gserv.cpp', NULL, 22, 22, NULL, 'Switches exactly match SPB tags, used in abbreviated form.', NULL, NULL);
(NULL, 'usage', 'gserv.cpp', NULL, 22, 23, NULL, 'Remove isc_, spb_ and svc_ parts of tag and you will get the switch.', NULL, NULL);
(NULL, 'usage', 'gserv.cpp', NULL, 22, 24, NULL, 'For example: isc_action_svc_backup is specified as action_backup,', NULL, NULL);
(NULL, 'usage', 'gserv.cpp', NULL, 22, 25, NULL, '             isc_spb_dbname => dbname,', NULL, NULL);
(NULL, 'usage', 'gserv.cpp', NULL, 22, 26, NULL, '             isc_info_svc_implementation => info_implementation,', NULL, NULL);
(NULL, 'usage', 'gserv.cpp', NULL, 22, 27, NULL, '             isc_spb_prp_db_online => prp_db_online and so on.', NULL, NULL);
(NULL, 'usage', 'gserv.cpp', NULL, 22, 28, NULL, 'You may specify single action or multiple info items when calling fbsvcmgr once.', NULL, NULL);
(NULL, 'usage', 'gserv.cpp', NULL, 22, 29, NULL, 'Full command line samples:', NULL, NULL);
(NULL, 'usage', 'gserv.cpp', NULL, 22, 30, NULL, 'fbsvcmgr service_mgr user sysdba password masterke action_db_stats dbname employee sts_hdr_pages', NULL, NULL);
(NULL, 'usage', 'gserv.cpp', NULL, 22, 31, NULL, '  (will list header info in database employee on local machine)', NULL, NULL);
(NULL, 'usage', 'gserv.cpp', NULL, 22, 32, NULL, 'fbsvcmgr yourserver:service_mgr user sysdba password masterke info_server_version info_svr_db_info', NULL, NULL);
(NULL, 'usage', 'gserv.cpp', NULL, 22, 33, NULL, '  (will show firebird version and databases usage on yourserver)', NULL, NULL);
(NULL, 'printInfo', 'gserv.cpp', NULL, 22, 34, NULL, 'Transaction @1 is in limbo', NULL, NULL);
(NULL, 'printInfo', 'gserv.cpp', NULL, 22, 35, NULL, 'Multidatabase transaction @1 is in limbo', NULL, NULL);
(NULL, 'printInfo', 'gserv.cpp', NULL, 22, 36, NULL, 'Host Site: @1', NULL, NULL);
(NULL, 'printInfo', 'gserv.cpp', NULL, 22, 37, NULL, 'Transaction @1', NULL, NULL);
(NULL, 'printInfo', 'gserv.cpp', NULL, 22, 38, NULL, 'has been prepared', NULL, NULL);
(NULL, 'printInfo', 'gserv.cpp', NULL, 22, 39, NULL, 'has been committed', NULL, NULL);
(NULL, 'printInfo', 'gserv.cpp', NULL, 22, 40, NULL, 'has been rolled back', NULL, NULL);
(NULL, 'printInfo', 'gserv.cpp', NULL, 22, 41, NULL, 'is not available', NULL, NULL);
(NULL, 'printInfo', 'gserv.cpp', NULL, 22, 42, NULL, 'Remote Site: @1', NULL, NULL);
(NULL, 'printInfo', 'gserv.cpp', NULL, 22, 43, NULL, 'Database Path: @1', NULL, NULL);
(NULL, 'printInfo', 'gserv.cpp', NULL, 22, 44, NULL, 'Automated recovery would commit this transaction', NULL, NULL);
(NULL, 'printInfo', 'gserv.cpp', NULL, 22, 45, NULL, 'Automated recovery would rollback this transaction', NULL, NULL);
(NULL, 'printInfo', 'gserv.cpp', NULL, 22, 46, NULL, 'No idea should it be commited or rolled back', NULL, NULL);
