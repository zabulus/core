...
-- JRD
(NULL, '', 'jrd.c', NULL, 0, 0, NULL, '', NULL, NULL);
...
('bad_db_handle', '', '', NULL, 0, 4, NULL, 'invalid database handle (no active connection)', NULL, NULL);
...
('bad_segstr_handle', '', '', NULL, 0, 8, NULL, 'invalid BLOB handle', NULL, NULL);
('bad_segstr_id', '', '', NULL, 0, 9, NULL, 'invalid BLOB ID', NULL, NULL);
...
('bad_trans_handle', '', '', NULL, 0, 12, NULL, 'invalid transaction handle (expecting explicit transaction start)', NULL, NULL);
...
('invalid_blr', '', '', NULL, 0, 23, NULL, 'invalid request BLR at offset @1', NULL, NULL);
('io_error', '', '', +++
...
('no_segstr_close', '', '', NULL, 0, 35, NULL, 'BLOB was not closed', NULL, NULL);
...
('open_trans', '', '', NULL, 0, 37, NULL, 'cannot disconnect database with open transactions (@1 active)', 'Commit or roll back those transactions before you detach
...
('read_only_view', '', '', NULL, 0, 42, NULL, 'cannot update read-only view @1', 'Views that include a record select, join, or project cannot
...
('segstr_no_op', '', '', NULL, 0, 48, NULL, 'attempted invalid operation on a BLOB', 'Check your program to make sure that it does not reference
...
with blob fields.');
('segstr_no_read', '', '', NULL, 0, 49, NULL, 'attempted read of a new, open BLOB', 'Check and correct your program logic.  Close the blob field
...
field.');
('segstr_no_write', '', '', NULL, 0, 51, NULL, 'attempted write to read-only BLOB', 'If you are using the call interface, open the blob for
...
('segstr_wrong_db', '', '', NULL, 0, 52, NULL, 'attempted reference to BLOB in unavailable database', 'Change your program so that the required database is
...
('stream_eof', NULL, NULL, NULL, 0, 54, NULL, 'attempt to fetch past the last record in a record stream', NULL, '');
...
('wrong_ods', '', '', NULL, 0, 59, NULL, 'unsupported on-disk structure for file @1; found @2.@3, support @4.@5', NULL, NULL);
...
('syntaxerr', '', '', NULL, 0, 70, NULL, 'BLR syntax error: expected @1 at offset @2, encountered @3', NULL, NULL);
...
('badpagtyp', '', '', NULL, 0, 83, NULL, 'page @1 is of wrong type (expected @2, found @3)', NULL, NULL);
...
('wroblrver', '', '', NULL, 0, 92, NULL, 'unsupported BLR version (expected @1, encountered @2)', NULL, NULL);
('wrodpbver', NULL, NULL, NULL, 0, 93, NULL, 'wrong version of database parameter block', NULL, NULL);
('blobnotsup', '', '', NULL, 0, 94, NULL, 'BLOB and array data types are not supported for @1 operation', NULL, NULL);
...
('nullsegkey', '', '', NULL, 0, 115, NULL, 'null segment of UNIQUE KEY', NULL, NULL);
('sqlerr', NULL, NULL, NULL, 0, 116, NULL, 'SQL error code = @1', NULL, NULL);
('wrodynver', '', '', NULL, 0, 117, NULL, 'wrong DYN version', NULL, NULL);
...
('noargacc_read', '', '', NULL, 0, 122, NULL, 'database system cannot read argument @1', NULL, NULL);
('noargacc_write', '', '', NULL, 0, 123, NULL, 'database system cannot write argument @1', NULL, NULL);
...
('bad_segstr_type', '', '', NULL, 0, 145, NULL, 'invalid BLOB type for operation', 'Program attempted a seek on a non-stream (i.e. segmented) blob.', 'Program attempted to a blob seek operation on a non-stream (i.e.
segmented) blob.');
...
('bad_stmt_handle', '', 'why.c', NULL, 0, 165, NULL, 'invalid statement handle', NULL, NULL);
...
('lock_timeout', '', 'lck.c', NULL, 0, 190, NULL, 'lock time-out on wait transaction', NULL, NULL);
...
('bad_svc_handle', '', 'why.c', NULL, 0, 239, NULL, 'invalid service handle', NULL, NULL);
...
('ib_error', '', '', NULL, 0, 369, NULL, 'Firebird error', NULL, NULL);
('cache_redef', '', 'dsql parse.y', NULL, 0, 370, NULL, 'Cache redefined', NULL, NULL);
('cache_too_small', '', 'dsql parse.y', NULL, 0, 371, NULL, 'Insufficient memory to allocate page buffer cache', NULL, NULL);
('log_redef', '', 'dsql parse.y', NULL, 0, 372, NULL, 'Log redefined', NULL, NULL);
...
('partition_not_supp', '', 'dsql parse.y', NULL, 0, 375, NULL, 'Partitions not supported in series of log file specification', NULL, NULL);
...
('precision_err', '', 'dsql parse.y', NULL, 0, 377, NULL, 'Precision must be from 1 to 18', NULL, NULL);
('scale_nogt', '', 'dsql parse.y', NULL, 0, 378, NULL, 'Scale must be between zero and precision', NULL, NULL);
...
('gds_$net_init_error', 'initWSA', 'inet.c', NULL, 0, 399, NULL, 'Error initializing the network software.', NULL, NULL);
('gds_$loadlib_failure', 'initWSA', 'inet.c', NULL, 0, 400, NULL, 'Unable to load required library @1.', NULL, NULL);
...
('io_create_err', '', '', NULL, 0, 413, NULL, 'Error while trying to create file', NULL, NULL);
('io_open_err', '', '', NULL, 0, 414, NULL, 'Error while trying to open file', NULL, NULL);
('io_close_err', '', '', NULL, 0, 415, NULL, 'Error while trying to close file', NULL, NULL);
('io_read_err', '', '', NULL, 0, 416, NULL, 'Error while trying to read from file', NULL, NULL);
('io_write_err', '', '', NULL, 0, 417, NULL, 'Error while trying to write to file', NULL, NULL);
('io_delete_err', '', '', NULL, 0, 418, NULL, 'Error while trying to delete file', NULL, NULL);
('io_access_err', '', '', NULL, 0, 419, NULL, 'Error while trying to access file', NULL, NULL);
...
('optimizer_blk_exe', 'OPT_compile', 'opt.c', NULL, 0, 442, NULL, 'size of optimizer block exceeded', NULL, NULL);
...
('sql_dialect_datatype_unsupport', '', 'dsql/pass1.c', NULL, 0, 476, NULL, 'Client SQL dialect @1 does not support reference to @2 datatype', NULL, NULL);
...
('too_many_contexts', '', 'cmp.c', NULL, 0, 480, NULL, 'Too many Contexts of Relation/Procedure/Views. Maximum allowed is 255', NULL, NULL);
...
('inv_dialect_specified', '', 'pag.c', NULL, 0, 485, NULL, 'Database dialect @1 is not a valid dialect.', NULL, NULL);
('valid_db_dialects', 'jrd8_create_database', 'jrd.c', NULL, 0, 486, NULL, 'Valid database dialects are @1.', NULL, NULL);
('sqlwarn', '', '', NULL, 0, 487, NULL, 'SQL warning code = @1', NULL, NULL);
...
('exec_sql_invalid_var', '(several)', '', NULL, 0, 509, NULL, 'Variable type (position @1) in EXECUTE STATEMENT ''@2'' INTO does not match returned column type', NULL, NULL);
('exec_sql_max_call_exceeded', '(several)', '', NULL, 0, 510, NULL, 'Too many recursion levels of EXECUTE STATEMENT', NULL, NULL);
('conf_access_denied', '(several)', 'dir_list.cpp', NULL, 0, 511, NULL, 'Access to @1 "@2" is denied by server administrator', NULL, NULL);
('wrong_backup_state', '', 'dfw.epp', NULL, 0, 512, NULL, 'Cannot change difference file name while database is in backup mode', NULL, NULL);
...
('', '', '', NULL, 1, 4, NULL, 'bad pool ID', NULL, NULL);
...
(NULL, 'ERRQ_syntax', 'err.c', NULL, 1, 13, NULL, 'expected @1, encountered "@1"', NULL, NULL);
...
('', '', '', NULL, 1, 36, NULL, 'could not create pipe', NULL, NULL);
...
('', '', '', NULL, 1, 42, NULL, 'Cannot open output file "@1"', NULL, NULL);
('', '', '', NULL, 1, 43, NULL, 'Could not run "@1"', NULL, NULL);
...
('', '', '', NULL, 1, 48, NULL, 'BLOB conversion is not supported', NULL, NULL);
...
('', '', '', NULL, 1, 55, NULL, 'BLOB conversion is not supported', NULL, NULL);
...
('', '', '', NULL, 1, 61, NULL, 'could not open scratch file', NULL, NULL);
...
('', '', '', NULL, 1, 67, NULL, 'cannot open command file "@1"', NULL, NULL);
...
('', '', '', NULL, 1, 75, NULL, 'Could not create QLI$PROCEDURES table', NULL, NULL);
...
('', '', '', NULL, 1, 78, NULL, 'QLI$PROCEDURES table must be created with RDO in Rdb/VMS databases', NULL, NULL);
...
('', 'print_topic', 'help.e', NULL, 1, 81, NULL, '
...
('', '', '', NULL, 1, 93, NULL, '	No indexes defined', NULL, NULL);
('', '', '', NULL, 1, 94, NULL, '	No indexes defined', NULL, NULL);
...
('', '', '', NULL, 1, 126, NULL, 'Procedure @1 not found in database @2', NULL, NULL);
...
('', '', '', NULL, 1, 129, NULL, 'No triggers are defined for table @1', NULL, NULL);
...
('', '', '', NULL, 1, 137, NULL, 'variables may not be based on BLOB fields', NULL, NULL);
('', '', '', NULL, 1, 138, NULL, 'cannot perform assignment to computed field @1', NULL, NULL);
(NULL, NULL, NULL, NULL, 1, 139, NULL, 'no context for ERASE', NULL, NULL);
('', '', '', NULL, 1, 140, NULL, 'cannot erase from a join', NULL, NULL);
('', '', '', NULL, 1, 141, NULL, '@1.* cannot be used when a single element is required', NULL, NULL);
...
(NULL, NULL, NULL, NULL, 1, 145, NULL, 'form @1 is not defined in database "@1"', NULL, NULL);
...
('', '', '', NULL, 1, 155, NULL, 'field referenced in BASED ON cannot be resolved against readied databases', NULL, NULL);
...
('', '', '', NULL, 1, 160, NULL, 'BLOB variables are not supported', NULL, NULL);
...
('', '', '', NULL, 1, 166, NULL, '@1 is not a table in database @2', NULL, NULL);
(NULL, NULL, NULL, NULL, 1, 167, NULL, 'variable data type', NULL, NULL);
('', '', '', NULL, 1, 168, NULL, 'no data type may be specified for a variable based on a field', NULL, NULL);
...
('', '', '', NULL, 1, 173, NULL, 'table or view name', NULL, NULL);
...
('', '', '', NULL, 1, 179, NULL, 'column definition clause', NULL, NULL);
...
('', '', '', NULL, 1, 182, NULL, 'FROM RSE clause', NULL, NULL);
...
('', '', '', NULL, 1, 202, NULL, 'period in qualified table name', NULL, NULL);
('', '', '', NULL, 1, 203, NULL, '@1 is not a table in database @2', NULL, NULL);
...
('', '', '', NULL, 1, 208, NULL, 'expected "table_name", encountered "@1"', NULL, NULL);
...
('', '', '', NULL, 1, 233, NULL, 'global field @1 already exists', NULL, NULL);
('', '', '', NULL, 1, 234, NULL, 'Cannot define an index in a view', NULL, NULL);
(NULL, NULL, NULL, NULL, 1, 235, NULL, 'Index @1 already exists', NULL, NULL);
('', '', '', NULL, 1, 236, NULL, 'Column @1 does not occur in table @2', NULL, NULL);
('', '', '', NULL, 1, 237, NULL, 'Table @1 already exists', NULL, NULL);
...
('', '', '', NULL, 1, 242, NULL, 'metadata operation failed', NULL, NULL);
...
('', '', '', NULL, 1, 247, NULL, 'field @1 does not exist', NULL, NULL);
...
('', '', '', NULL, 1, 252, NULL, 'data type cannot be changed locally', NULL, NULL);
...
('', '', '', NULL, 1, 255, NULL, 'Data type conflict with existing global field @1', NULL, NULL);
('', '', '', NULL, 1, 256, NULL, 'No data type specified for field @1', NULL, NULL);
(NULL, NULL, NULL, NULL, 1, 257, NULL, 'database info call failed', NULL, NULL);
('', '', '', NULL, 1, 258, NULL, 'do not understand BLR operator @1', NULL, NULL);
...
(NULL, NULL, NULL, NULL, 1, 264, NULL, 'Field @1 in @2 @3 of database @3', NULL, NULL);
...
('', 'process_statement', 'dtr.c', NULL, 1, 351, NULL, 'Do you want to roll back your updates?', NULL, NULL);
...
('', 'compile_edit', 'compile.c', NULL, 1, 356, NULL, 'EDIT argument must be a BLOB field', NULL, NULL);
('', 'compile_rse', 'compile.c', NULL, 1, 357, NULL, 'relations from multiple databases in single RSE', NULL, NULL);
('', 'compile_edit', 'compile.c', NULL, 1, 358, NULL, 'cannot find database for BLOB edit', NULL, NULL);
...
('', '', 'MOV', NULL, 1, 410, NULL, 'Cannot convert from @1 to @2', NULL, NULL);
('', 'MOVQ_decompose', 'MOV', NULL, 1, 411, NULL, 'Cannot convert "@1" to a numeric value', NULL, NULL);
...
('', 'CMD_transaction', 'command.c', NULL, 1, 465, NULL, 'Error during two phase commit on database @1
...
('', 'MET_modify_field', 'meta.e', NULL, 1, 468, NULL, 'Data type of field @1 may not be changed to or from BLOB', NULL, NULL);
...
('', 'format_value', 'format.c', NULL, 1, 480, NULL, 'cannot format unsubscripted array @1', NULL, NULL);
(NULL, 'extend_pool', 'ALL.C', NULL, 1, 481, NULL, 'unsuccessful attempt to extend pool beyond 64KB', NULL, NULL);
('', 'FMT_format', 'FORMAT.C', NULL, 1, 482, NULL, 'field width (@1) * header segments (@2) greater than 60,000 characters', NULL, NULL);
...
('', 'mover_error', 'mov.c', NULL, 1, 504, NULL, 'unknown data type @1', NULL, NULL);
...
('', 'main', 'DDL.C', NULL, 2, 5, NULL, 'gdef: cannot open @1', NULL, NULL);
('', 'main', 'DDL.C', NULL, 2, 6, NULL, 'gdef: cannot open @1 or @2', NULL, NULL);
('', 'main', 'DDL.C', NULL, 2, 7, NULL, '
...
('', 'DDL_err', 'ddl.c', NULL, 2, 15, NULL, '@1:@2:', NULL, NULL);
...
('', 'EXE_create_database', 'exe.e', NULL, 2, 20, NULL, 'Database "@1" exists but cannot be opened', NULL, NULL);
('', 'EXE_create_database', 'exe.e', NULL, 2, 21, NULL, 'Could not create database "@1"', NULL, NULL);
...
('', 'EXE_drop_database', 'exe.e', NULL, 2, 25, NULL, 'Could not locate database', NULL, NULL);
('', 'EXE_drop_database', 'exe.e', NULL, 2, 26, NULL, 'error committing metadata changes', NULL, NULL);
('', 'EXE_drop_database', 'exe.e', NULL, 2, 27, NULL, 'Could not release database', NULL, NULL);
(NULL, 'EXE_drop_database', ' exe.e', NULL, 2, 28, NULL, 'Could not delete file @1', NULL, NULL);
('', 'EXE_modify_database', 'exe.e', NULL, 2, 29, NULL, 'Could not attach database "@1"', NULL, NULL);
...
('', 'EXE_fini', 'exe.e', NULL, 2, 36, NULL, 'error committing metadata changes', NULL, NULL);
(NULL, 'add_field', 'exe.e', NULL, 2, 37, NULL, 'field @1 already exists in relation @1', NULL, NULL);
...
('', 'add_ files', 'exe.e', NULL, 2, 40, NULL, 'error committing new file declarations', NULL, NULL);
(NULL, 'add_function', 'exe.e', NULL, 2, 41, NULL, 'function @1 already exists', NULL, NULL);
('', 'add_index', 'exe.e', NULL, 2, 42, NULL, '@1 is a view and cannot be indexed', NULL, NULL);
('', 'add_index', 'exe.e', NULL, 2, 43, NULL, 'table @1 does not exist', NULL, NULL);
('', 'add_index', 'exe.e', NULL, 2, 44, NULL, 'index @1: field @2 does not exist in relation @3', NULL, NULL);
('', 'add_index', 'exe.e', NULL, 2, 45, NULL, 'index @1: field @2 in @3 is computed and cannot be a key', NULL, NULL);
('', 'add_index', 'exe.e', NULL, 2, 46, NULL, 'combined key length (@1) for index @2 is > 254 bytes', NULL, NULL);
...
('', 'add_relation', 'exe.e', NULL, 2, 49, NULL, 'table @1 already exists', NULL, NULL);
...
('', 'add_user_privilege', 'exe.e', NULL, 2, 54, NULL, 'table @1 does not exist', NULL, NULL);
('', 'add_view', 'exe.e', NULL, 2, 55, NULL, 'table @1 already exists', NULL, NULL);
(NULL, 'add_view', 'exe.e', NULL, 2, 56, NULL, 'field @1 already exists in relation @2', NULL, NULL);
('', 'add_view', 'exe.e', NULL, 2, 57, NULL, 'field @1 does not exist in relation @2 as referenced in view field @3', NULL, NULL);
...
('', 'drop_field', ' exe.e', NULL, 2, 61, NULL, 'field @1 does not exist in relation @2', NULL, NULL);
('', 'drop_filter', 'exe.e', NULL, 2, 62, NULL, 'filter @1 does not exist', NULL, NULL);
('', 'drop_function', 'exe.e', NULL, 2, 63, NULL, 'function @1 does not exist', NULL, NULL);
('', 'drop_global_field', 'exe.e', NULL, 2, 64, NULL, 'field @1 is used in relation @2 (local name @3) and cannot be dropped', NULL, NULL);
('', 'drop_global_field', 'exe.e', NULL, 2, 65, NULL, 'field @1 does not exist', NULL, NULL);
('', 'drop_index', ' exe.e', NULL, 2, 66, NULL, 'index @1 does not exist', NULL, NULL);
(NULL, 'drop_relation', ' exe.e', NULL, 2, 67, NULL, '@1 referenced by view @2', NULL, NULL);
('', 'drop_relation', ' exe.e', NULL, 2, 68, NULL, 'cannot drop system relation @1', NULL, NULL);
('', 'drop_relation', 'exe.e', NULL, 2, 69, NULL, 'table @1 does not exist', NULL, NULL);
('', 'drop_security', 'exe.e', NULL, 2, 70, NULL, 'security class @1 does not exist', NULL, NULL);
('', 'drop_shadow', 'exe.e', NULL, 2, 71, NULL, 'shadow @1 does not exist', 'The only recourse is to redefine
...
('', 'drop_shadow', 'exe.e', NULL, 2, 72, NULL, 'error committing deletion of shadow', NULL, NULL);
('', 'drop_trigger', 'exe.e', NULL, 2, 73, NULL, 'Trigger @1 does not exist', NULL, NULL);
('', 'drop_trigger_msg', 'exe.e', NULL, 2, 74, NULL, 'Trigger message number @1 for trigger @2 does not exist', NULL, NULL);
('', 'drop_type', 'exe.e', NULL, 2, 75, NULL, 'Type @1 for field @2 does not exist', NULL, NULL);
('', 'erase_userpriv', 'exe.e', NULL, 2, 76, NULL, 'User privilege @1 on field @2 in relation @3
for user @4 does not exist', NULL, NULL);
('', 'erase_userpriv', ' exe.e', NULL, 2, 77, NULL, 'User privilege @1 on relation @2 for user @3 does not exist', NULL, NULL);
...
('', 'make_desc', 'exe.e', NULL, 2, 81, NULL, '(EXE) make_desc: do not understand node type', NULL, NULL);
('', 'modify_field', 'exe.e', NULL, 2, 82, NULL, 'field @1 does not exist', NULL, NULL);
('', 'modify_global_field', 'exe.e', NULL, 2, 83, NULL, 'Unauthorized attempt to change field @1 to or from BLOB', NULL, NULL);
('', 'modify_global_field', 'exe.e', NULL, 2, 84, NULL, 'field @1 does not exist', NULL, NULL);
...
('', 'modify_relation', 'exe.e', NULL, 2, 87, NULL, 'table @1 does not exist', NULL, NULL);
(NULL, 'modify_trigger', 'exe.e', NULL, 2, 88, NULL, 'Invalid attempt to assign trigger @1 to a new relation', NULL, NULL);
('', 'modify_trigger', 'exe.e', NULL, 2, 89, NULL, 'Trigger @1 does not exist', NULL, NULL);
('', 'modify_type', 'exe.e', NULL, 2, 90, NULL, 'Type @1 for field @1 does not exist', NULL, NULL);
...
('', 'string_length', 'exe.e', NULL, 2, 94, NULL, '(EXE) string_length: No defined length for BLOBS', NULL, NULL);
...
('', 'expand_action', 'expand.c', NULL, 2, 97, NULL, 'object cannot be resolved', NULL, NULL);
(NULL, 'expand_field', 'expand.c', NULL, 2, 98, NULL, 'Global field @1 is not defined', NULL, NULL);
('', 'field_context', 'expand.c', NULL, 2, 99, NULL, 'field @1 does not exist in relation @2', NULL, NULL);
('', 'field_context', 'expand.c', NULL, 2, 100, NULL, 'field @1 does not exist', NULL, NULL);
('', 'field_search', 'expand.c', NULL, 2, 101, NULL, 'field @1 cannot be resolved', NULL, NULL);
('', 'lookup_field', 'expand.c', NULL, 2, 102, NULL, 'field @1 is not defined in relation @2', NULL, NULL);
('', 'lookup_global_field', 'expand.c', NULL, 2, 103, NULL, 'global field @1 is not defined', NULL, NULL);
('', 'lookup relation', 'expand.c', NULL, 2, 104, NULL, 'relation @1 is not defined', NULL, NULL);
('', 'lookup_trigger', 'expand.c', NULL, 2, 105, NULL, 'trigger @1 is not defined', NULL, NULL);
...
('', 'NOD_resolve', 'expand.c', NULL, 2, 109, NULL, 'Cannot resolve field "@1"', NULL, NULL);
...
('', 'PARSE_relation', 'parse.c', NULL, 2, 116, NULL, 'expected table name, encountered "@1"', NULL, NULL);
...
('', 'define_database', 'parse.c', NULL, 2, 121, NULL, 'only SECURITY_CLASS, DESCRIPTION, and CACHE can be dropped', NULL, NULL);
('', 'define_database', 'parse.c', NULL, 2, 122, NULL, 'PAGE_SIZE cannot be modified', NULL, NULL);
...
('', 'define_function', 'parse.c', NULL, 2, 132, NULL, 'expected comma or semicolon, encountered "@1"', NULL, NULL);
...
('', 'define_index', 'parse.c', NULL, 2, 135, NULL, 'expected comma or semicolon, encountered "@1"', NULL, NULL);
(NULL, 'define_old_trigger', 'parse.c', NULL, 2, 136, NULL, 'expected STORE, MODIFY, ERASE, END_TRIGGER, encountered "@1"', NULL, NULL);
('', 'define_relation', ' parse.c', NULL, 2, 137, NULL, 'table @1 already exists', NULL, NULL);
('', 'define_relation', 'parse.c', NULL, 2, 138, NULL, 'expected comma or semicolon, encountered "@1"', NULL, NULL);
...
('', 'define_trigger', 'parse.c', NULL, 2, 142, NULL, 'message number @1 exceeds 255', NULL, NULL);
...
('', 'define_view', 'parse.c', NULL, 2, 147, NULL, 'data type cstring not supported for fields', NULL, NULL);
...
('', 'modify_field', 'parse.c', NULL, 2, 168, NULL, 'data type cstring not supported for fields', NULL, NULL);
('', 'modify_field', 'parse.c', NULL, 2, 169, NULL, ' A computed expression cannot be changed or added', NULL, NULL);
...
('', 'modify_relation', 'parse.c', NULL, 2, 173, NULL, 'A computed expression cannot be changed or added', NULL, NULL);
...
('', 'modify_trigger', 'parse.c', NULL, 2, 177, NULL, 'Unsuccessful attempt to modify trigger relation', NULL, NULL);
('', 'modify_trigger', 'parse.c', NULL, 2, 178, NULL, 'message number @1 exceeds 255', NULL, NULL);
(NULL, 'modify_trigger', 'parse.c', NULL, 2, 179, NULL, 'expected message modification keyword, encountered "@1"', NULL, NULL);
('', 'modify_type', 'parse.c', NULL, 2, 180, NULL, 'database version is too old for the new syntax: types', NULL, NULL);
('', 'modify_view', 'parse.c', NULL, 2, 181, NULL, 'A computed expression cannot be changed or added', NULL, NULL);
...
('', 'parse_end', 'parse.c', NULL, 2, 190, NULL, 'expected semicolon, encountered "@1"', NULL, NULL);
('', 'parse_field', 'parse.c', NULL, 2, 191, NULL, 'data type cstring not supported for fields', NULL, NULL);
...
('', 'parse_field_clauses', ' parse.c', NULL, 2, 194, NULL, 'COMPUTED BY expression must be parenthesized', NULL, NULL);
...
('', 'parse_identifier', 'parse.c', NULL, 2, 207, NULL, 'expected comma between group and user ID, encountered "@1"', NULL, NULL);
...
('', 'parse_page_size', 'parse.c', NULL, 2, 210, NULL, 'PAGE_SIZE specified (@1) longer than limit of @2 bytes', NULL, NULL);
...
('', 'validate_field', 'parse.c', NULL, 2, 227, NULL, 'computed fields need data types', NULL, NULL);
('', 'validate_field', 'parse.c', NULL, 2, 228, NULL, 'subtypes are valid only for BLOBS and text', NULL, NULL);
('', 'validate_field', 'parse.c', NULL, 2, 229, NULL, 'segment length is valid only for BLOBS', NULL, NULL);
('', ' lookup_global_field', 'parse.c', NULL, 2, 230, NULL, 'global field @1 is not defined', NULL, NULL);
...
('', 'parse_from', 'expr.c', NULL, 2, 239, NULL, 'expected FROM RSE clause, encountered "@1"', NULL, NULL);
...
('', 'DDL_ext', 'extract.e', NULL, 2, 248, NULL, 'ddl: cannot open @1', NULL, NULL);
...
('', 'extract_computed', 'extract.e', NULL, 2, 252, NULL, '**** field @1 cannot be extracted, computed source missing ***', NULL, NULL);
(NULL, '', '', NULL, 2, 253, NULL, '', NULL, NULL);
...
('', 'print_blob', 'extract.e', NULL, 2, 270, NULL, '*****  BLOB option not understood ****', NULL, NULL);
...
('', '', '   LEX_init', NULL, 2, 276, NULL, 'could not open scratch file', NULL, NULL);
...
('', 'TRN_translate', 'trn.c', NULL, 2, 281, NULL, 'gdef: cannot open DYN output file: @1', NULL, NULL);
...
('', 'define_trigger', 'parse.c', NULL, 2, 294, NULL, 'unexpected end of file, semicolon missing?', NULL, NULL);
('', 'parse_function_arg', 'parse.c', NULL, 2, 295, NULL, 'Functions cannot return arrays.', NULL, NULL);
...
('', 'define_view', 'parse.c', NULL, 2, 300, NULL, 'table @1 already exists', NULL, NULL);
('', 'modify_global_field', 'exe.e', NULL, 2, 301, NULL, 'Array indexes and size cannot be modified', NULL, NULL);
('', 'check_range', 'exe.e', NULL, 2, 302, NULL, 'Modify data type of array @1 requires complete field specification', NULL, NULL);
...
('', 'add_index', 'exe.e', NULL, 2, 312, NULL, 'key length (@1) for compound index @2 exceeds 202', NULL, NULL);
...
('', 'EXE_modify_database', 'exe.e', NULL, 2, 321, NULL, 'error committing new Write-ahead Log declarations', NULL, NULL);
...
('', 'add_cache', 'exe.e', NULL, 2, 324, NULL, 'error committing new shared cache file declaration', NULL, NULL);
(NULL, 'drop_cache', 'exe.e', NULL, 2, 325, NULL, 'no shared cache file exists to drop', NULL, NULL);
('', 'drop_cache', 'exe.e', NULL, 2, 326, NULL, 'error committing deletion of shared cache file', NULL, NULL);
('', 'EXE_drop_database', 'exe.e', NULL, 2, 327, NULL, 'error in getting Write-ahead Log information', NULL, NULL);
...
('', 'define_log_file', 'parse.c', NULL, 2, 336, NULL, 'Minimum log length should be @1 Kbytes', NULL, NULL);
('', 'define_database', 'parse.c', NULL, 2, 337, NULL, 'Cannot add and drop log file in same statement.', NULL, NULL);
(NULL, 'define_database', 'parse.c', NULL, 2, 338, NULL, 'Only one log configuration can be specified.', NULL, NULL);
('', 'define_cache', 'parse.c', NULL, 2, 339, NULL, 'minimum of @1 cache pages required', NULL, NULL);
...
('dsql_feature_not_supported_ods', '', 'ddl.cpp', NULL, 7, 25, NULL, 'Feature not supported on ODS version older than @1.@2', NULL, NULL);
...
('', '', 'dyn.c', NULL, 8, 9, NULL, 'DEFINE GENERATOR unexpected DYN verb', NULL, NULL);
...
('', '', 'dyn.c', NULL, 8, 14, NULL, 'No table specified for index', NULL, NULL);
(NULL, NULL, 'dyn.c', NULL, 8, 15, NULL, 'STORE RDB$INDICES failed', NULL, NULL);
(NULL, NULL, 'dyn.c', NULL, 8, 16, NULL, 'unsupported DYN verb', NULL, NULL);
('', '', 'dyn.c', NULL, 8, 17, NULL, 'PRIMARY KEY column lookup failed', NULL, NULL);
('', '', 'dyn_def.epp', NULL, 8, 18, NULL, 'could not find UNIQUE or PRIMARY KEY constraint in table @1 with specified columns', NULL, NULL);
('', '', 'dyn.c', NULL, 8, 19, NULL, 'PRIMARY KEY lookup failed', NULL, NULL);
('', '', 'dyn.c', NULL, 8, 20, NULL, 'could not find PRIMARY KEY index in specified table @1', NULL, NULL);
...
('', '', 'dyn.c', NULL, 8, 25, NULL, 'STORE RDB$USER_PRIVILEGES failed defining a table', NULL, NULL);
...
('', '', 'dyn.c', NULL, 8, 37, NULL, 'BLOB Filter @1 not found', 'Define blob filter in RDB$BLOB_FILTERS.', 'Blob filter was not found.');
...
('', '', 'dyn_del.epp', NULL, 8, 43, NULL, 'Domain @1 is used in table @2 (local name @3) and cannot be dropped', NULL, NULL);
...
('', '', 'dyn.c', NULL, 8, 46, NULL, 'Column not found', NULL, NULL);
...
('', '', 'dyn.c', NULL, 8, 51, NULL, 'No table specified in ERASE RFR', NULL, NULL);
('', '', 'dyn.c', NULL, 8, 52, NULL, 'Column @1 from table @2 is referenced in view @3', NULL, NULL);
...
('', '', 'dyn.c', NULL, 8, 55, NULL, 'Column not found for table', NULL, NULL);
...
('', '', 'dyn.c', NULL, 8, 61, NULL, 'Table not found', NULL, NULL);
...
('', '', 'dyn.c', NULL, 8, 74, NULL, 'ERASE RDB$SECURITY_CLASSES failed', NULL, NULL);
...
('', '', 'dyn.c', NULL, 8, 80, NULL, ' Specified domain or source column does not exist', NULL, NULL);
('', '', 'dyn.c', NULL, 8, 81, NULL, 'Generation of column name failed', NULL, NULL);
...
('', '', 'dyn.c', NULL, 8, 89, NULL, 'Domain not found', NULL, NULL);
...
('', '', 'dyn.c', NULL, 8, 93, NULL, 'Index column not found', NULL, NULL);
...
('', '', 'dyn.c', NULL, 8, 96, NULL, 'Local column @1 not found', NULL, NULL);
...
('', '', 'dyn.c', NULL, 8, 101, NULL, 'Table column not found', NULL, NULL);
...
('', '', 'dyn.c', NULL, 8, 106, NULL, 'Create metadata BLOB failed', NULL, NULL);
('', '', 'dyn.c', NULL, 8, 107, NULL, 'Write metadata BLOB failed', NULL, NULL);
('', '', 'dyn.c', NULL, 8, 108, NULL, 'Close metadata BLOB failed', NULL, NULL);
('', '', 'dyn.c', NULL, 8, 109, NULL, 'Triggers created automatically cannot be modified', NULL, NULL);
...
('', 'define_index', 'dyn.e', NULL, 8, 116, NULL, ' attempt to index BLOB column in INDEX @1', NULL, NULL);
('', 'define_index', 'dyn.e', NULL, 8, 117, NULL, ' attempt to index array column in index @1', NULL, NULL);
...
('', 'define_index', 'dyn.e', NULL, 8, 120, NULL, 'Unknown columns in index @1', NULL, NULL);
...
('', 'define_constraint', 'dyn.e', NULL, 8, 123, NULL, 'Column: @1 not defined as NOT NULL - cannot be used in PRIMARY KEY constraint definition', NULL, NULL);
(NULL, 'define_constraint', 'dyn.e', NULL, 8, 124, NULL, 'A column name is repeated in the definition of constraint: @1', NULL, NULL);
('', 'define_constraint', 'dyn.e', NULL, 8, 125, NULL, 'Integrity Constraint lookup failed', NULL, NULL);
...
('', 'delete_constraint', 'dyn.e', NULL, 8, 128, NULL, 'No table specified in delete_constraint', NULL, NULL);
...
('', 'define_relation', 'dyn.c', NULL, 8, 132, NULL, 'Table @1 already exists', NULL, NULL);
...
(NULL, 'define_procedure', 'dyn.e', NULL, 8, 135, NULL, 'Procedure @1 already exists', NULL, NULL);
(NULL, 'define_parameter', 'dyn.e', NULL, 8, 136, NULL, 'STORE RDB$PROCEDURE_PARAMETERS failed', NULL, NULL);
('', 'define_intl_info', 'dyn.e', NULL, 8, 137, NULL, 'Store into system table @1 failed', NULL, NULL);
...
(NULL, '', 'dyn.c', NULL, 8, 148, NULL, 'Only one data type change to the domain @1 allowed at a time', NULL, NULL);
(NULL, '', 'dyn.c', NULL, 8, 149, NULL, 'Only one data type change to the field @1 allowed at a time', NULL, NULL);
(NULL, '', 'dyn.c', NULL, 8, 150, NULL, 'STORE RDB$FILES failed', NULL, NULL);
('', '', 'dyn_mod.epp', NULL, 8, 151, NULL, 'Character set @1 not found', NULL, NULL);
('', '', 'dyn_mod.epp', NULL, 8, 152, NULL, 'Collation @1 not found', NULL, NULL);
(NULL, '', 'dyn.c', NULL, 8, 153, NULL, 'ERASE RDB$LOG_FILES failed', NULL, NULL);
(NULL, '', 'dyn.c', NULL, 8, 154, NULL, 'STORE RDB$LOG_FILES failed', NULL, NULL);
('', '', 'dyn_mod.epp', NULL, 8, 155, NULL, 'Role @1 not found', NULL, NULL);
(NULL, '', 'dyn.e', NULL, 8, 156, NULL, 'Difference file lookup failed', NULL, NULL);
...
('', 'get_string', 'dyn.e', NULL, 8, 159, NULL, 'Name longer than database column size', NULL, NULL);
(NULL, 'modify_global_field', 'dyn', NULL, 8, 160, NULL, '"Only one constraint allowed for a domain"', NULL, NULL);
('', 'generate_field_position', 'dyn.e', NULL, 8, 162, NULL, 'Looking up column position failed', NULL, NULL);
...
('', 'define_shadow', 'dyn.e', NULL, 8, 164, NULL, 'Shadow lookup failed', NULL, NULL);
('', 'define_shadow', 'dyn.e', NULL, 8, 165, NULL, 'Shadow @1 already exists', NULL, NULL);
('', 'define_file', 'dyn.c', NULL, 8, 166, NULL, 'Cannot add file with the same name as the database or added files', NULL, NULL);
('', 'grantor_can_grant', 'dyn.e', NULL, 8, 167, NULL, 'no grant option for privilege @1 on column @2 of table/view @3', NULL, NULL);
('', 'grantor_can_grant', 'dyn.e', NULL, 8, 168, NULL, 'no grant option for privilege @1 on column @2 of base table/view @3', NULL, NULL);
('', 'grantor_can_grant', 'dyn.e', NULL, 8, 169, NULL, 'no grant option for privilege @1 on table/view @2 (for column @3)', NULL, NULL);
('', 'grantor_can_grant', 'dyn.e', NULL, 8, 170, NULL, 'no grant option for privilege @1 on base table/view @2 (for column @3)', NULL, NULL);
('', 'grantor_can_grant', 'dyn.e', NULL, 8, 171, NULL, 'no @1 privilege with grant option on table/view @2 (for column @3)', NULL, NULL);
('', 'grantor_can_grant', 'dyn.e', NULL, 8, 172, NULL, 'no @1 privilege with grant option on base table/view @2 (for column @3)', NULL, NULL);
('', 'grantor_can_grant', 'dyn.e', NULL, 8, 173, NULL, 'no grant option for privilege @1 on table/view @2', NULL, NULL);
('', 'grantor_can_grant', 'dyn.e', NULL, 8, 174, NULL, 'no @1 privilege with grant option on table/view @2', NULL, NULL);
('', 'grantor_can_grant', 'dyn.e', NULL, 8, 175, NULL, 'table/view @1 does not exist', NULL, NULL);
('', 'grantor_can_grant', 'dyn.e', NULL, 8, 176, NULL, 'column @1 does not exist in table/view @2', NULL, NULL);
('', 'modify_relation', 'dyn.e', NULL, 8, 177, NULL, 'Can not alter a view', NULL, NULL);
('', 'check_relation_existance', 'jrd/dyn.e', NULL, 8, 178, NULL, 'EXTERNAL FILE table not supported in this context', NULL, NULL);
('', 'create_index', 'dyn.e', NULL, 8, 179, NULL, 'attempt to index COMPUTED BY column in INDEX @1', NULL, NULL);
('', 'define_index', 'dyn.e', NULL, 8, 180, NULL, 'Table Name lookup failed', NULL, NULL);
('', 'define_index', 'dyn.e', NULL, 8, 181, NULL, 'attempt to index a view', NULL, NULL);
('', 'grantor_can_grant', 'dyn.c', NULL, 8, 182, NULL, 'SELECT RDB$RELATIONS failed in grant', NULL, NULL);
('', 'grantor_can_grant', 'dyn.c', NULL, 8, 183, NULL, 'SELECT RDB$RELATION_FIELDS failed in grant', NULL, NULL);
('', 'grantor_can_grant', 'dyn.c', NULL, 8, 184, NULL, 'SELECT RDB$RELATIONS/RDB$OWNER_NAME failed in grant', NULL, NULL);
('', 'grantor_can_grant', 'dyn.c', NULL, 8, 185, NULL, 'SELECT RDB$USER_PRIVILEGES failed in grant', NULL, NULL);
('', 'grantor_can_grant', 'dyn', NULL, 8, 186, NULL, 'SELECT RDB$VIEW_RELATIONS/RDB$RELATION_FIELDS/... failed in grant', NULL, NULL);
('', 'DYN_delete_local_field', 'dyn_del.e', NULL, 8, 187, NULL, 'column @1 from table @2 is referenced in index @3', NULL, NULL);
...
('', 'change_backup_mode', 'dyn_mod.epp', NULL, 8, 215, NULL, 'Difference file is not defined', NULL, NULL);
('', 'change_backup_mode', 'dyn_mod.epp', NULL, 8, 216, NULL, 'Difference file is already defined', NULL, NULL);
('', 'DYN_define_difference', 'dyn_def.epp', NULL, 8, 217, NULL, 'Database is already in the physical backup mode', NULL, NULL);
('', 'change_backup_mode', 'dyn_mod.epp', NULL, 8, 218, NULL, 'Database is not in the physical backup mode', NULL, NULL);
...
('', '', 'dyn_del.epp', NULL, 8, 235, NULL, 'Collation @1 is used in table @2 (field name @3) and cannot be dropped', NULL, NULL);
('', '', 'dyn_del.epp', NULL, 8, 236, NULL, 'Collation @1 is used in domain @2 and cannot be dropped', NULL, NULL);
('', 'DYN_delete_collation', 'dyn_del.epp', NULL, 8, 237, NULL, 'Cannot delete system collation', NULL, NULL);
('', 'DYN_delete_collation', 'dyn_del.epp', NULL, 8, 238, NULL, 'Cannot delete default collation of CHARACTER SET @1', NULL, NULL);
('', '', 'dyn_del.epp', NULL, 8, 239, NULL, 'Domain @1 is used in procedure @2 (parameter name @3) and cannot be dropped', NULL, NULL);
...
('gbak_page_size_missing', '', 'burp.c', NULL, 12, 2, NULL, 'page size parameter missing', NULL, NULL);
('gbak_page_size_toobig', '', 'burp.c', NULL, 12, 3, NULL, 'Page size specified (@1) greater than limit (16384 bytes)', NULL, NULL);
('gbak_redir_ouput_missing', '', 'burp.c', NULL, 12, 4, NULL, 'redirect location for output is not specified', NULL, NULL);
('gbak_switches_conflict', '', 'burp.c', NULL, 12, 5, NULL, 'conflicting switches for backup/restore', NULL, NULL);
('gbak_unknown_device', '', 'burp.c', NULL, 12, 6, NULL, 'device type @1 not known', NULL, NULL);
('gbak_no_protection', '', 'burp.c', NULL, 12, 7, NULL, 'protection is not there yet', NULL, NULL);
('gbak_page_size_not_allowed', '', 'burp.c', NULL, 12, 8, NULL, 'page size is allowed only on restore or create', NULL, NULL);
('gbak_multi_source_dest', '', 'burp.c', NULL, 12, 9, NULL, 'multiple sources or destinations specified', NULL, NULL);
('gbak_filename_missing', '', 'burp.c', NULL, 12, 10, NULL, 'requires both input and output filenames', NULL, NULL);
('gbak_dup_inout_names', '', 'burp.c', NULL, 12, 11, NULL, 'input and output have the same name.  Disallowed.', NULL, NULL);
('gbak_inv_page_size', '', 'burp.c', NULL, 12, 12, NULL, 'expected page size, encountered "@1"', NULL, NULL);
('gbak_db_specified', '', 'burp.c', NULL, 12, 13, NULL, 'REPLACE specified, but the first file @1 is a database', NULL, NULL);
('gbak_db_exists', '', 'burp.c', NULL, 12, 14, NULL, 'database @1 already exists.  To replace it, use the -REP switch', NULL, NULL);
('gbak_unk_device', '', 'burp.c', NULL, 12, 15, NULL, 'device type not specified', NULL, NULL);
('', '', 'burp.c', NULL, 12, 16, NULL, 'cannot create APOLLO tape descriptor file @1', NULL, NULL);
('', '', 'burp.c', NULL, 12, 17, NULL, 'cannot set APOLLO tape descriptor attribute for @1', NULL, NULL);
('', '', 'burp.c', NULL, 12, 18, NULL, 'cannot create APOLLO cartridge descriptor file @1', NULL, NULL);
('', '', 'burp.c', NULL, 12, 19, NULL, 'cannot close APOLLO tape descriptor file @1', NULL, NULL);
('gbak_blob_info_failed', '', 'burp.c', NULL, 12, 20, NULL, 'gds_$blob_info failed', NULL, NULL);
('gbak_unk_blob_item', '', 'burp.c', NULL, 12, 21, NULL, 'do not understand BLOB INFO item @1', NULL, NULL);
('gbak_get_seg_failed', '', 'burp.c', NULL, 12, 22, NULL, 'gds_$get_segment failed', NULL, NULL);
('gbak_close_blob_failed', '', 'burp.c', NULL, 12, 23, NULL, 'gds_$close_blob failed', NULL, NULL);
('gbak_open_blob_failed', '', 'burp.c', NULL, 12, 24, NULL, 'gds_$open_blob failed', NULL, NULL);
('gbak_put_blr_gen_id_failed', '', 'burp.c', NULL, 12, 25, NULL, 'Failed in put_blr_gen_id', NULL, NULL);
('gbak_unk_type', '', 'burp.c', NULL, 12, 26, NULL, 'data type @1 not understood', NULL, NULL);
('gbak_comp_req_failed', '', 'burp.c', NULL, 12, 27, NULL, 'gds_$compile_request failed', NULL, NULL);
('gbak_start_req_failed', '', 'burp.c', NULL, 12, 28, NULL, 'gds_$start_request failed', NULL, NULL);
('gbak_rec_failed', '', 'burp.c', NULL, 12, 29, NULL, ' gds_$receive failed', NULL, NULL);
('gbak_rel_req_failed', '', 'burp.c', NULL, 12, 30, NULL, 'gds_$release_request failed', NULL, NULL);
('gbak_db_info_failed', '', 'burp.c', NULL, 12, 31, NULL, ' gds_$database_info failed', NULL, NULL);
('gbak_no_db_desc', '', 'burp.c', NULL, 12, 32, NULL, 'Expected database description record', NULL, NULL);
('gbak_db_create_failed', '', 'burp.c', NULL, 12, 33, NULL, 'failed to create database @1', NULL, NULL);
('gbak_decomp_len_error', '', 'burp.c', NULL, 12, 34, NULL, 'RESTORE: decompression length error', NULL, NULL);
('gbak_tbl_missing', '', 'burp.c', NULL, 12, 35, NULL, 'cannot find table @1', NULL, NULL);
('gbak_blob_col_missing', '', 'burp.c', NULL, 12, 36, NULL, 'Cannot find column for BLOB', NULL, NULL);
('gbak_create_blob_failed', '', 'burp.c', NULL, 12, 37, NULL, 'gds_$create_blob failed', NULL, NULL);
('gbak_put_seg_failed', '', 'burp.c', NULL, 12, 38, NULL, 'gds_$put_segment failed', NULL, NULL);
('gbak_rec_len_exp', '', 'burp.c', NULL, 12, 39, NULL, 'expected record length', NULL, NULL);
('gbak_inv_rec_len', '', 'burp.c', NULL, 12, 40, NULL, 'wrong length record, expected @1 encountered @2', NULL, NULL);
('gbak_exp_data_type', '', 'burp.c', NULL, 12, 41, NULL, 'expected data attribute', NULL, NULL);
('gbak_gen_id_failed', '', 'burp.c', NULL, 12, 42, NULL, 'Failed in store_blr_gen_id', NULL, NULL);
('gbak_unk_rec_type', '', 'burp.c', NULL, 12, 43, NULL, 'do not recognize record type @1', NULL, NULL);
('gbak_inv_bkup_ver', '', 'burp.c', NULL, 12, 44, NULL, 'Expected backup version 1..8.  Found @1', NULL, NULL);
('gbak_missing_bkup_desc', '', 'burp.c', NULL, 12, 45, NULL, 'expected backup description record', NULL, NULL);
('gbak_string_trunc', '', 'burp.c', NULL, 12, 46, NULL, 'string truncated', NULL, NULL);
('gbak_cant_rest_record', '', 'burp.c', NULL, 12, 47, NULL, ' warning -- record could not be restored', NULL, NULL);
('gbak_send_failed', '', 'burp.c', NULL, 12, 48, NULL, 'gds_$send failed', NULL, NULL);
('gbak_no_tbl_name', '', 'burp.c', NULL, 12, 49, NULL, 'no table name for data', NULL, NULL);
('gbak_unexp_eof', '', 'burp.c', NULL, 12, 50, NULL, 'unexpected end of file on backup file', NULL, NULL);
('gbak_db_format_too_old', '', 'burp.c', NULL, 12, 51, NULL, 'database format @1 is too old to restore to', NULL, NULL);
('gbak_inv_array_dim', '', 'burp.c', NULL, 12, 52, NULL, 'array dimension for column @1 is invalid', NULL, NULL);
...
('gbak_xdr_len_expected', '', 'burp.c', NULL, 12, 55, NULL, 'Expected XDR record length', NULL, NULL);
...
(NULL, NULL, 'burp.c', NULL, 12, 60, NULL, '	@1B(ACKUP_DATABASE)    backup database to file', NULL, NULL);
...
(NULL, NULL, 'burp.c', NULL, 12, 63, NULL, '	@1M(ETA_DATA)          backup or restore metadata only', NULL, NULL);
(NULL, NULL, 'burp.c', NULL, 12, 64, NULL, 'blob', NULL, NULL);
('gbak_open_bkup_error', '', 'burp.c', NULL, 12, 65, NULL, 'cannot open backup file @1', NULL, NULL);
('gbak_open_error', '', 'burp.c', NULL, 12, 66, NULL, 'cannot open status and error output file @1', NULL, NULL);
(NULL, NULL, 'burp.c', NULL, 12, 67, NULL, 'closing file, committing, and finishing', NULL, NULL);
('', '', 'burp.c', NULL, 12, 68, NULL, '    committing metadata', NULL, NULL);
('', '', 'burp.c', NULL, 12, 69, NULL, 'commit failed on table @1', NULL, NULL);
...
('', '', 'burp.c', NULL, 12, 72, NULL, 'committing data for table @1', NULL, NULL);
(NULL, NULL, 'burp.c', NULL, 12, 73, NULL, '	@1C(REATE_DATABASE)    create database from backup file', NULL, NULL);
...
(NULL, NULL, 'burp.c', NULL, 12, 78, NULL, '	@1I(NACTIVE)           deactivate indexes during restore', NULL, NULL);
('', '', 'burp.c', NULL, 12, 79, NULL, 'do not understand BLOB INFO item @1', NULL, NULL);
('', '', 'burp.c', NULL, 12, 80, NULL, 'do not recognize @1 attribute @2 -- continuing', NULL, NULL);
('', '', 'burp.c', NULL, 12, 81, NULL, 'error accessing BLOB column @1 -- continuing', NULL, NULL);
...
('', '', 'burp.c', NULL, 12, 84, NULL, 'column', NULL, NULL);
...
('', '', 'burp.c', NULL, 12, 92, NULL, 'domain', NULL, NULL);
(NULL, NULL, 'burp.c', NULL, 12, 93, NULL, 'index', NULL, NULL);
(NULL, NULL, 'burp.c', NULL, 12, 94, NULL, 'trigger @1 is invalid', NULL, NULL);
(NULL, NULL, 'burp.c', NULL, 12, 95, NULL, 'legal switches are:', NULL, NULL);
(NULL, NULL, 'burp.c', NULL, 12, 96, NULL, 'length given for initial file (@1) is less than minimum (@2)', NULL, NULL);
(NULL, NULL, 'burp.c', NULL, 12, 97, NULL, '	@1E(XPAND)             no data compression', NULL, NULL);
(NULL, NULL, 'burp.c', NULL, 12, 98, NULL, '	@1L(IMBO)              ignore transactions in limbo', NULL, NULL);
('', '', 'burp.c', NULL, 12, 99, NULL, '	@1O(NE_AT_A_TIME)      restore one table at a time', NULL, NULL);
(NULL, NULL, 'burp.c', NULL, 12, 100, NULL, 'opened file @1', NULL, NULL);
(NULL, NULL, 'burp.c', NULL, 12, 101, NULL, '	@1P(AGE_SIZE)          override default page size', NULL, NULL);
...
('', '', 'burp.c', NULL, 12, 104, NULL, '	@1Z                    print version number', NULL, NULL);
...
('', '', 'burp.c', NULL, 12, 109, NULL, '	@1Y  <path>            redirect/suppress status message output', NULL, NULL);
(NULL, NULL, 'burp.c', NULL, 12, 110, NULL, 'Reducing the database page size from @1 bytes to @2 bytes', NULL, NULL);
('', '', 'burp.c', NULL, 12, 111, NULL, 'table', NULL, NULL);
(NULL, NULL, 'burp.c', NULL, 12, 112, NULL, '	@1REP(LACE_DATABASE)   replace database from backup file', NULL, NULL);
(NULL, NULL, 'burp.c', NULL, 12, 113, NULL, '	@1V(ERIFY)             report each action taken', NULL, NULL);
('', '', 'burp.c', NULL, 12, 114, NULL, 'restore failed for record in table @1', NULL, NULL);
('', '', 'burp.c', NULL, 12, 115, NULL, '    restoring column @1', NULL, NULL);
...
('', '', 'burp.c', NULL, 12, 121, NULL, 'restoring domain @1', NULL, NULL);
...
('', '', 'burp.c', NULL, 12, 124, NULL, 'restoring data for table @1', NULL, NULL);
...
('', '', 'burp.c', NULL, 12, 128, NULL, '    restoring type @1 for column @2', NULL, NULL);
...
('', '', 'burp.c', NULL, 12, 132, NULL, 'switches can be abbreviated to the unparenthesized characters', NULL, NULL);
...
('', '', 'burp.c', NULL, 12, 138, NULL, 'validation error on column in table @1', NULL, NULL);
...
('', '', 'burp.c', NULL, 12, 142, NULL, '    writing data for table @1', NULL, NULL);
(NULL, NULL, 'burp.c', NULL, 12, 143, NULL, '     writing gen id of: @1', NULL, NULL);
('', '', 'burp.c', NULL, 12, 144, NULL, '         writing column @1', NULL, NULL);
...
('', '', 'burp.c', NULL, 12, 149, NULL, '    writing domain @1', NULL, NULL);
('', '', 'burp.c', NULL, 12, 150, NULL, 'writing domains', NULL, NULL);
...
('', '', 'burp.c', NULL, 12, 153, NULL, '    writing table @1', NULL, NULL);
('', '', 'burp.c', NULL, 12, 154, NULL, 'writing tables', NULL, NULL);
...
('', '', 'burp.c', NULL, 12, 160, NULL, '    writing type @1 for column @2', NULL, NULL);
...
(NULL, '', 'burp.c', NULL, 12, 166, NULL, 'readied database @1 for backup', NULL, NULL);
('', '', 'burp.c', NULL, 12, 167, NULL, 'restoring table @1', NULL, NULL);
(NULL, '', 'burp.c', NULL, 12, 168, NULL, 'type', NULL, NULL);
(NULL, 'BURP_print', 'burp.c', NULL, 12, 169, NULL, 'gbak:', NULL, NULL);
('', '', 'restore.e', NULL, 12, 170, NULL, 'committing metadata for table @1', NULL, NULL);
('', '', 'restore.e', NULL, 12, 171, NULL, ' error committing metadata for table @1', NULL, NULL);
(NULL, 'main', 'burp.c', NULL, 12, 172, NULL, '	@1K(ILL)               restore without creating shadows', NULL, NULL);
...
(NULL, 'main', 'burp.c', NULL, 12, 175, NULL, '	@1T(RANSPORTABLE)      transportable backup -- data in XDR format', NULL, NULL);
(NULL, 'BACKUP_backup', 'backup.e', NULL, 12, 176, NULL, 'closing file, committing, and finishing. @1 bytes written', NULL, NULL);
(NULL, 'main', 'BURP.C', NULL, 12, 177, NULL, '	@1G(ARBAGE_COLLECT)    inhibit garbage collection', NULL, NULL);
(NULL, 'main', 'BURP.C', NULL, 12, 178, NULL, '	@1IG(NORE)             ignore bad checksums', NULL, NULL);
('', 'put_index', 'backup.e', NULL, 12, 179, NULL, '	column @1 used in index @2 seems to have vanished', NULL, NULL);
('', 'put_index', 'backup.e', NULL, 12, 180, NULL, 'index @1 omitted because @2 of the expected @3 keys were found', NULL, NULL);
(NULL, '', 'burp.c', NULL, 12, 181, NULL, '	@1FA(CTOR)             blocking factor', NULL, NULL);
...
(NULL, 'main', 'burp.c', NULL, 12, 186, NULL, '	@1OL(D_DESCRIPTIONS)   save old style metadata descriptions', NULL, NULL);
(NULL, '', 'burp.c', NULL, 12, 187, NULL, '	@1N(O_VALIDITY)        do not restore database validity conditions', NULL, NULL);
...
(NULL, 'main', 'burp.c', NULL, 12, 190, NULL, '	@1PAS(SWORD)           Firebird password', NULL, NULL);
(NULL, 'main', 'burp.c', NULL, 12, 191, NULL, '	@1USER                 Firebird user name', NULL, NULL);
...
('gbak_missing_skipped_bytes', '', 'burp.c', NULL, 12, 200, NULL, ' missing parameter for the number of bytes to be skipped', NULL, NULL);
('gbak_inv_skipped_bytes', '', 'burp.c', NULL, 12, 201, NULL, 'expected number of bytes to be skipped, encountered "@1"', NULL, NULL);
('', '', 'restore.e', NULL, 12, 202, NULL, 'adjusting an invalid decompression length from @1 to @2', NULL, NULL);
('', '', 'restore.e', NULL, 12, 203, NULL, 'skipped @1 bytes after reading a bad attribute @2', NULL, NULL);
(NULL, '', 'burp.c', NULL, 12, 204, NULL, '	@1S(KIP_BAD_DATA)      skip number of bytes after reading bad data', NULL, NULL);
('', '', 'restore.e', NULL, 12, 205, NULL, 'skipped @1 bytes looking for next valid attribute, encountered attribute @2', NULL, NULL);
('', 'write_rel_constraints', 'backup.e', NULL, 12, 206, NULL, 'writing table constraints', NULL, NULL);
(NULL, 'write_rel_constraints', 'backup.e', NULL, 12, 207, NULL, 'writing constraint @1', NULL, NULL);
('', '', 'restore.e', NULL, 12, 208, NULL, 'table constraint', NULL, NULL);
...
('', 'prompt_for_name', 'mvol.c', NULL, 12, 225, NULL, 'Done with volume #@1, "@2"', NULL, NULL);
...
('', 'get_security_class', 'restore.e', NULL, 12, 234, NULL, 'Skipped bad security class entry: @1', NULL, NULL);
('', 'convert_sub_type', 'restore.e', NULL, 12, 235, NULL, 'Unknown V3 SUB_TYPE: @1 in FIELD: @2.', NULL, NULL);
('', 'cvt_v3_to_v4_intl', 'restore.e', NULL, 12, 236, NULL, 'Converted V3 sub_type: @1 to character_set_id: @2 and collate_id: @3.', NULL, NULL);
('', 'cvt_v3_to_v4_intl', 'restore.e', NULL, 12, 237, NULL, 'Converted V3 scale: @1 to character_set_id: @2 and callate_id: @3.', NULL, NULL);
('gbak_sysmemex', 'MISC_alloc_memory', 'misc.c', NULL, 12, 238, NULL, 'System memory exhausted', NULL, NULL);
('', 'main()', 'burp.c', NULL, 12, 239, NULL, '	@1NT                   Non-Transportable backup file format', NULL, NULL);
('', 'RESTORE_restore', 'restore.e', NULL, 12, 240, NULL, 'Index "@1" failed to activate because:', NULL, NULL);
('', 'RESTORE_restore', 'restore.e', NULL, 12, 241, NULL, '  The unique index has duplicate values or NULLs.', NULL, NULL);
('', 'RESTORE_restore', 'restore.e', NULL, 12, 242, NULL, '  Delete or Update duplicate values or NULLs, and activate index with', NULL, NULL);
('', 'RESTORE_restore', 'restore.e', NULL, 12, 243, NULL, '  ALTER INDEX "@1" ACTIVE;', NULL, NULL);
('', 'RESTORE_restore', 'restore.e', NULL, 12, 244, NULL, '  Not enough disk space to create the sort file for an index.', NULL, NULL);
('', 'RESTORE_restore', 'restore.e', NULL, 12, 245, NULL, '  Set the TMP environment variable to a directory on a filesystem that does have enough space, and activate index with', NULL, NULL);
...
('gbak_page_buffers', 'BURP_gbak', 'burp.c', NULL, 12, 257, NULL, '	@1BU(FFERS)            override page buffers default', NULL, NULL);
...
('', 'next_volume', 'mvol.c', NULL, 12, 261, NULL, 'Starting with volume #@1, "@2"', NULL, NULL);
...
('', 'MVOL_write', 'mvol.c', NULL, 12, 272, NULL, 'Warning -- free disk space exhausted for file @1, the rest of the bytes (@2) will be written to file @3', NULL, NULL);
...
('', '', '', NULL, 12, 275, NULL, '', NULL, NULL);
('', '', 'burp.c', NULL, 12, 276, NULL, '	@1USE_(ALL_SPACE)      do not reserve space for record versions', NULL, NULL);
('', '', 'burpswi.h', NULL, 12, 277, NULL, '        @1SE(RVICE)            use services manager', NULL, NULL);
('gbak_opt_mode', 'BURP_gbak', 'burp.c', NULL, 12, 278, NULL, '	@1MO(DE) <access>      "read_only" or "read_write" access', NULL, NULL);
('gbak_mode_req', 'BURP_gbak', 'burp.c', NULL, 12, 279, NULL, '"read_only" or "read_write" required', NULL, NULL);
('', 'RESTORE_restore', 'restore.e', NULL, 12, 280, NULL, 'setting database to read-only access', NULL, NULL);
...
(NULL, NULL, 'burp.c', NULL, 12, 284, NULL, '	@1R(ECREATE_DATABASE) [O(VERWRITE)] create (or replace if OVERWRITE used)
				database from backup file', NULL, NULL);
...
(NULL, NULL, NULL, NULL, 13, 98, NULL, 'Unsuccessful execution caused by a system error that precludes
successful execution of subsequent statements', NULL, NULL);
('', '', '', NULL, 13, 99, NULL, 'Unsuccessful execution caused by system error that does not preclude successful execution of subsequent statements', NULL, NULL);
...
(NULL, NULL, NULL, NULL, 13, 183, NULL, 'The insert, update, delete, ddl or authorization statement cannot
 be executed because the transaction is inquiry only', NULL, NULL);
...
('', '', '', NULL, 13, 196, NULL, 'An error was found in the application program input parameters for the SQL statement.', NULL, NULL);
(NULL, NULL, NULL, NULL, 13, 197, NULL, 'Invalid insert or update value(s): object columns are
constrained - no 2 table rows can have duplicate column values', NULL, NULL);
('', '', '', NULL, 13, 198, NULL, 'Arithmetic overflow or division by zero has occurred.', NULL, NULL);
...
('', '', '', NULL, 13, 382, NULL, 'Cannot delete object referenced by another object', NULL, NULL);
...
('', '', '', NULL, 13, 492, NULL, ' The cursor identified in the update or delete statement is not positioned on a row.', NULL, NULL);
...
('', '', '', NULL, 13, 697, NULL, 'Incompatible column/host variable data type', NULL, NULL);
...
('', '', '', NULL, 13, 849, NULL, 'This column cannot be updated because it is derived from an SQL function or expression.', NULL, NULL);
...
('', 'VIO_erase', 'vio.c', NULL, 15, 187, NULL, 'cannot delete system tables', NULL, NULL);
...
(NULL, '', 'MOV_get_double', NULL, 15, 190, NULL, 'conversion not supported for specified data types', NULL, NULL);
...
('', 'BLB_open2', 'blb.c', NULL, 15, 194, NULL, 'BLOB not found', NULL, NULL);
('', 'BLB_put_segment', 'blb.c', NULL, 15, 195, NULL, 'cannot update old BLOB', NULL, NULL);
...
('', 'delete_blob_id', 'blb.c', NULL, 15, 200, NULL, 'invalid BLOB ID', NULL, NULL);
('', 'get_next_page', 'blb.c', NULL, 15, 201, NULL, 'cannot find BLOB page', NULL, NULL);
...
('', 'lock_buffer', 'cch.c', NULL, 15, 215, NULL, 'page @1, page type @2 lock conversion denied', NULL, NULL);
('', 'lock_buffer', 'cch.c', NULL, 15, 216, NULL, 'page @1, page type @2 lock denied', NULL, NULL);
...
('', 'CMP_format', 'cmp.c', NULL, 15, 222, NULL, 'bad BLR -- invalid stream', NULL, NULL);
...
('', 'CMP_get_desc', 'cmp.c', NULL, 15, 225, NULL, 'data type not supported for arithmetic', NULL, NULL);
...
(NULL, 'pass1', 'cmp.c', NULL, 15, 228, NULL, 'cannot access field in view @2', NULL, NULL);
...
('', 'translate_status', 'map.c', NULL, 15, 239, NULL, 'Firebird status vector inconsistent', NULL, NULL);
('', 'translate_status', 'map.c', NULL, 15, 240, NULL, 'Firebird/RdB message parameter inconsistency', NULL, NULL);
...
('', 'filter_transliterate_text()', 'filters.c', NULL, 15, 289, NULL, 'Unknown BLOB FILTER ACTION_', NULL, NULL);
('savepoint_error', '', 'exe.c', NULL, 15, 290, NULL, 'error during savepoint backout', NULL, NULL);
('', '', 'vio.c', NULL, 15, 291, NULL, 'cannot find record back version', NULL, NULL);
('', 'grant_user', 'grant.e', NULL, 15, 292, NULL, 'Illegal user_type.', NULL, NULL);
('', 'squeeze_acl', 'grant.e', NULL, 15, 293, NULL, 'bad ACL', NULL, NULL);
('', 'release_bdb', 'cch.c', NULL, 15, 294, NULL, 'inconsistent LATCH_mark release', NULL, NULL);
('', 'latch_bdb', 'cch.c', NULL, 15, 295, NULL, 'inconsistent LATCH_mark call', NULL, NULL);
('', 'release_bdb', 'cch.c', NULL, 15, 296, NULL, 'inconsistent latch downgrade call', NULL, NULL);
('', 'release_bdb', 'cch.c', NULL, 15, 297, NULL, 'bdb is unexpectedly marked', NULL, NULL);
('', 'release_bdb', 'cch.c', NULL, 15, 298, NULL, 'missing exclusive latch', NULL, NULL);
('', 'latch_bdb', 'cch.c', NULL, 15, 299, NULL, 'exceeded maximum number of shared latches on a bdb', NULL, NULL);
('', 'release_bdb', 'cch.c', NULL, 15, 300, NULL, 'can''t find shared latch', NULL, NULL);
...
('', 'EVL_expr', 'jrd/evl.c', NULL, 15, 303, NULL, 'Invalid expression for evaluation', NULL, NULL);
...
('HLP_SETPLANONLY', 'help', 'isql.epp', NULL, 17, 109, NULL, '    SET HEADING            -- toggle display of query column titles', NULL, NULL);
...
('TIME_ERR', 'add_row()', 'isql.epp', NULL, 17, 114, NULL, 'Bad TIMESTAMP: @1', NULL, NULL);
...
('', 'exec_line', 'gsec_exec.c', NULL, 18, 74, NULL, 'gsec - memory allocation error', NULL, NULL);
('', 'exec_line', 'gsec_exec.c', NULL, 18, 75, NULL, 'gsec error', NULL, NULL);
...
('', 'main', 'dba.e', NULL, 21, 5, NULL, 'gstat version @1', NULL, NULL);
('', 'main', 'dba.e', NULL, 21, 6, NULL, '
Database "@1"', NULL, NULL);
('', 'main', 'dba.e', NULL, 21, 7, NULL, '

Database file sequence:', NULL, NULL);
('', 'main', 'dba.e', NULL, 21, 8, NULL, 'File @1 continues as file @2', NULL, NULL);
('', 'main', 'dba.e', NULL, 21, 9, NULL, 'File @1 is the @2 file', NULL, NULL);
('', 'main', 'dba.e', NULL, 21, 10, NULL, '
Analyzing database pages ...', NULL, NULL);
('', 'main', 'dba.e', NULL, 21, 11, NULL, '    Primary pointer page: @1, Index root page: @2', NULL, NULL);
('', 'main', 'dba.e', NULL, 21, 12, NULL, '    Data pages: @1, data page slots: @2, average fill: @3', NULL, NULL);
('', 'main', 'dba.e', NULL, 21, 13, NULL, '    Fill distribution:', NULL, NULL);
('', 'main', 'dba.e', NULL, 21, 14, NULL, '    Index @1 (@2)', NULL, NULL);
('', 'main', 'dba.e', NULL, 21, 15, NULL, '	Depth: @1, leaf buckets: @2, nodes: @3', NULL, NULL);
('', 'main', 'dba.e', NULL, 21, 16, NULL, '	Average data length: @1, total dup: @2, max dup: @3', NULL, NULL);
('', 'main', 'dba.e', NULL, 21, 17, NULL, '	Fill distribution:', NULL, NULL);
('', 'analyze_data', 'dba.e', NULL, 21, 18, NULL, '    Expected data on page @1', NULL, NULL);
('', 'analyze_index', 'dba.e', NULL, 21, 19, NULL, '    Expected b-tree bucket on page @1 from @2', NULL, NULL);
('', 'main', 'dba.e', NULL, 21, 20, NULL, 'unknown switch "@1"', NULL, NULL);
('', 'main', 'dba.e', NULL, 21, 21, NULL, 'Available switches:', NULL, NULL);
('', 'main', 'dba.e', NULL, 21, 22, NULL, '    -a      analyze data and index pages', NULL, NULL);
('', 'main', 'dba.e', NULL, 21, 23, NULL, '    -d      analyze data pages', NULL, NULL);
('', 'main', 'dba.e', NULL, 21, 24, NULL, '    -h      analyze header page', NULL, NULL);
('', 'main', 'dba.e', NULL, 21, 25, NULL, '    -i      analyze index leaf pages', NULL, NULL);
('', 'main', 'dba.e', NULL, 21, 26, NULL, '    -l      analyze log page', NULL, NULL);
('', 'main', 'dba.e', NULL, 21, 27, NULL, '    -s      analyze system relations', NULL, NULL);
('', 'main', 'dba.e', NULL, 21, 28, NULL, '    -z      display version number', NULL, NULL);
...
('gstat_username', '', 'dba.e', NULL, 21, 32, NULL, '    -u      username', NULL, NULL);
