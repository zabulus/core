...
const int IN_SW_DBA_TRUSTED_USER	= 13;	// trusted user name
const int IN_SW_DBA_TRUSTED_ROLE	= 14;	// use predefined trusted role
#ifdef TRUSTED_AUTH
...
//  {IN_SW_DBA_LOG,				isc_spb_sts_db_log,			"LOG",		0,0,0,	false,	26,	1, NULL},	// msg 26: -l      analyze log page
    {IN_SW_DBA_SYSTEM,			isc_spb_sts_sys_relations,	"SYSTEM",	0,0,0,	false,	27,	1, NULL},	// msg 27: -s      analyze system relations
    {IN_SW_DBA_USERNAME,		0,							"USERNAME",	0,0,0,	false,	32,	1, NULL},	// msg 32: -u      username
    {IN_SW_DBA_PASSWORD,		0,							"PASSWORD",	0,0,0,	false,	33,	1, NULL},	// msg 33: -p      password
...
#endif
    {IN_SW_DBA_VERSION,			0,							"Z",		0,0,0,	false,	28,	1, NULL},	// msg 28: -z      display version number
    {IN_SW_DBA_HELP,			0,							"?",		0,0,0,	false,	0,	1, NULL},	// Help
