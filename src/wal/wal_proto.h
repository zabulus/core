 ...
 *	MODULE:		wal_proto.h
 *	DESCRIPTION:	Prototype header file for wal.cpp
 *
...
SSHORT	WAL_attach (ISC_STATUS*, struct wal**, const SCHAR*);
...
SSHORT	WAL_journal_enable (ISC_STATUS*, struct wal*, const SCHAR*, USHORT, const SCHAR*);
SSHORT	WAL_put (ISC_STATUS*, struct wal*, const UCHAR*, USHORT, const UCHAR*, USHORT, SLONG*, SLONG*);
