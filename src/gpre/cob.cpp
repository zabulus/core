...
static int gen_end_fetch( ACT action)
{
...
static int gen_request( REQ request)
{
	REF reference;
	BLB blob;
	POR port;
...
static int printa( TEXT * column, BOOLEAN call, TEXT * string, ...)
{
	va_list ptr;
	TEXT s[256];
...
static int set_sqlcode( ACT action)
{
	TEXT buffer[128];
