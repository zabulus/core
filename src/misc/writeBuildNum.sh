...
BuildVersion="$Id: writeBuildNum.sh,v 1.3741.2.12 2004-01-05 08:48:58 paul_reeves Exp $"
...
RevNo=0
BuildNum=4231
BuildSuffix="Firebird 1.5 Release Candidate 8"
FIREBIRD_PACKAGE_VERSION=RC8
