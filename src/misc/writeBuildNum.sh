...
BuildVersion="$Id: writeBuildNum.sh,v 1.3398 2003-05-14 08:24:51 alexpeshkoff Exp $"
...
RevNo=0
BuildNum=3403
BuildSuffix="Firebird 1.5 Release Candidate 2"
FIREBIRD_PACKAGE_VERSION=0.RC2
