...
BuildVersion="$Id: writeBuildNum.sh,v 1.3497 2003-06-06 06:40:01 alexpeshkoff Exp $"
...
RevNo=0
BuildNum=3501
BuildSuffix="Firebird 1.5 Release Candidate 3"
FIREBIRD_PACKAGE_VERSION=0.RC3
