...
BuildVersion="$Id: writeBuildNum.sh,v 1.3745 2003-07-08 12:26:43 alexpeshkoff Exp $"
...
RevNo=0
BuildNum=3748
BuildSuffix="Firebird 1.5 Release Candidate 4"
FIREBIRD_PACKAGE_VERSION=0.RC4
