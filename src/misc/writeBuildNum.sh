...
BuildVersion="$Id: writeBuildNum.sh,v 1.3208 2003-04-12 10:35:09 alexpeshkoff Exp $"
...
RevNo=0
BuildNum=3214
BuildSuffix="Firebird 1.5 Release Candidate 1"
FIREBIRD_PACKAGE_VERSION=0.RC1
