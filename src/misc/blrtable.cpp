...
static const VERB verbs[] =
{
	...
	PAIR(nod_class_exprnode_jrd, blr_dbkey, 1, 0, VALUE, VALUE),
	PAIR(nod_class_exprnode_jrd, blr_divide, 1, 0, VALUE, VALUE),
	PAIR(nod_class_exprnode_jrd, blr_fid, 1, 0, VALUE, VALUE),
	PAIR(nod_class_exprnode_jrd, blr_field, 1, 0, VALUE, VALUE),
	...
	PAIR(nod_class_recsrcnode_jrd, blr_rse, 1, 0, TYPE_RSE, OTHER),
