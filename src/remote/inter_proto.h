...
ISC_STATUS	REM_attach_database(ISC_STATUS *, SSHORT, SCHAR *, struct rdb **, SSHORT, SCHAR *, UCHAR *);
ISC_STATUS	REM_attach_service(ISC_STATUS *, USHORT, TEXT *, struct rdb **, USHORT, SCHAR *);
ISC_STATUS	REM_blob_info(ISC_STATUS *, struct rbl **, SSHORT, SCHAR *, SSHORT, SCHAR *);
...
ISC_STATUS	REM_create_blob2(ISC_STATUS *, struct rdb **, struct rtr **, struct rbl **, BID, USHORT, UCHAR *);
ISC_STATUS	REM_create_database(ISC_STATUS *, SSHORT, SCHAR *, struct rdb **, SSHORT, SCHAR *, SSHORT, UCHAR *);
ISC_STATUS	REM_database_info(ISC_STATUS *, struct rdb **, SSHORT, SCHAR *, SSHORT, SCHAR *);
...
ISC_STATUS	REM_sql_info(ISC_STATUS *, struct rsr **, SSHORT, SCHAR *, SSHORT, SCHAR *);
...
ISC_STATUS	REM_open_blob2(ISC_STATUS *, struct rdb **, struct rtr **, struct rbl **, BID, USHORT, UCHAR *);
ISC_STATUS	REM_prepare_transaction(ISC_STATUS *, struct rtr **, USHORT, UCHAR *);
ISC_STATUS	REM_put_segment(ISC_STATUS *, struct rbl **, USHORT, UCHAR *);
...
ISC_STATUS	REM_reconnect_transaction(ISC_STATUS *, struct rdb **, struct rtr **, USHORT, UCHAR *);
ISC_STATUS	REM_release_request(ISC_STATUS *, struct rrq **);
ISC_STATUS	REM_request_info(ISC_STATUS *, struct rrq **, SSHORT, SSHORT, UCHAR *, SSHORT, UCHAR *);
...
ISC_STATUS	REM_transaction_info(ISC_STATUS *, struct rtr **, SSHORT, UCHAR *, SSHORT, UCHAR *);
