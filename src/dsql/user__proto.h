...
ISC_STATUS API_ROUTINE gds__execute(ISC_STATUS*, FRBRD**, const SCHAR*, SQLDA*);
...
ISC_STATUS API_ROUTINE gds__prepare(ISC_STATUS*, FRBRD**, FRBRD**, const SCHAR*,
...
ISC_STATUS API_ROUTINE isc_embed_dsql_exec_immed(ISC_STATUS*, FRBRD**, FRBRD**,
	USHORT, const SCHAR*, USHORT, XSQLDA*);
ISC_STATUS API_ROUTINE isc_embed_dsql_exec_immed2(ISC_STATUS*, FRBRD**, FRBRD**,
	USHORT, const SCHAR*, USHORT, XSQLDA*, XSQLDA*);
ISC_STATUS API_ROUTINE isc_embed_dsql_execute(ISC_STATUS*, FRBRD**,
	const SCHAR*, USHORT, XSQLDA*);
ISC_STATUS API_ROUTINE isc_embed_dsql_execute2(ISC_STATUS*, FRBRD**,
	const SCHAR*, USHORT, XSQLDA*, XSQLDA*);
ISC_STATUS API_ROUTINE isc_embed_dsql_execute_immed(ISC_STATUS*, FRBRD**,
	FRBRD**, USHORT, const SCHAR*, USHORT, XSQLDA*);
...
ISC_STATUS API_ROUTINE isc_embed_dsql_open2(ISC_STATUS*, FRBRD**, const SCHAR*, USHORT, XSQLDA*, XSQLDA*);
ISC_STATUS API_ROUTINE isc_embed_dsql_prepare(ISC_STATUS*, FRBRD**, FRBRD**,
	const SCHAR*, USHORT, const SCHAR*, USHORT, XSQLDA*);
ISC_STATUS API_ROUTINE isc_embed_dsql_release(ISC_STATUS*, const SCHAR*);
ISC_STATUS API_ROUTINE isc_execute(ISC_STATUS*, FRBRD**, const SCHAR*, SQLDA*);
ISC_STATUS API_ROUTINE isc_execute_immediate(ISC_STATUS*, FRBRD**, FRBRD**,
	SSHORT*, const SCHAR*);
...
ISC_STATUS API_ROUTINE isc_open(ISC_STATUS*, FRBRD**, const SCHAR*, SQLDA*);
ISC_STATUS API_ROUTINE isc_prepare(ISC_STATUS*, FRBRD**, FRBRD**, SCHAR*, SSHORT*,
	const SCHAR*, SQLDA*);
