...
ISC_STATUS API_ROUTINE gds__open(ISC_STATUS*, FB_API_HANDLE*, SCHAR*, SQLDA*);
...
ISC_STATUS API_ROUTINE isc_embed_dsql_open(ISC_STATUS*, FB_API_HANDLE*, SCHAR*, USHORT, XSQLDA*);
...
ISC_STATUS API_ROUTINE isc_prepare(ISC_STATUS*, FB_API_HANDLE*, FB_API_HANDLE*, SCHAR*, SSHORT*,
	const SCHAR*, SQLDA*);
