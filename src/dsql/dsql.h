...
enum req_flags_vals {
	REQ_cursor_open			= 0x0001,
	REQ_save_metadata		= 0x0002,
	REQ_prepared			= 0x0004,
	REQ_embedded_sql_cursor	= 0x0008,
	REQ_procedure			= 0x0010,
	REQ_trigger				= 0x0020,
	REQ_orphan				= 0x0040,
	REQ_enforce_scope		= 0x0080,
	REQ_no_batch			= 0x0100,
	REQ_backwards			= 0x0200,
	REQ_blr_version4		= 0x0400,
	REQ_blr_version5		= 0x0800,
	REQ_block				= 0x1000,
	REQ_selectable			= 0x2000,
	REQ_CTE_recursive		= 0x4000,
	REQ_dsql_upd_or_ins		= 0x8000
};
