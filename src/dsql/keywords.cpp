...
static const TOK tokens[] =
{
	...
	{ASCII_CHAR, "ASCII_CHAR", 2, true},
	{ASCII_VAL, "ASCII_VAL", 2, true},
	{ASIN, "ASIN", 2, true},
	{AT, "AT", 1, false},
	{ATAN, "ATAN", 2, true},
	{ATAN2, "ATAN2", 2, true},
	...
	{BIN_AND, "BIN_AND", 2, true},
	{BIN_OR, "BIN_OR", 2, true},
	{BIN_SHL, "BIN_SHL", 2, true},
	{BIN_SHR, "BIN_SHR", 2, true},
	{BIN_XOR, "BIN_XOR", 2, true},
	...
	{CASE, "CASE", 2, false},
	{CAST, "CAST", 1, false},
	{CEIL, "CEIL", 2, true},	// alias of CEILING
	...
	{MATCHED, "MATCHED", 2, true},
	{MATCHING, "MATCHING", 2, true},
	{MAXIMUM, "MAX", 1, false},
	{MAXVALUE, "MAXVALUE", 2, true},
	{MAX_SEGMENT, "MAXIMUM_SEGMENT", 1, false},
	{MERGE, "MERGE", 1, false},
	{MILLISECOND, "MILLISECOND", 2, true},
	{MINIMUM, "MIN", 1, false},
	{MINUTE, "MINUTE", 2, false},
	{MINVALUE, "MINVALUE", 2, true},
	{MOD, "MOD", 2, true},
