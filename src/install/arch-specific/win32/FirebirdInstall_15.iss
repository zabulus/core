...
Source: output\bin\gbak.exe; DestDir: {app}\bin; Components: ServerComponent; Flags: sharedfile ignoreversion;
Source: output\bin\gbak.exe; DestDir: {app}\bin; Components: DevAdminComponent;  Flags: ignoreversion;
Source: output\bin\gdef.exe; DestDir: {app}\bin; Components: DevAdminComponent;  Flags: ignoreversion;
Source: output\bin\gfix.exe; DestDir: {app}\bin; Components: ServerComponent; Flags: sharedfile ignoreversion;
Source: output\bin\gfix.exe; DestDir: {app}\bin; Components: DevAdminComponent;  Flags: ignoreversion;
Source: output\bin\gpre.exe; DestDir: {app}\bin; Components: DevAdminComponent;  Flags: ignoreversion;
Source: output\bin\gsec.exe; DestDir: {app}\bin; Components: ServerComponent; Flags: sharedfile ignoreversion;
