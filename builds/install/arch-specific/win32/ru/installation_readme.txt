==================================================
Сервер Баз Данных Firebird 2.1 RC2
==================================================

Этот документ является руководством по установке
пакета Firebird 2.1.0 на платформе Windows. Эти
замечания относятся именно к установке программы,
а не к самому продукту Firebird 2.1.0 в целом.

Предполагается, что читатели данного документа уже
знакомы с Firebird версии 2.0. Если же вы знакомитесь
с Firebird 2.1 в процессе миграции с версии 1.5, то
рекомендуем вам обратиться к документации по версии
2.0 с целью ознакомиться с основными отличиями между
версиями 1.5 и 2.x.
...
версии этого пакета для данной версии Firebirf вы можете
найти по адресу:
...
o Данная программа установки позволяет установить только
  экземпляр сервера Firebird 2.1 с именем по умолчанию
