...
Добро пожаловать в мир Firebird 2.1.2.


Обращение к пользователям
=========================

Firebird 2.1.2 является хорошо проверенным, всесторонне
...
doc/Firebird_v2.1.2.ReleaseNotes.pdf.
