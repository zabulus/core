...
@del gpre_boot.exe
@cd msvc6
@msdev Firebird2.dsw /MAKE "common_static - Win32 Release" "gpre_boot - Win32 Release"  /REBUILD /OUT boot1.log
@cd ..
...
@cd msvc6
@msdev Firebird2.dsw /MAKE "fbclient_static - Win32 Release" "gpre_static - Win32 Release"  /REBUILD /OUT boot2.log
@cd ..
...
@cd msvc6
@msdev Firebird2.dsw /MAKE "build_msg - Win32 Release" "codes - Win32 Release"  /REBUILD /OUT boot3.log
@cd ..
