...
# ADD CPP /nologo /G4 /MD /W3 /Gi /GX /Zi /Ot /Og /Oi /Op /Oy /Ob1 /I "../../../src/include" /I "../../../src/include/gen" /D "NDEBUG" /D "_WINDOWS" /D "SUPERSERVER" /D "WIN32" /D "_MBCS" /D "_X86_" /FR /FD /EHc- /c
# ADD BASE MTL /nologo /D "_DEBUG" /mktyplib203 /win32
# ADD MTL /nologo /D "_DEBUG" /mktyplib203 /win32
# ADD BASE RSC /l 0x41d /d "_DEBUG"
# ADD RSC /l 0x41d /d "_DEBUG"
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib shell32.lib comctl32.lib advapi32.lib ws2_32.lib mpr.lib version.lib /nologo /stack:0x200000 /subsystem:windows /incremental:no /pdb:"..\..\..\temp\release\firebird/bin/fbserver.pdb" /debug /machine:I386 /out:"..\..\..\temp\release\firebird/bin/fbserver.exe" /opt:ref,icf
