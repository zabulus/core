...
@devenv Firebird2.sln /project v5_examples %CLEAN% /OUT v5_examples.log
@goto :EOF
...
@echo.
@echo Building debug
@devenv Firebird2.sln /project v5_examples %CLEAN% debug /OUT v5_examples.log
@goto :EOF
...
@copy msvc7\%DBG_DIR%\v5_examples\v5_examples.exe output\v5_examples\empbuild.exe > nul
@goto :EOF
